...
/**
    ...
    **/
	...
	/**不支持VBF**/
    s32Ret = HI_GO_CreateText(NULL, "./res/higo_gb2312.ubf", &hFont);
    if (HI_SUCCESS != s32Ret) 
    {
        SAMPLE_TRACE("failed to create the font:./res/higo_gb2312.ubf !\n"); 
        goto RET;       
    }

#if defined(CHIP_TYPE_hi3716m) || defined(CHIP_TYPE_hi3716mv310)
	/** 不影响原有的使用方式，最好不要使用接口调用 **/
    ...
    HI_GO_SetTextStyle(hFont, HIGO_TEXT_STYLE_BOLD);
