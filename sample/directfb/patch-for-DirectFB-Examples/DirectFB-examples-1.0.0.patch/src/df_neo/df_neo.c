...
{
  "../share/directfb-examples/apple-red.png",
  "../share/directfb-examples/gnome-applets.png",
  "../share/directfb-examples/gnome-calendar.png",
  "../share/directfb-examples/gnome-foot.png",
  "../share/directfb-examples/gnome-gmush.png",
  "../share/directfb-examples/gnome-gimp.png",
  "../share/directfb-examples/gnome-gsame.png",
  "../share/directfb-examples/gnu-keys.png"
};

#define N_IMAGES (int)((sizeof (image_names) / sizeof (image_names[0])))

#define BACKGROUND_NAME  "../share/directfb-examples/background.jpg"
