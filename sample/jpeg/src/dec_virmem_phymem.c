...
*
******************************************************************************
File Name	    : sample_dec_virmem_phymem.c
Version		    : Initial Draft
Author		    : 
Created		    : 2014/06/20
Description	    : 码流来源于虚拟内存，输出为用户的连续的物理内存
Function List 	: 
...
/*****************************************************************************
* func		: sample_dec_virmemin_phymemout
* description: CNcomment: 虚拟内存输入连续的物理内存输出  CNend\n
* param[in]	: *pFileName		CNcomment:要解码的文件	  CNend\n
* retval 	: NA
* others:	: NA
*****************************************************************************/
HI_VOID sample_dec_virmemin_phymemout(HI_CHAR *pFileName)
{
...
int main(int argc,char** argv)
{
		...
		while((ptr = readdir(dir))!=NULL)
        {
			 ...
			 sample_dec_virmemin_phymemout(pFileName);
		}
