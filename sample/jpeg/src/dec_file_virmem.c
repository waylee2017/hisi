...
*
******************************************************************************
File Name	    : sample_dec_file_virmem.c
Version		    : Initial Draft
Author		    : 
Created		    : 2014/06/20
Description	    : 码流来源于文件，输出为用户的虚拟内存
Function List 	: 
...
/*****************************************************************************
* func		: sample_dec_filein_virmemout
* description: CNcomment: 文件输入虚拟内存输出  CNend\n
* param[in]	: *pFileName		CNcomment:要解码的文件	  CNend\n
* retval 	: NA
* others:	: NA
*****************************************************************************/
HI_VOID sample_dec_filein_virmemout(HI_CHAR *pFileName)
{
...
int main(int argc,char** argv)
{
		...
		while((ptr = readdir(dir))!=NULL)
        {
			 ...
			 sample_dec_filein_virmemout(pFileName);
		}
