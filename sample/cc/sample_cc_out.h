...
HI_S32 CC_Output_GetTextSize(HI_U32 u32Userdata, HI_U16 *u8Str,HI_S32 StrNum, HI_S32 *width, HI_S32 *heigth);

HI_S32 CC_Output_Blit(HI_U32 u32UserPrivatData, HI_UNF_CC_RECT_S *SrcRect, HI_UNF_CC_RECT_S *DestRect);
