...
HI_S32 CreateTsResource(HI_HANDLE hWin)
{
    ...
    Ret = HI_UNF_SND_Attach(HI_UNF_SND_0, g_hAvplayTs, HI_UNF_SND_MIX_TYPE_MASTER, 100);
    if (Ret != HI_SUCCESS)
    {
...
SND_DETACH:
    HI_UNF_SND_Detach(HI_UNF_SND_0, g_hAvplayTs);
...
HI_S32 main(HI_S32 argc,HI_CHAR *argv[])
{
    ...
    pthread_create(&g_EsThd, HI_NULL, (HI_VOID *)EsThread, HI_NULL);
