...
//g_u8ClearOddKey:      12 34 56 78 9a bc de f0 
//g_u8ClearEvenKey:     12 34 56 78 9a bc de f0 
//g_u8EncrytedOddKey1:  74 18 17 0D 0F 42 3A 5B
//g_u8EncrytedEvenKey1: 74 18 17 0D 0F 42 3A 5B
static HI_U8 g_u8ClearOddKey[16]     = {0x12,0x34,0x56,0x78,0x9a,0xbc,0xde,0xf0};
static HI_U8 g_u8ClearEvenKey[16]    = {0x12,0x34,0x56,0x78,0x9a,0xbc,0xde,0xf0};;
static HI_U8 g_u8EncrytedOddKey[16]  = {0x74,0x18,0x17,0x0D,0x0F,0x42,0x3A,0x5B};
static HI_U8 g_u8EncrytedEvenKey[16] = {0x74,0x18,0x17,0x0D,0x0F,0x42,0x3A,0x5B};
...
HI_S32 loadcsa2cw(HI_HANDLE hKey, HI_U32 CwType, HI_U32 ProgNum)
{
    ...
    else
    {
        ...
        if(stOtpFuseAttr.unOtpFuseAttr.stKeyladderLevSel.enKeyladderLevel >= HI_UNF_ADVCA_KEYLADDER_LEV2)
        {
            ...
            memcpy(stKeyladderAttr.unKlAttr.stCSA2KlAttr.u8SessionKey, g_u8EncrptedSessionKey, 16);
            Ret |= HI_UNF_ADVCA_SetKeyLadderAttr(HI_UNF_ADVCA_KEYLADDER_CSA2, &stKeyladderAttr);
        }
