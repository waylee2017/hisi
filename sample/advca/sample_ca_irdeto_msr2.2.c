...
//The Hi3716MV310 encrypted CUSK is 0xAA,0x26,0x9D,0xD4,0x70,0x88,0x13,0xC0,0x91,0xAF,0x86,0xE8,0x39,0x48,0x32,0xAB
...
/* stream: SST_V2.4.mpg
*/
//g_u8DVBRootkey:   0xAA,0x26,0x9D,0xD4,0x70,0x88,0x13,0xC0,0x91,0xAF,0x86,0xE8,0x39,0x48,0x32,0xAB
//clearOddrKey:     0xA8,0x9C,0x0F,0x53,0x51,0x08,0xBD,0x16
//ClearEvenKey:     0x19,0xDF,0x63,0x5B,0xDC,0xB8,0x90,0x24
...
*/
//g_u8DVBRootkey:   0xAA,0x26,0x9D,0xD4,0x70,0x88,0x13,0xC0,0x91,0xAF,0x86,0xE8,0x39,0x48,0x32,0xAB
//g_u8ClearSessionkey:     0x57,0x0D,0x64,0xFD,0xD6,0x4C,0x22,0x10,0x92,0x14,0xDE,0x31,0xBE,0x1B,0x15,0x8A
//g_u8EncrptedSessionKey:  0x8A,0xA8,0x9D,0x1A,0x49,0x5C,0xAF,0x6A,0x9D,0x90,0x3D,0xBA,0x0E,0xF7,0x3B,0xC8
//clearOddrKey:     0xA8,0x9C,0x0F,0x53,0x51,0x08,0xBD,0x16
//ClearEvenKey:     0x19,0xDF,0x63,0x5B,0xDC,0xB8,0x90,0x24
//EncrytedOddKey:   0x88,0xE1,0xAB,0x2F,0x0C,0xF6,0x74,0x53
//EncrytedEvenKey:  0x7E,0x13,0x18,0xA8,0x2B,0xAF,0x6B,0xDC

//1: 8byte_CW-KL_ALG_TDES-KL_Level_2-TS_CSA2 (SST_V2.4.mpg)
static HI_U8 g_u8TDesEncrytedOddKey[8] = {0x88,0xE1,0xAB,0x2F,0x0C,0xF6,0x74,0x53};
static HI_U8 g_u8TDesEncrytedEvenKey[8] = {0x7E,0x13,0x18,0xA8,0x2B,0xAF,0x6B,0xDC};
static HI_U8 g_u8TDesEncrptedCwpk[16] = {0x8A,0xA8,0x9D,0x1A,0x49,0x5C,0xAF,0x6A,0x9D,0x90,0x3D,0xBA,0x0E,0xF7,0x3B,0xC8}; 
...
//clearOddrKey:     0xA8,0x9C,0x0F,0x53,0x51,0x08,0xBD,0x16
//ClearEvenKey:     0x19,0xDF,0x63,0x5B,0xDC,0xB8,0x90,0x24
//EncrytedOddKey:   0x7A,0x7E,0x3F,0x45,0xFB,0x77,0x81,0xB1,0x62,0x52,0x1B,0xE0,0x35,0xD5,0xE3,0xB4
//EncrytedEvenKey:  0x4A,0x83,0x85,0x34,0x6F,0x6D,0x78,0xB9,0xD1,0x8B,0x85,0xF9,0x35,0x9F,0x90,0xE1  

//2: 8byte_CW-KL_ALG_AES-KL_Level_2-TS_CSA2 (SST_V2.4.mpg)
static HI_U8 g_u8AesEncrytedOddKey[16] = {0x7A,0x7E,0x3F,0x45,0xFB,0x77,0x81,0xB1,0x62,0x52,0x1B,0xE0,0x35,0xD5,0xE3,0xB4};
static HI_U8 g_u8AesEncrytedEvenKey[16] = {0x4A,0x83,0x85,0x34,0x6F,0x6D,0x78,0xB9,0xD1,0x8B,0x85,0xF9,0x35,0x9F,0x90,0xE1};
static HI_U8 g_u8AesEncrptedCwpk[16] = {0x92,0x5D,0xCE,0xBC,0xAC,0xF1,0x6E,0x0C,0xF3,0xCE,0xAE,0x99,0x22,0x9D,0x85,0xDB}; 


/*===============================================================*/
/* stream: IRDETO_AES_CBC.ts
*/
//g_u8DVBRootkey:   0xAA,0x26,0x9D,0xD4,0x70,0x88,0x13,0xC0,0x91,0xAF,0x86,0xE8,0x39,0x48,0x32,0xAB
//g_u8ClearSessionkey:     0x90,0x5D,0x62,0xBD,0xE2,0xCB,0xD3,0x76,0x5B,0x7A,0xFC,0x24,0x99,0x84,0x04,0x8E
//g_u8EncrptedSessionKey:  0x92,0x5D,0xCE,0xBC,0xAC,0xF1,0x6E,0x0C,0xF3,0xCE,0xAE,0x99,0x22,0x9D,0x85,0xDB
//clearOddrKey:     0xA8,0x9C,0x0F,0x53,0x51,0x08,0xBD,0x16,0xA8,0x9C,0x0F,0x53,0x51,0x08,0xBD,0x16
//ClearEvenKey:     0x19,0xDF,0x63,0x5B,0xDC,0xB8,0x90,0x24,0x19,0xDF,0x63,0x5B,0xDC,0xB8,0x90,0x24
//EncrytedOddKey:   0xE6,0x7E,0x43,0x0A,0x10,0x02,0x48,0xBE,0x35,0xC4,0xD0,0x87,0xA7,0x23,0xB6,0xB6
//EncrytedEvenKey:  0xCA,0x44,0xA2,0x46,0xC2,0x17,0xC2,0x14,0x5F,0xEE,0x95,0xA1,0xDE,0xB0,0x42,0x49
//IV:0x49,0x72,0x64,0x65,0x74,0x6F,0xA9,0x43,0x6F,0x70,0x79,0x72,0x69,0x67,0x68,0x74
...
static HI_U8 g_u8AesCbcEncrytedOddKey[16] = {0xE6,0x7E,0x43,0x0A,0x10,0x02,0x48,0xBE,0x35,0xC4,0xD0,0x87,0xA7,0x23,0xB6,0xB6};
static HI_U8 g_u8AesCbcEncrytedEvenKey[16] = {0xCA,0x44,0xA2,0x46,0xC2,0x17,0xC2,0x14,0x5F,0xEE,0x95,0xA1,0xDE,0xB0,0x42,0x49};
static HI_U8 g_u8AesCbcEncrptedCwpk[16] = {0x92,0x5D,0xCE,0xBC,0xAC,0xF1,0x6E,0x0C,0xF3,0xCE,0xAE,0x99,0x22,0x9D,0x85,0xDB};
...
static HI_S32 DmxInit(HI_VOID)
{
    ...
    Ret |= HI_UNF_DMX_AttachTSPort(PVR_DMX_ID_REC, HI_UNF_DMX_PORT_3_RAM);
#else	
