...
#ifndef CHIP_TYPE_hi3110ev500
    Ret = HI_UNF_DISP_SetLayerZorder(HI_UNF_DISP_HD0, HI_UNF_DISP_LAYER_VIDEO_0, HI_LAYER_ZORDER_MOVEBOTTOM);
#else
    Ret = HI_UNF_DISP_SetLayerZorder(HI_UNF_DISP_SD0, HI_UNF_DISP_LAYER_VIDEO_0, HI_LAYER_ZORDER_MOVEBOTTOM);
#endif
    if(HI_SUCCESS != Ret)
    {
        PVR_SAMPLE_Printf("call HI_UNF_DISP_SetLayerZorder failed.\n");
        HIADP_Disp_DeInit();
        HIADP_Snd_DeInit();
        HI_SYS_DeInit();
    }
