...
HI_U32 u32UartBaseAddr = 0x101e5000;
...
HI_U8 get_advca_support( void)
{
    regAddr.val32 = 0x10180128;
	read_regVal();

    if (regData.val32 == HI_CHIP_ADVCA)
    {
        return SUPPORT_ADVCA;
    }
    else if (regData.val32 == HI_CHIP_NON_ADVCA)
    {
