...
#define PT6961_DIN     (1)    /*DIN signal pin connected with GPIO5_1*/ /*CNcomment:数据输出信号管脚与GPIO5_1相连*/
#define PT6961_DOUT    (4)    /*DOUT signal pin connected with GPIO5_4*/ /*CNcomment:数据输入信号管脚与GPIO5_4相连*/
