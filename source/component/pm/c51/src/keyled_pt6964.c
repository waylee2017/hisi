...
#define PT6964_CLK     (2)    /*CLK signal pin connected with GPIO5_2*/ /*CNcomment:时钟信号管脚与GPIO5_2相连*/
#define PT6964_DIN     (1)
#define PT6964_DOUT    (1)

#define PT6964_STANBY_KEY	   (45)   /* GPIO5_5 use to standby and wake up in pt6964 panel*/
