...
typedef enum hiSVR_PLAYER_VALUE_E
{
    ...
    HI_SVR_PLAYER_VALUE_U8P,            /**<The type of HI_SVR_PLAYERKVP_S::unValue is HI_U8.* The array length is HI_SVR_PLAYERKVP_S::u32ValueNum.*//**< CNcomment:The type of HI_SVR_PLAYERKVP_S::unValue is HI_S64.*//**< HI_SVR_PLAYERKVP_S::unValue的类型为HI_U8*,数组长度为HI_SVR_PLAYERKVP_S::u32ValueNum */
...
#define HI_SVR_META_PRINT(_meta)                                                \
do {                                                                            \
...
/**
\brief Creates a metadata data structure.CNcomment:创建Metadata结构体 CNend
\attention \n
None.
\param None
\retval Pointer to the ::HI_SVR_PLAYER_METADATA_S data structure. CNcomment: ::HI_SVR_PLAYER_METADATA_S结构体指针 CNend
\see \n
None.
*/
...
/**
\brief Releases the metadata data structure. CNcomment:释放Metadata结构体 CNend
\attention \n
None.
\param None
\retval None.
