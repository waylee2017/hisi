...
E0zVg4C3NiZh4exdkhFHEraoGcOeILRw1DlzQPcKX/C/oUI4mLtmL1+2RUqm2+8wYVpieJXA
+LQVeUCg4dme73/QHLYIzGXR//+j7WCx4JncXuup2lJvBgqr8I15SudPlJMGMeS+BO0rtAa4
A5afOujuOq5PTiPSPJTj6kjZuDjnKX3pAOOka9CrhkCjFId9O8UBtt5HKfOylg==#*/
...
void Resample2X_Flush(HResampler inst)
{
    ...
    if (s != NULL)
    {
        memset(s->histbuf, (NBLOCK + s->nhist) * sizeof(short), 0);
