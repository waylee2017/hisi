...
#ifndef LOADER
    CA_MISCKeyLadder_Open();
    CA_SetMiscAlgorithm(HI_UNF_ADVCA_ALG_TYPE_AES);
    CA_SetMISCSessionKey(HI_UNF_ADVCA_KEYLADDER_LEV1, g_u8MiscInput1);
    CA_SetMISCSessionKey(HI_UNF_ADVCA_KEYLADDER_LEV2, g_u8MiscInput2);
    CA_SetMISCSessionKey(HI_UNF_ADVCA_KEYLADDER_LEV3, g_u8MiscInput3);
    CA_SetMISCSessionKey(HI_UNF_ADVCA_KEYLADDER_LEV4, g_u8MiscInput4);
#else
