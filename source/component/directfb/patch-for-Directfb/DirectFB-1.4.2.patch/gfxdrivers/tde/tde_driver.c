...
HI_S32 ADP_ConvertFormat(DFBSurfacePixelFormat ColorFmt, TDE2_COLOR_FMT_E *pTDEColorFmt)
{
    HI_S32 i;
...
HI_S32 ADP_ConverKey(unsigned long ColorKey, TDE2_COLOR_FMT_E PixelF, TDE2_COLORKEY_U *pKeyValue)
{
    HI_U8 a, r, g, b;
