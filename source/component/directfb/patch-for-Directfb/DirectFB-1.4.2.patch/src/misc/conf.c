...
static void config_allocate( void )
{
     ...
     dfb_config->mmx                      = true;
     dfb_config->vt                       = false;//modiry by w66592, default no vt
     dfb_config->vt_switch                = false;//modiry by w66592, default no vt
     dfb_config->vt_num                   = -1;
     dfb_config->vt_switching             = false;//modiry by w66592, default no vt
