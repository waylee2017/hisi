...
*                       Macro Definitions
*****************************************************************************/
#define CC608_FROM_CABLE    1
#define MAX_DTVCC_PACKET_LEN   128

/* CC data start flags, see A53 page 32 */
#define CABLE_DATA              0x03
#define USER_DATA_START_CODE    0x000001b2
#define ATSC_IDENTIFIER         0x47413934
#define SAUD_IDENTIFIER         0x53415544
#define USER_DATA_TYPE_CODE     0x03    /*CC*/

#define PACKET_START_FLAG       0xFF    /* DTVCC channel packet start flag */
#define PACKET_DATA_FLAG        0xFE    /* DTVCC channel packet data flag */
#define PACKET_END_FLAG1        0xFA
#define PACKET_END_FLAG2        0xFB
#define PACKET_CC608_FIELD1     0xFC
#define PACKET_CC608_FIELD2     0xFD

#define MAX_VBI_DATA_COUNT      15
#define CAPTION_BUF_SIZE 64

/*
   p is buffer pointer;
   o is offset;
   b stand for left move bit number;
*/
#define GET8(p,o)   (p[o] & 0xFF)
#define GET16(p,o)  ((p[o]<<8) | p[(o)+1])
#define GET32(p,o)  ((p[o]<<24) | (p[(o)+1]<<16) | (p[(o)+2]<<8) | p[(o)+3])

#define GET1(p,o,b) ((p[o] >> (b)) & 0x01)
#define GET2(p,o,b) ((p[o] >> (b)) & 0x03)
#define GET3(p,o,b) ((p[o] >> (b)) & 0x07)
#define GET4(p,o,b) ((p[o] >> (b)) & 0x0F)
#define GET5(p,o,b) ((p[o] >> (b)) & 0x1F)
#define GET6(p,o,b) ((p[o] >> (b)) & 0x3F)
#define GET7(p,o,b) ((p[o] >> (b)) & 0x7F)

#define INVALID_SERVICE_NUM (-1)
...
typedef HI_VOID (*DTVCC_CmdDecode_FN)(HI_U8 *pu8Cmd);
typedef struct tagCC708_CmdMap_S
{
    HI_U8 u8CMDLen;
    DTVCC_CmdDecode_FN pfnCmdDecoder;
}CC708_CmdMap_S;

typedef struct tagColor_S
{
    HI_U8 r;
    HI_U8 g;
    HI_U8 b;
...
typedef struct tagCC708_CaptionBuf_S
{
    HI_U16 u16Buf[CAPTION_BUF_SIZE];
    HI_U8  u8BufLen;
}CC708_CaptionBuf_S;

typedef struct tagNTSC_BitStream_S
{
    HI_U8     *pu8Start;
    HI_U8     *pu8Buf;
    HI_U8     *pu8End;
    HI_U8     u8LeftBits;    /* read_count number of available bits */
} NTSC_BitStream_S;

/*******************************************************************************
*                       Static Data Definition
*******************************************************************************/
static HI_VOID _DtvCC_NulCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_ETXCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_BSCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_FFCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_CRCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_HCRCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_EXT1Cmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_P16Cmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_SetCurrentWindowCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_ClearWindowsCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_DisplayWindowsCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_HideWindowsCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_ToggleWindowsCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_DeleteWindowsCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_DelayCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_ResetCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_SetPenAttributesCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_SetPenColorCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_SetPenLocationCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_SetWindowAttributesCmd(HI_U8 *pu8Cmd);
static HI_VOID _DtvCC_DefineWindowCmd(HI_U8 *pu8Cmd);

static HI_BOOL _DtvCC_OddParityCheck(HI_U8 data);
static HI_S32 _DtvCC_GetEXT1CmdLen(HI_U8 *pu8Cmd, HI_S32 avalaible_len);

CC708_CmdMap_S DTVCCCmdMap[64] =
{
    {1,_DtvCC_NulCmd},   // 0x00
    {1,NULL},
    {1,NULL},
    {1,_DtvCC_ETXCmd},   // 0x03
    {1,NULL},
    {1,NULL},
    {1,NULL},
    {1,NULL},
    ...
    {1,_DtvCC_FFCmd},    // 0x0C
    {1,_DtvCC_CRCmd},    // 0x0D
    {1,_DtvCC_HCRCmd},   // 0x0E
    {1,NULL},
    {2,_DtvCC_EXT1Cmd},  // 0x10
    {2,NULL},
    {2,NULL},
    {2,NULL},
    {2,NULL},
    ...
    {3,NULL},
    {3,NULL},
    {1,_DtvCC_SetCurrentWindowCmd},  // 0x80
    {1,_DtvCC_SetCurrentWindowCmd},  // 0x81
    {1,_DtvCC_SetCurrentWindowCmd},  // 0x82
    {1,_DtvCC_SetCurrentWindowCmd},  // 0x83
    {1,_DtvCC_SetCurrentWindowCmd},  // 0x84
    {1,_DtvCC_SetCurrentWindowCmd},  // 0x85
    {1,_DtvCC_SetCurrentWindowCmd},  // 0x86
    {1,_DtvCC_SetCurrentWindowCmd},  // 0x87
    {2,_DtvCC_ClearWindowsCmd},      // 0x88
    {2,_DtvCC_DisplayWindowsCmd},    // 0x89
    {2,_DtvCC_HideWindowsCmd},       // 0x8A
    {2,_DtvCC_ToggleWindowsCmd},     // 0x8B
    {2,_DtvCC_DeleteWindowsCmd},     // 0x8C
    {2,_DtvCC_DelayCmd},             // 0x8D
    {1,NULL},                       // 0x8E
    {1,_DtvCC_ResetCmd},           // 0x8F
    {3,_DtvCC_SetPenAttributesCmd},  // 0x90
    {4,_DtvCC_SetPenColorCmd},       // 0x91
    {3,_DtvCC_SetPenLocationCmd},    // 0x92
    {1,NULL},
    {1,NULL},
    {1,NULL},
    {1,NULL},
    {5,_DtvCC_SetWindowAttributesCmd},// 0x97
    {7,_DtvCC_DefineWindowCmd},      //0x98
    {7,_DtvCC_DefineWindowCmd},      //0x99
    {7,_DtvCC_DefineWindowCmd},      //0x9A
    {7,_DtvCC_DefineWindowCmd},      //0x9B
    {7,_DtvCC_DefineWindowCmd},      //0x9C
    {7,_DtvCC_DefineWindowCmd},      //0x9D
    {7,_DtvCC_DefineWindowCmd},      //0x9E
    {7,_DtvCC_DefineWindowCmd},      //0x9F
};


static HI_U16 DTVCCG2Code2UnicodeMap[96] =
{
    0x1020,0x1021,0x005f,0x005f,0x005f,0x2026,0x005f,0x005f,0x005f,0x005f,0x0160,0x005f,0x0152,0x005f,0x005f,0x005f,
    0x2588,0x2018,0x2019,0x201c,0x201d,0x2022,0x005f,0x005f,0x005f,0x2122,0x0161,0x005f,0x0153,0x2120,0x005f,0x0178,
    0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,
    0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,
    0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,
    0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x215b,0x215c,0x215d,0x215e,0x2502,0x2510,0x2514,0x2500,0x2518,0x250c,
};


static HI_U16 DTVCCG3Code2UnicodeMap[96] =
{
    0xf101,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,
    0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,
    0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,
    0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,
    0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,0x005f,
...
static CC708_CaptionBuf_S stCaptionBuf;

/*******************************************************************************
*                       Static Function  Definition
*******************************************************************************/

static void _DtvCC_DelayTimerCallback(void *pParam)
{
    HI_U8 u8ModuleId = *((HI_U8 *)pParam);
    CC708_OBJECT_S *pstCCObj = CC708_OBJ_GetHandle(u8ModuleId);
    if (HI_NULL == pstCCObj)
    {
        return;
    }

    if(pstCCObj->u8IsDelay)
    {
        pstCCObj->u8IsDelay = 0;
    }
}
static HI_VOID _DtvCC_DelayTimerInit(HI_U8 u8ModuleID)
{
    HI_U32 u32ModuleID = u8ModuleID;
    (HI_VOID)CCTimer_Open(CCTIMER_ID_708DELAY, _DtvCC_DelayTimerCallback, (HI_VOID *)u32ModuleID);
}

static void _DtvCC_DelayTimerStart(HI_U8 u8ModuleID, HI_U8 u8TenthOfSecond)
{
    HI_U32 u32Msec = u8TenthOfSecond * 100;
   (HI_VOID)CCTimer_Start(CCTIMER_ID_708DELAY, u32Msec, TIMER_MODE_ONE_SHOOT);
}

static void _DtvCC_DelayTimerStop(HI_U8 u8ModuleID)
{
    (HI_VOID)CCTimer_Stop(CCTIMER_ID_708DELAY);
}

static HI_U32 _DtvCC_Translate2Color(HI_U8 u8Color)
{
    Color_S stRGB;

    HI_U32 u32Color = 0;

    static HI_U32 au8RGBMap[3][4] = {
    /*red*/        {0xff000000,0x005f0000,0x00af0000,0x00ff0000},
    /*green*/     {0xff000000,0x00005f00,0x0000af00,0x0000ff00},
    /*blue*/       {0xff000000,0x0000005f,0x000000af,0x000000ff}
    };

    stRGB.r = (u8Color & 0x30)>>4;
    stRGB.g = (u8Color & 0x0c)>>2;
    stRGB.b = u8Color & 0x03;

    u32Color=au8RGBMap[0][stRGB.r] | au8RGBMap[1][stRGB.g] | au8RGBMap[2][stRGB.b];

    return u32Color;
}

/****************************************************************************************
*                                   Coding Layer Decoder Function Definitions
*****************************************************************************************/
/************************************************************************
 * Function name: HI_S32 _DtvCC_ParseServiceBlock(HI_U8 *pbuf, HI_U8 len)
 * Description: DTV CC service decoder.
 * Arguments: pbuf: the address of the service data.
 *                   len:  the length of the service len.
 * Return value:
 * Note:
 * Todo:
 *************************************************************************/
static HI_S32 _DtvCC_ParseServiceBlock(HI_U8 *pu8Buf, HI_U8 u8BufLen)
{
    CC708_OBJECT_S *pstCCObj = CC708_OBJ_GetHandle(0);
    HI_U8 *pu8ServiceData = NULL;
    HI_U8 u8ServiceLen,u8Offset = 0;
    HI_U8 u8ServiceData;
    DTVCC_CMDBuffer_S *pstCMDBuffer = &pstCCObj->stCMDBuffer;

    if(NULL == pu8Buf || 0 == u8BufLen)
    {
        HI_ERR_CC("pu8Buf pointer NULL!\n");
        return HI_FAILURE;
    }

    u8ServiceLen = u8BufLen;
    pu8ServiceData = pu8Buf;

    if(pstCMDBuffer->u8CurSize < pstCMDBuffer->u8TotalSize)
    {
        /*follow case happened when a cmd transport in two services*/
        if((u8ServiceLen - u8Offset) >= (pstCMDBuffer->u8TotalSize - pstCMDBuffer->u8CurSize))
        {
            CC708_CmdMap_S CmdMap;
            HI_U8 u8CMD;
            HI_U8 CmdLen;
            DTVCC_CmdDecode_FN DTVCCCmdDecoder;

            memcpy(&pstCMDBuffer->au8CMD[pstCMDBuffer->u8CurSize],pu8ServiceData,pstCMDBuffer->u8TotalSize - pstCMDBuffer->u8CurSize);

            //u8CMD = pstCMDBuffer->au8CMD[0];

            u8CMD = pu8ServiceData[u8Offset];
            CmdMap = DTVCCCmdMap[((u8CMD&0x80)>>2)|(u8CMD&0x1f)];
            CmdLen = CmdMap.u8CMDLen;
            DTVCCCmdDecoder = CmdMap.pfnCmdDecoder;

            if(DTVCCCmdDecoder != NULL)
            {
                DTVCCCmdDecoder(pstCMDBuffer->au8CMD);
            }

            pstCMDBuffer->u8CurSize = 0;
            pstCMDBuffer->u8TotalSize = 0;
            memset(pstCMDBuffer->au8CMD,0,8);

            u8Offset += CmdLen;
        }
        else
        {
            memcpy(&pstCMDBuffer->au8CMD[pstCMDBuffer->u8CurSize],pu8ServiceData,u8ServiceLen - u8Offset);

            pstCMDBuffer->u8CurSize += u8ServiceLen - u8Offset;
    ...
    while(u8Offset < u8ServiceLen)
    {
        u8ServiceData = GET8(pu8ServiceData,u8Offset);
        if(u8ServiceData < 0x20 || ((0x7f < u8ServiceData) && (u8ServiceData < 0xa0)))/*CMD,C0,C1*/
        {
            CC708_CmdMap_S stCmdMap;
            HI_U8 u8CmdLen = 0;
            DTVCC_CmdDecode_FN pfnDTVCCCmdDecoder;

            stCmdMap = DTVCCCmdMap[((u8ServiceData&0x80) >>2 )|(u8ServiceData & 0x1f)];
            u8CmdLen = stCmdMap.u8CMDLen;
            pfnDTVCCCmdDecoder = stCmdMap.pfnCmdDecoder;

            /*when servive data is DTVCC command or ETX(0x30),the caption data will be paint on the screen.P35 S8.6*/
            if(((0x7f < u8ServiceData) && (u8ServiceData < 0xa0)) || u8ServiceData == C0_ETX || u8ServiceData== C0_CR || u8ServiceData== C0_HCR || u8ServiceData== C0_FF)
            {
               if((stCaptionBuf.u8BufLen > 0) && (stCaptionBuf.u8BufLen <= CAPTION_BUF_SIZE))
               {
                  CC708_OSD_DrawCaptionToWindow(stCaptionBuf.u16Buf,stCaptionBuf.u8BufLen);
                  memset(stCaptionBuf.u16Buf, 0, sizeof(HI_U16)*stCaptionBuf.u8BufLen);
                  stCaptionBuf.u8BufLen = 0;
               }
            }

            if(u8ServiceData == C0_EXT1)
            {
                u8CmdLen = _DtvCC_GetEXT1CmdLen(&pu8ServiceData[u8Offset],u8ServiceLen-u8Offset);
            }

            /* cmd integrity check,cmd in more than one service */
            if(u8CmdLen > (u8ServiceLen-u8Offset))
            {
                pstCMDBuffer->u8TotalSize = u8CmdLen;
                pstCMDBuffer->u8CurSize = u8ServiceLen - u8Offset;
                memcpy(pstCMDBuffer->au8CMD,&pu8ServiceData[u8Offset],u8ServiceLen - u8Offset);
                break;
            }

            if(pfnDTVCCCmdDecoder != NULL)
            {
                pfnDTVCCCmdDecoder(&pu8ServiceData[u8Offset]);
            }

            u8Offset += u8CmdLen;
        }
        else if (u8ServiceData > 0x9f || ((0x1F < u8ServiceData) &&(u8ServiceData < 0x80)))      /*CAP*/
        {
            HI_U16 u16Caption;

            if(pu8ServiceData[u8Offset] == 0x7f)/*music unicode code*/
            {
                u16Caption = 0x266a;
            }
            else
            {
                u16Caption = pu8ServiceData[u8Offset];
            }

            stCaptionBuf.u16Buf[stCaptionBuf.u8BufLen++] = u16Caption;
            u8Offset += 1;
        }
...
/*CEA-708 P24 */
static HI_S32 _DtvCC_GetEXT1CmdLen(HI_U8 *pu8Cmd, HI_S32 s32AvalaibleLen)
{
    HI_U8 u8ByteCode;
    HI_U8 u8Length;

    u8ByteCode = GET8(pu8Cmd,1);
    ...
    else if(u8ByteCode <= 0x0f)
    {
        return 3;
    }
    else if(u8ByteCode <= 0x17)
    {
        return 4;
    }
    else if(u8ByteCode <= 0x1F)
    {
        return 5;
    }

    /* C3 code set  */
    if( (u8ByteCode >= 0x80)&&(u8ByteCode <= 0x87) )
    {
        return 6;
    }
    else if( (u8ByteCode >= 0x88)&&(u8ByteCode <= 0x8f) )
    {
        return 7;
    }

    /* variable u8Length commands S7.4.8*/
    if( ( u8ByteCode & 0xf0) == 0x90 )
    {
        if( s32AvalaibleLen >= 3 )
        {
            u8Length = GET6(pu8Cmd,2,0);
            return u8Length+3;
        }
        else
        {
            return s32AvalaibleLen + 1;
        }
    }
...
/*************************************************************************************************
 * Function name: static HI_U8 _DtvCC_DetectRstDcCmd(HI_U8 *pbuf, HI_U8 len, HI_U8 *pu8Cmd)*
 * Description: detect delay cancel and reset command before buffer service input data.                  *
 * Arguments:   pbuf: the address of the service data.                                           *
 *                     len:  the length of the service data.                                            *
 *                     pu8Cmd: pointer to return the found command.                                       *
 * Return value: if find the delay cancel or reset command, return the position of the command.  *
 * Note:                                                                                         *
 * Todo:                                                                                         *
 *************************************************************************************************/
static HI_U8 _DtvCC_DetectRstDcCmd(HI_U8 *pu8buf, HI_U8 u8BufLen, HI_U8 *pu8Cmd)
{
    HI_U8 *pu8Service = NULL;
    HI_U8 u8ServiceLen,u8Offset = 0;
    HI_U8 u8ServiceData;

    if(NULL == pu8buf || u8BufLen == 0 || pu8Cmd == NULL)
    {
        HI_ERR_CC("pu8buf pointer NULL!\n");
        return 0;
    }
    ...
    *pu8Cmd = C0_NUL;
    ...
    while(u8Offset < u8ServiceLen)
    {
        u8ServiceData = GET8(pu8Service,u8Offset);

        if(u8ServiceData < 0x20 || ((0x7f < u8ServiceData) && (u8ServiceData < 0xa0))) /*C0,C1*/
        {
            CC708_CmdMap_S stCmdMap;
            HI_S32 s32CmdLen;

            stCmdMap = DTVCCCmdMap[((u8ServiceData&0x80)>>2)|(u8ServiceData&0x1f)];
            s32CmdLen = stCmdMap.u8CMDLen;

            /*Extended code space,get ext1 cmd code length */
            if(u8ServiceData == C0_EXT1)
            {
                s32CmdLen = _DtvCC_GetEXT1CmdLen(&pu8Service[u8Offset],u8ServiceLen-u8Offset);
            }
            /* cmd integrity check */
            if(s32CmdLen > (u8ServiceLen-u8Offset))
            {
                break;
            }

            /* decode delay cancel command */
            if(u8ServiceData == C1_DLC)
            {
                DEC_TRACE("Get delay cancel command!\n");
                *pu8Cmd = C1_DLC;
                break;
            }
            else if(u8ServiceData==C1_RST)
            {
                DEC_TRACE("Get reset command!\n");
                *pu8Cmd = C1_RST;
                break;
            }
        ...
        {
            /* cc caption data or undefined service data */
            u8Offset ++;
        }
    }
...
/**********************************************************************************************************************
*                                   Service Layer Decoder Function Definitions
**********************************************************************************************************************/

/********************************************************************************************
 *  put_servicedata_tofifo: put data to service_fifo  [productor]
 *  process_servicefifo will be the consumer to process data.
 *******************************************************************************************/
static HI_VOID _DtvCC_PutServiceDataToFIFO( HI_U8 *pu8Buf,HI_U8 u8BufLen)
{
    DTVCC_ServiceElement_S stSvsElement;
    CC708_OBJECT_S *pstCCObj = CC708_OBJ_GetHandle(0);
    HI_U8 u8Position,n;
    HI_U8 u8Cmd = 0;

    /* pre-detect the reset/delay cancle command */
    u8Position = _DtvCC_DetectRstDcCmd(pu8Buf,u8BufLen,&u8Cmd);
    if (u8Cmd == C1_RST) /*if find reset command*/
    {
        pstCCObj->u8IsDelay = 0;
        _DtvCC_DelayTimerStop(0);

        u8Position += 1;// skip reset command
        u8BufLen -= (u8Position);// clear the data before reset command

        if(u8BufLen > 0)
        {
            memmove(pu8Buf,pu8Buf+u8Position,u8BufLen);
        }
        (HI_VOID)CC708_OSD_Reset();
    }
    else if (u8Cmd == C1_DLC) //if find delay cancle command
    {
        pstCCObj->u8IsDelay = 0;
        _DtvCC_DelayTimerStop(0);
    }

    /*Insert the remainder Buffered data to queue.*/
    if (u8BufLen > 0)
    {
        n = CCQueue_GetHeadPos(&pstCCObj->stServiceQueue);
        stSvsElement.pu8Buffer = pstCCObj->au8ServiceData[n];
        memcpy(stSvsElement.pu8Buffer,pu8Buf,u8BufLen);
        stSvsElement.u8ServiceLen = u8BufLen;

        if (!CCQueue_Insert(&pstCCObj->stServiceQueue,&stSvsElement))
        {
            HI_INFO_CC("ServiceQueue full,reset delay command \n");
            pstCCObj->u8IsDelay = 0;
            _DtvCC_DelayTimerStop(0);
        }
    }
...
static HI_S32 _DtvCC_CheckSvcBlockDataIntegrality(HI_U8 *pu8buf,HI_U8 u8BufSize)
{
    HI_S32 i;
    HI_U8 u8Data;
    ...
    {
        u8Data = pu8buf[i];
        if(u8Data < 0x20 || ((0x7f < u8Data) && (u8Data < 0xa0)))    /*CMD*/
        {
            CC708_CmdMap_S stCmdMap;
            HI_S32 u32CmdLen;

            stCmdMap = DTVCCCmdMap[((u8Data&0x80)>>2)|(u8Data&0x1f)];
            u32CmdLen = stCmdMap.u8CMDLen;

            /* ext1 cmd is a variable length cmd, we should get ext1 cmd code length here */
            if(u8Data == C0_EXT1)
            {
                u32CmdLen = _DtvCC_GetEXT1CmdLen(&pu8buf[i],u8BufSize-i);
            }

            /* cmd integrity check */
            if(u32CmdLen > (u8BufSize-i))
            {
                DEC_TRACE("CMD 0x%x not complete, length:%d,CmdLen:%d\n",u8Data,(u8BufSize-i),u32CmdLen);
                return i;
            }
...
/***************************************************************************
 * function name: _DtvCC_ParsePacketData(HI_U8 *pPacketBuf, HI_U8 u8BufLen)         *
 * description:   Service Block Parse Routine                              *
 *                Put the specific block_data to cc708 queue               *
 ***************************************************************************/
static HI_S32 _DtvCC_ParsePacketData(HI_U8 *pu8PacketBuf, HI_U8 u8BufLen)
{
    CC708_OBJECT_S *pstCCObj = CC708_OBJ_GetHandle(0);
    HI_U8 u8ServiceSize    = 0;
    HI_U8 u8HeaderSize,u8ServiceNo;
    HI_U8 u8Offset         = 0;

    DTVCC_ServiceBlock_S *pServiceBlock = &pstCCObj->stServiceBlock;
    DTVCC_Packet_S *pPacket             = &pstCCObj->stPacket;

    if( NULL == pu8PacketBuf || u8BufLen == 0 )
    {
        HI_ERR_CC("service block null!\n");
        return HI_FAILURE;
    }

    while( u8Offset < u8BufLen )
    {
        if(pstCCObj->bServiceBlockEnded == HI_TRUE)
        {
            // parse service block header
            u8ServiceSize  = GET5(pu8PacketBuf, u8Offset, 0);
            u8ServiceNo    = GET3(pu8PacketBuf, u8Offset, 5);
            u8Offset++;
            u8HeaderSize   = 1;
            DEC_TRACE("u8ServiceNo = %d,u8ServiceSize = %d\n",u8ServiceNo,u8ServiceSize);
            /*now we didn't support extend service*/
            if( (u8ServiceNo == 7) && (u8ServiceSize != 0) )
            {
                u8ServiceNo = GET6(pu8PacketBuf,u8Offset,0);
                u8Offset++;
                u8HeaderSize = 2;
            }

            /*null service block*/
            if( (u8ServiceNo == 0) || (u8ServiceSize == 0) )
            {
                continue;
            }

            if((pServiceBlock->u8CurSize + u8HeaderSize + u8ServiceSize) > pPacket->u8TotalSize)
            {
                HI_INFO_CC("Block extends past the end of packet!Reset!\n");
                (HI_VOID)CC708_DEC_Reset(0);
                break;
            }

            pServiceBlock->u8ServiceSize = u8ServiceSize;
            pServiceBlock->u8ServiceNo = u8ServiceNo;
            pServiceBlock->u8CurSize = 0;

            pstCCObj->bServiceBlockEnded = HI_FALSE;

            continue;
        }

        if((pServiceBlock->u8ServiceNo == pstCCObj->u32ServiceType) && CC708_IsStart(0))
        {
            //the follow case happened when one service block cross in two packets
            if((pServiceBlock->u8ServiceSize - pServiceBlock->u8CurSize) > (u8BufLen - u8Offset))
            {
                memcpy(&pServiceBlock->u8Data[pServiceBlock->u8CurSize],pu8PacketBuf+u8Offset,u8BufLen - u8Offset);
                pServiceBlock->u8CurSize += u8BufLen - u8Offset;
                u8Offset += u8BufLen;

                if((_DtvCC_CheckSvcBlockDataIntegrality(pServiceBlock->u8Data,
                           pServiceBlock->u8CurSize)) != pServiceBlock->u8CurSize)
                {
                    continue;
                }

                _DtvCC_PutServiceDataToFIFO( pServiceBlock->u8Data,pServiceBlock->u8CurSize);

                pServiceBlock->u8ServiceSize -= pServiceBlock->u8CurSize;
                pServiceBlock->u8CurSize = 0;
            }
            else              /*find a  servive block in a packet*/
            {
                memcpy(&pServiceBlock->u8Data[pServiceBlock->u8CurSize],
                       pu8PacketBuf+u8Offset,pServiceBlock->u8ServiceSize - pServiceBlock->u8CurSize);
                u8Offset += pServiceBlock->u8ServiceSize - pServiceBlock->u8CurSize;

                _DtvCC_PutServiceDataToFIFO( pServiceBlock->u8Data,pServiceBlock->u8ServiceSize);

                pServiceBlock->u8CurSize = 0;
                pServiceBlock->u8ServiceSize = 0;
                pServiceBlock->u8ServiceNo = 0;
                pstCCObj->bServiceBlockEnded = HI_TRUE;
            }
        }
        else    /*do not put the service data into service queue*/
        {
            if((pServiceBlock->u8ServiceSize - pServiceBlock->u8CurSize) > (u8BufLen - u8Offset))
            {
                pServiceBlock->u8CurSize += u8BufLen - u8Offset;
...
/**********************************************************************************************************************
*                                   Packet Layer Decoder Function Definitions
**********************************************************************************************************************/


static HI_VOID _DtvCC_ParsePacket(HI_U8 *pu8PacketBuf, HI_U8 u8PacketLen)
{
    if( NULL == pu8PacketBuf || u8PacketLen == 0 )
    {
        HI_ERR_CC("packet null or lenght zero!\n");
        return ;
    }

    /*The Caption Channel Packet consists of a 1 byte header and n-1 bytes of packet data*/
    _DtvCC_ParsePacketData(pu8PacketBuf+1,u8PacketLen-1);/*skip packet head*/
}


static inline HI_VOID _DtvCC_EndPacket(HI_VOID)
{
    CC708_OBJECT_S *pstCCObj = CC708_OBJ_GetHandle(0);
    DTVCC_Packet_S *pstPacket = &pstCCObj->stPacket;

    _DtvCC_ParsePacket(pstPacket->au8PacketData,pstPacket->u8CurSize);

    if(pstPacket->u8CurSize == pstPacket->u8TotalSize)
    {
        memset(pstPacket,0,sizeof(pstPacket->au8PacketData));
        pstPacket->bStart = HI_FALSE;
        memset(&pstCCObj->stServiceBlock,0,sizeof(pstCCObj->stServiceBlock));
    }
    else
    {
        pstPacket->u8TotalSize -= pstPacket->u8CurSize;
        pstPacket->u8CurSize = 0;
    }

}


/*function:check if continuous packet*/
static HI_VOID _DtvCC_CheckPacketSequenceNo(HI_VOID)
{
    CC708_OBJECT_S *pstCCObj = CC708_OBJ_GetHandle(0);
    DTVCC_Packet_S *pstPacket = &pstCCObj->stPacket;


    /*the first time to decode packet data*/
    if(pstCCObj->s32LastSeqenceNo == INVALID_SERVICE_NUM)
    {
        pstCCObj->s32LastSeqenceNo = pstPacket->u8SeqenceNo;
    }
    else
    {
        if( pstPacket->u8SeqenceNo != ((pstCCObj->s32LastSeqenceNo + 1) & 0x03 ) )
        {
            DEC_TRACE("Sequence number error!,SeqenceNo:%d,LastSeqenceNo:%d\n",pstPacket->u8SeqenceNo,pstCCObj->s32LastSeqenceNo);
            /*invalide sequence number*/
            /*when a lost packet is detected,any partially accumulated data
                      from the previously received packet is to be discarded,and the
                      processing associated with the CC708Reset command should be performed
                      for each existing service 708 Spec P11*/
            pstCCObj->s32LastSeqenceNo = INVALID_SERVICE_NUM;
...
/**********************************************************************
 * function name: _DtvCC_ParsePicUsrData(...)
 * description:   dispatch cc608(NTSC) and cc708 data
 *                put cc708 to packet buffer, 608 to vbi queue
 **********************************************************************/
static HI_S32 _DtvCC_ParsePicUsrData( HI_U8 *pu8CCPicData, HI_U8 u8CCdataLength, HI_BOOL bCheckATSC608)
{
    CC708_OBJECT_S *pstCCObj = CC708_OBJ_GetHandle(0);
    ...
    HI_U8 au8NtscData[MAX_VBI_DATA_COUNT] = {0};
    HI_U8 u8NtscCounter = 0;

    if( (NULL == pu8CCPicData) || (u8CCdataLength == 0) )
    {
        HI_ERR_CC("Param invalid!\n");
        return HI_FAILURE;
    }

    HI_UNF_CC_VBI_DADA_S stVBIDataField1, stVBIDataField2;
    stVBIDataField1.u8FieldParity = CC608_VBI_FIELD1;
    stVBIDataField1.u8Data1 = 0;
    stVBIDataField1.u8Data2 = 0;

    stVBIDataField2.u8FieldParity = CC608_VBI_FIELD2;
    stVBIDataField2.u8Data1 = 0;
    stVBIDataField2.u8Data2 = 0;

    while( u8offset < u8CCdataLength )
    {
        u8CCFlag = pu8CCPicData[u8offset++];
        u8LoopTimes = 2;

        switch(u8CCFlag)
        {
            case PACKET_START_FLAG:  /* get a new packet,also means prepacket end*/
            {
                if(pstPacket->u8CurSize > 0)
                {
                    _DtvCC_EndPacket();
                }

                /*decode the packet length,here include the 1 byte header*/
                pstPacket->u8SeqenceNo = (pu8CCPicData[u8offset] & 0xC0) >> 6;
                u8PacketLen = pu8CCPicData[u8offset] & 0x3f;
                _DtvCC_CheckPacketSequenceNo();

                pstPacket->u8TotalSize = (u8PacketLen == 0)?(128):(u8PacketLen*2);
                if(((pstPacket->u8CurSize + 2) > MAX_DTVCC_PACKET_LEN) || ((u8offset+1) >= u8CCdataLength))
                {
                    HI_ERR_CC("packetlen:%d +2 >= MAX_LEN:%d\n",pstPacket->u8CurSize,MAX_DTVCC_PACKET_LEN);
                    return HI_FAILURE;
                }

                pstPacket->au8PacketData[pstPacket->u8CurSize++] = pu8CCPicData[u8offset++];
                pstPacket->au8PacketData[pstPacket->u8CurSize++] = pu8CCPicData[u8offset++];/*SHOULD BE TWO BYTES*/

                pstPacket->bStart = HI_TRUE;
                if((pstPacket->u8CurSize > 0) && (pstPacket->u8CurSize == pstPacket->u8TotalSize))
                {
                    _DtvCC_EndPacket();
                }
            ...
            case PACKET_DATA_FLAG:
            {
                if(pstPacket->bStart)
                {
                    while((u8LoopTimes-- > 0) && (pstPacket->u8CurSize < pstPacket->u8TotalSize))
                    {
                        pstPacket->au8PacketData[pstPacket->u8CurSize++] = pu8CCPicData[u8offset++];
                        if( (pstPacket->u8CurSize > 0) && (pstPacket->u8CurSize == pstPacket->u8TotalSize) )
                        {
            ...
            case PACKET_CC608_FIELD1:
            case PACKET_CC608_FIELD2:
            {
                if(PACKET_CC608_FIELD1 == u8CCFlag)
                {
                     stVBIDataField1.u8FieldParity = CC608_VBI_FIELD1;
                     stVBIDataField1.u8Data1 = pu8CCPicData[u8offset];
                     stVBIDataField1.u8Data2 = pu8CCPicData[u8offset + 1];
                }
                else
                {
                    stVBIDataField2.u8FieldParity = CC608_VBI_FIELD2;
                    stVBIDataField2.u8Data1 = pu8CCPicData[u8offset];
                    stVBIDataField2.u8Data2 = pu8CCPicData[u8offset + 1];
                }

                if((pu8CCPicData[u8offset] == 0) && (pu8CCPicData[u8offset+1]==0 ))
                {
                    u8offset +=2;
                    break;
                }

                if(u8CCFlag == PACKET_CC608_FIELD1)
                {
                    au8NtscData[u8NtscCounter++] = CC608_VBI_FIELD1;
                }
                else
                {
                    au8NtscData[u8NtscCounter++] = CC608_VBI_FIELD2;
                }
                while(u8LoopTimes-- > 0)
                {
                    if( u8offset >= u8CCdataLength)
                    {
                        HI_ERR_CC("u8offset:%d  >= u8CCdataLength:%d\n",u8offset,u8CCdataLength);
                        return HI_FAILURE;
                    }
                    au8NtscData[u8NtscCounter++] = pu8CCPicData[u8offset++];
                }

                break;
            }
            case PACKET_END_FLAG1:
            case PACKET_END_FLAG2:
            {
                if((pstPacket->u8CurSize > 0) && (pstPacket->u8CurSize >= pstPacket->u8TotalSize))
                {
                    _DtvCC_EndPacket();
    ...
    if( u8NtscCounter > 0)
    {
          (HI_VOID)CCDISP_SendVbiData(&stVBIDataField1,&stVBIDataField2);
    }

    /*one user data ,parse one time 608 data*/
    if( (u8NtscCounter > 0) && (u8NtscCounter < (MAX_VBI_DATA_COUNT - 1)) && bCheckATSC608 && CC608_IsStart(0))
    {
        /*There are 608 in this user data*/
        HI_U8 loop = 0;
        HI_U8 buff[3];

        for (loop = 0; loop < u8NtscCounter-2; loop += 3)
        {
            //copy to buff
            buff[0] = au8NtscData[loop];   //field
            buff[1] = au8NtscData[loop+1]; //ccdata1
            buff[2] = au8NtscData[loop+2]; //ccdata2

            if (_DtvCC_OddParityCheck(buff[1]) && _DtvCC_OddParityCheck(buff[2]))
            {
                //parse normal data
                CC608_VBIParse(0,buff,3);
            }
        }
    }
    return HI_SUCCESS;
...
static inline void _DtvCC_BitStreamInit( NTSC_BitStream_S *s, void *p_data, int i_data )
{
    s->pu8Start = (HI_U8 *)p_data;
    s->pu8Buf       = (HI_U8 *)p_data;
    s->pu8End   = s->pu8Buf + i_data;
    s->u8LeftBits  = 8;
}


static inline HI_U8 _DtvCC_BitStreamRead( NTSC_BitStream_S *s, HI_U8 read_count )
{
    ...
    while( read_count > 0 )
    {
        if( s->pu8Buf >= s->pu8End )
        {
            break;
        }

        if( ( i_shr = s->u8LeftBits - read_count ) >= 0 )/* more in the buffer than requested */
        {
            i_result |= ( *s->pu8Buf >> i_shr )&i_mask[read_count];
            s->u8LeftBits -= read_count;
            if( s->u8LeftBits == 0 )
            {
                s->pu8Buf++;
                s->u8LeftBits = 8;
        ...
        else /* less in the buffer than requested */
        {
           if(s->u8LeftBits >= 33)
           {
                break;
           }
           i_result |= (*s->pu8Buf&i_mask[s->u8LeftBits]) << (0-i_shr);
           read_count  -= s->u8LeftBits;
           s->pu8Buf++;
           s->u8LeftBits = 8;
        }
    }
...
static HI_S32 _DtvCC_DecodeCABLE(HI_U8 *pBuf, HI_U8 BufLen, HI_BOOL bTopFieldFirst)
{
    HI_U8 cc_invalid = 1;
    HI_U8 vbi_data_flag = 0,field_number=0;
    HI_U8 cc_data1=0,cc_data2=0;
    HI_U8 ccdata1=0,ccdata2=0;
    HI_U8 ccCount = 0,i=0;
    HI_U8 pucCCData[3];
    NTSC_BitStream_S s;
    ...
    _DtvCC_BitStreamInit(&s,pBuf,BufLen);

    vbi_data_flag = _DtvCC_BitStreamRead(&s,8);
    if(vbi_data_flag & 0x01)
    {
        ccCount = _DtvCC_BitStreamRead(&s,5);
        HI_UNF_CC_VBI_DADA_S stVBIDataField1,stVBIDataField2;
        stVBIDataField1.u8FieldParity = CC608_VBI_FIELD1;
        stVBIDataField1.u8Data1 = 0x80;
        stVBIDataField1.u8Data2 = 0x80;

         stVBIDataField2.u8FieldParity = CC608_VBI_FIELD2;
         stVBIDataField2.u8Data1 = 0x80;
         stVBIDataField2.u8Data2 = 0x80;
        
        for(i=0;i<ccCount;i++)
        {
            (HI_VOID)_DtvCC_BitStreamRead(&s,2);//priority: 2bits
            field_number = _DtvCC_BitStreamRead(&s,2);//field_number: 2bits
            (HI_VOID)_DtvCC_BitStreamRead(&s,5);//line_offset: 5bits
            cc_data1 = _DtvCC_BitStreamRead(&s,8);//cc1: 8bits
            cc_data2 = _DtvCC_BitStreamRead(&s,8);//cc2: 8bits
            (HI_VOID)_DtvCC_BitStreamRead(&s,1);//marker_bit: 1bits

            //revert ccdata1 and ccdata2
            ccdata1 = ReverseChar(cc_data1);
            ccdata2 = ReverseChar(cc_data2);
            ...
            if(HI_FALSE == bTopFieldFirst)
            {
                field_number ^= 0x01;
            }
            if(field_number == 1)
            {
                pucCCData[0] = CC608_VBI_FIELD2; /*field number*/
            }
            else
            {
                pucCCData[0] = CC608_VBI_FIELD1; /*field number*/
            }

            pucCCData[1] = ccdata1 & 0x7f;
            pucCCData[2] = ccdata2 & 0x7f;

            if(cc_invalid == 1)
            {
                if(CC608_VBI_FIELD1==pucCCData[0])
                {
                     stVBIDataField1.u8FieldParity =  pucCCData[0] ;
                     stVBIDataField1.u8Data1 = ccdata1;
                     stVBIDataField1.u8Data2 = ccdata2;
                }
                else
                {
                     stVBIDataField2.u8FieldParity =  pucCCData[0] ;
                     stVBIDataField2.u8Data1 = ccdata1;
                     stVBIDataField2.u8Data2 = ccdata2;
                }
                
            }


            if( (pucCCData[1] != 0 || pucCCData[2] != 0) && cc_invalid == 1 )
            {
                CC608_VBIParse(0, pucCCData, 3);
            }
        }
...
static HI_S32 _DtvCC_DecodeSAUD(HI_U8 *pBuf, HI_U8 BufLen, HI_BOOL bCheckATSC608)
{
    HI_U8 saud_type = 0,offset = 0;
    HI_U8 cc_count = 0;
    int i,field_num,ccdata1,ccdata2;
    HI_U8 au8608Data[3];
    ...
    saud_type = GET8(pBuf,offset);
    offset++;
    if( saud_type != 0x04 )
    {
        return HI_FAILURE;
    }
    cc_count = GET8(pBuf,offset);
    offset++;
    cc_count = (cc_count&0x1f);
    if( cc_count*3 + offset > BufLen )
    {
        HI_ERR_CC("invalide cc_count:%d for saud data BufLen:%d,underflow\n",cc_count, BufLen);
        return HI_FAILURE;
    }
    for(i=0; i<cc_count; i++)
    {
        field_num = GET8(pBuf,offset);
        field_num = (field_num&0x03);
        offset++;
        ccdata1 = GET8(pBuf,offset);
        offset++;
        ccdata2 = GET8(pBuf,offset);
        offset++;

        /*field number*/
        if(field_num ==1 )
        {
            au8608Data[0] = CC608_VBI_FIELD1;
        }
        else if(field_num ==2)
        {
            au8608Data[0] = CC608_VBI_FIELD2;
        }
        else if(field_num ==3)
        {
            au8608Data[0] = CC608_VBI_FIELD2;
        ...
        au8608Data[1] = ccdata1 & 0x7f;
        au8608Data[2] = ccdata2 & 0x7f;

        if( (ccdata1 != 0 || ccdata2 != 0)&& bCheckATSC608 )
        {
            (HI_VOID)CC608_VBIParse(0, au8608Data, 3);
        }
    }
    return HI_SUCCESS;
}
...
#endif
/*********************************************************************************
* function name: Decode_ATSC()                                                  *
* description:   decode the atsc cc according to the SCTE21 P15                 *
*                the buffer passed into this function all with the identifier   *
*                0x47413934 and the buffer begin at the user_data_type_code     *
*********************************************************************************/
static HI_S32 _DtvCC_DecodeATSC(HI_U8 *pu8Buf, HI_U8 u8BufLen, HI_BOOL bCheckATSC608)
{
    HI_U8 u8Offset = 0;
    HI_U8 u8ProcessFlag = 0;
    HI_U8 u8DataType = 0;
    HI_U8 u8ccCount = 0;
    ...
    u8DataType = GET8(pu8Buf,u8Offset);
    u8Offset++;
    switch(u8DataType)
    {
    case USER_DATA_TYPE_CODE:    /*CC*/
        u8ProcessFlag = GET1(pu8Buf,u8Offset,6);
        if(!u8ProcessFlag)        /*needn't deal with the cc data*/
        {
            HI_ERR_CC("\nProcess flag is 0\n");
            return HI_FAILURE;
        }
        u8ccCount = GET5(pu8Buf,u8Offset,0);
        u8Offset += 2;            /*include em_data(reserve) u8Offset*/

        if((u8ccCount*3) >= (u8BufLen - u8Offset))
        {
            HI_ERR_CC("Data len is less than cc data in stream!");
            return HI_FAILURE;
        }

        /*check ccCount validation, check marker_bits*/
        if((pu8Buf[u8Offset + u8ccCount*3] != 0xFF) && (pu8Buf[u8Offset + u8ccCount*3] != 0xF8))
        {
            HI_ERR_CC("Invalid userdata mask value:%#x !\n",pu8Buf[u8Offset + u8ccCount*3 ]);
        }

        (HI_VOID)_DtvCC_ParsePicUsrData(&pu8Buf[u8Offset], u8ccCount*3, bCheckATSC608);
    ...
    case 0x04:
        ...
        break;
    default:
        HI_ERR_CC("User Data type not match: 0x%x\n",u8DataType);
        return HI_FAILURE;
    }
    return HI_SUCCESS;
}
...
*                    export Function
*****************************************************************************/
HI_S32 CC708_DEC_Start(HI_U8 u8ModuleID)
{
    stCaptionBuf.u8BufLen = 0;
    _DtvCC_DelayTimerInit(u8ModuleID);

    return HI_SUCCESS;
}

HI_S32 CC708_DEC_Stop(HI_U8 u8ModuleID)
{
    CC708_OBJECT_S *pstCCObj = CC708_OBJ_GetHandle(u8ModuleID);
    if( pstCCObj == NULL )
    {
        HI_ERR_CC("Invalid module id!\n");
        return HI_FAILURE;
    }
    ...
    {
        pstCCObj->u8IsDelay = 0;
        _DtvCC_DelayTimerStop(u8ModuleID);
    }

    return HI_SUCCESS;
}

HI_S32 CC708_DEC_Reset(HI_U8 u8ModuleID)
{
    CC708_OBJECT_S *pstCCObj = CC708_OBJ_GetHandle(u8ModuleID);
    if( pstCCObj == NULL )
    {
    ...
    memset(&pstCCObj->stCMDBuffer, 0, sizeof(DTVCC_CMDBuffer_S));
    memset(&pstCCObj->stPacket, 0, sizeof(DTVCC_Packet_S));
    memset(&pstCCObj->stServiceBlock, 0, sizeof(DTVCC_ServiceBlock_S));
...
HI_S32 CC708_DEC_UserDataParse(HI_U8 *pu8UserData, HI_U32 u32DataLen, HI_BOOL bTopFieldFirst)
{
    ...
    HI_U8 *pu8Buf = pu8UserData;
    HI_BOOL bCheckATSC608 = HI_TRUE;

    if(HI_NULL == pu8UserData || 0 == u32DataLen )
    {
        HI_ERR_CC("\nParam invalid\n");
        return HI_FAILURE;
    }

    /*Userdata from AVPLAY is pure data ,not include the userdata head*/
    while (u32offset < u32DataLen)
    {
#if CC608_FROM_CABLE
        if(CABLE_DATA == pu8Buf[u32offset])
        {
            u32offset++;
            s32Ret = _DtvCC_DecodeCABLE( &pu8UserData[u32offset],(HI_U8)(u32DataLen-u32offset), bTopFieldFirst);
            if(1 == s32Ret)
            {
                bCheckATSC608 = HI_FALSE;
            }

            while(u32offset < u32DataLen)
            {
                if((pu8Buf[u32offset] == 0x00) &&
                    (pu8Buf[u32offset+1] == 0x00) &&
                        (pu8Buf[u32offset+2] == 0x01))
                {
                    u32offset += 3;
                    break;
                }
        ...
        u32DataType = GET32(pu8Buf,u32offset);
        u32offset += 4;

        if(ATSC_IDENTIFIER == u32DataType) //atsc
        {
            s32Ret = _DtvCC_DecodeATSC( &pu8UserData[u32offset],(HI_U8)(u32DataLen-u32offset),bCheckATSC608);
        ...
        else if( SAUD_IDENTIFIER == u32DataType ) //saud data
        {
            s32Ret = _DtvCC_DecodeSAUD(&pu8UserData[u32offset],(HI_U8)(u32DataLen-u32offset),bCheckATSC608);
...
HI_S32 CC708_DEC_ProcessServicefifo(HI_VOID)
{
    ...
    CC708_OBJECT_S *pstCCObj     = CC708_OBJ_GetHandle(0);
    TRI_QUEUE *pstServiceQueue = &(pstCCObj->stServiceQueue);
    DTVCC_ServiceElement_S stSvsElement;

    //if not delay, we get queue element and decoder it to graph cmd.others we directly return.
    while(!CCQueue_IsEmpty(pstServiceQueue) && !pstCCObj->u8IsDelay)
    {
        if (CCQueue_Get(pstServiceQueue, &stSvsElement))
        {
            s32Ret = _DtvCC_ParseServiceBlock(stSvsElement.pu8Buffer,stSvsElement.u8ServiceLen);
            if(HI_FAILURE == s32Ret)
            {
                HI_ERR_CC("_DtvCC_ParseServiceBlock failed!\n");
            }
            CCQueue_Remove(pstServiceQueue,&stSvsElement);
        }
    }
    return s32Ret;
}
...
static void _DtvCC_NulCmd(HI_U8 *pu8Cmd)
{

}

static void _DtvCC_ETXCmd(HI_U8 *pu8Cmd)
{
    DEC_TRACE("C0_ETX command!%#x\n",*pu8Cmd);

    /* The ETX code is required at the end of a caption text segment to */
    /* terminate the segment when the segment is not immediately followed */
    /* by another caption command. Spec P17 */
    /* So we should draw received caption here*/
    CC708_OSD_ETX();
}

static void _DtvCC_BSCmd(HI_U8 *pu8Cmd)
{
    DEC_TRACE("C0_BS command! %#x\n",*pu8Cmd);
    CC708_OSD_BSText();
}

static void _DtvCC_FFCmd(HI_U8 *pu8Cmd)
{
    DEC_TRACE("C0_ff command!%#x\n",*pu8Cmd);
    CC708_OSD_FFText();
}

static void _DtvCC_CRCmd(HI_U8 *pu8Cmd)
{
    DEC_TRACE("C0_CR  %#x\n",*pu8Cmd);
    CC708_OSD_CRText();
}

static void _DtvCC_HCRCmd(HI_U8 *pu8Cmd)
{
    DEC_TRACE("CO_HCR command %#x\n",*pu8Cmd);
    CC708_OSD_HCRText();
}

static void _DtvCC_EXT1Cmd(HI_U8 *pu8Cmd)
{
    HI_U8 u8Byte;
    HI_U16 u16Caption = 0;

    u8Byte = GET8(pu8Cmd,1);

    /* C2 C3 code set, just skip */
    if((u8Byte < 0x20)||((u8Byte >= 0x80)&&(u8Byte < 0x90)))
    {
        return;
    }

    /* variable length commands, just skip */
    if( (u8Byte & 0xf0) == 0x90 )
    {
        return ;
    }
    ...
    if(u8Byte < 0x80)
    {
        u16Caption = DTVCCG2Code2UnicodeMap[u8Byte-0x20];

        /* if it is a TSP or NBTSP, treat NBTSP as 0x1020 */
        if((u16Caption == 0x1020) ||(u16Caption == 0x1021))
        {
            u16Caption = 0x1020;
        }
    ...
    {
        u16Caption = DTVCCG3Code2UnicodeMap[u8Byte-0xA0];
    }
...
static const HI_U16 ksc5601_2uni_page21[1115] = {
  /* 0x21 */
...
static const HI_U16 ksc5601_2uni_page30[2350] = {
  /* 0x30 */
...
static const HI_U16 ksc5601_2uni_page4a[4888] = {
  /* 0x4a */
...
/*******************************************/
/* P16 code is used as a further code space extension */
/* for 16-bit character sets. Spec P17 */
/*******************************************/
static void _DtvCC_P16Cmd(HI_U8 *pu8Cmd)
{
    HI_U16 u16Unicode;
    HI_U8 u8Char1,u8Char2;

    u16Unicode = ( pu8Cmd[1] << 8) | pu8Cmd[2];
    DEC_TRACE("P16 two byte codes:%#x\n",u16Unicode);

    /*todu...*/
    /*here we should map the 16_bit code to unicode data*/
    /*We treat the language as EUC-KR(ksc5601)*/
    if(pu8Cmd[1] >= 0xa1)
    {
        u8Char1 = pu8Cmd[1]-0x80;
        u8Char2 = pu8Cmd[2]-0x80;
        if((u8Char1 >= 0x21 && u8Char1 <= 0x2c)
            || (u8Char1 >= 0x30 && u8Char1 <= 0x48)
            || (u8Char1 >= 0x4a && u8Char1 <= 0x7d))
        {
            if (u8Char2 >= 0x21 && u8Char2 < 0x7f)
            {
                HI_S32 i = 94 * (u8Char1 - 0x21) + (u8Char2 - 0x21);
                if (i < 1410)
                {
                    if (i < 1115)
                    {
                        u16Unicode = ksc5601_2uni_page21[i];
                    }
                }
                else if (i < 3854)
                {
                    if (i < 3760)
                    {
                        u16Unicode = ksc5601_2uni_page30[i-1410];
                    }
                }
                else
                {
                    if (i < 8742)
                    {
                        u16Unicode = ksc5601_2uni_page4a[i-3854];
                    }
                }
            }
        }
    ...
    {
        HI_ERR_CC("p16 code data : %#x not support\n",pu8Cmd[1]);
    }
    DEC_TRACE("--->%#x\n",u16Unicode);
    if(0xfffd != u16Unicode)
    {
        stCaptionBuf.u16Buf[stCaptionBuf.u8BufLen++] = u16Unicode;
    }
    return;

}

static void _DtvCC_SetCurrentWindowCmd(HI_U8 *pu8Cmd)
{
    HI_U8 windowID;
    if(NULL == pu8Cmd)
    {
        HI_ERR_CC("CMD is null!\n");
        return ;
    }

    windowID = GET3(pu8Cmd,0,0);
    DEC_TRACE("Set Current Window command  %#x\n",*pu8Cmd);
    DEC_TRACE("windowID:%d\n",windowID);

    CC708_OSD_SetCurrentWindow(windowID);
    return ;
}

static void _DtvCC_ClearWindowsCmd(HI_U8 *pu8Cmd)
{
    HI_U8 u8WindowMap;
    ...
    u8WindowMap = GET8(pu8Cmd,1);
    DEC_TRACE("Clear Window command %#x\n",*pu8Cmd);
    DEC_TRACE("u8WindowMap:0x%x\n",u8WindowMap);

    // execuate command
    CC708_OSD_ClearWindows(u8WindowMap);
    return ;
}

static void _DtvCC_DisplayWindowsCmd(HI_U8 *pu8Cmd)
{
    HI_U8 u8WindowMap;
    ...
    u8WindowMap = GET8(pu8Cmd,1);
    DEC_TRACE("Display Window command %#x\n",*pu8Cmd);
    DEC_TRACE("u8WindowMap:0x%x\n",u8WindowMap);

    // execuate command
    CC708_OSD_DisplayWindows(u8WindowMap);
    return ;
}

static void _DtvCC_HideWindowsCmd(HI_U8 *pu8Cmd)
{
    HI_U8 u8WindowMap;
    ...
    u8WindowMap = GET8(pu8Cmd,1);
    DEC_TRACE("Hide Window command  %#x\n",*pu8Cmd);
    DEC_TRACE("u8WindowMap:0x%x\n",u8WindowMap);

    // execuate command
    CC708_OSD_HideWindows(u8WindowMap);
    return ;
}

static void _DtvCC_ToggleWindowsCmd(HI_U8 *pu8Cmd)
{
    HI_U8 u8WindowMap;
    ...
    u8WindowMap = GET8(pu8Cmd,1);
    DEC_TRACE("Toggle Window command  %#x\n",*pu8Cmd);
    DEC_TRACE("u8WindowMap:0x%x\n",u8WindowMap);

    // execuate command
    CC708_OSD_ToggleWindows(u8WindowMap);
    return ;
}

static void _DtvCC_DeleteWindowsCmd(HI_U8 *pu8Cmd)
{
    HI_U8 u8WindowMap;
    ...
    DEC_TRACE("Delete Window command  %#x,u8WindowMap:0x%x\n",*pu8Cmd,u8WindowMap);

    // execuate command
    CC708_OSD_DeleteWindows(u8WindowMap);
    return ;
}

static void _DtvCC_DelayCmd(HI_U8 *pu8Cmd)
{
    HI_U8 tenthOfSecond;
    CC708_OBJECT_S *pstCCObj= CC708_OBJ_GetHandle(0);
    ...
    tenthOfSecond = GET8(pu8Cmd,1);
    DEC_TRACE("Delay command  %#x\n",*pu8Cmd);

    pstCCObj->u8IsDelay = 1;
    _DtvCC_DelayTimerStart(0,tenthOfSecond);

    return ;
}

static void _DtvCC_ResetCmd(HI_U8 *pu8Cmd)
{
    /*here we do nothing,because reset command has been processed before input it to Service Queue*/
    DEC_TRACE("CC708Reset command  %#x\n",*pu8Cmd);

    /* clear input buffer */
    CC708_OSD_Reset();
}

static void _DtvCC_SetPenAttributesCmd(HI_U8 *pu8Cmd)
{
    HI_U8 u8PenSize,u8FontName,u8TextTag,u8TextOffset,u8IsItalics,u8IsUnderline,u8EdgeType;
    HI_U8 u8Offset = 1;
    ...
    /*we map all the attribute to unf attribute*/
    u8PenSize = GET2(pu8Cmd,u8Offset,0) + HI_UNF_CC_FONTSIZE_SMALL;
    CC708DECPARAM_UPPER_CHECK(u8PenSize,HI_UNF_CC_FONTSIZE_BUTT,"Pen Size",HI_UNF_CC_FONTSIZE_STANDARD);

    u8TextOffset = GET2(pu8Cmd,u8Offset,2) + CC_OS_SUBSCRIPT;
    CC708DECPARAM_UPPER_CHECK(u8TextOffset,MAX_CC_OFFSET,"u8Offset",CC_OS_NORMAL);

    u8TextTag = GET4(pu8Cmd,u8Offset,4);
    u8Offset++;

    u8FontName = GET3(pu8Cmd,u8Offset,0) + HI_UNF_CC_FN_DEFAULT;
    u8EdgeType = GET3(pu8Cmd,u8Offset,3) + HI_UNF_CC_EDGETYPE_NONE;
    CC708DECPARAM_UPPER_CHECK(u8EdgeType,HI_UNF_CC_EDGETYPE_BUTT,"Edge Type",HI_UNF_CC_EDGETYPE_NONE);
    u8IsUnderline = GET1(pu8Cmd,u8Offset,6);
    u8IsItalics = GET1(pu8Cmd,u8Offset,7);

    DEC_TRACE("Set Pen Attribute command  %#x\n",*pu8Cmd);
    DEC_TRACE("u8PenSize:%d,u8FontName:%d,u8TextTag:%d,u8TextOffset:%d,u8IsItalics:%d,u8IsUnderline:%d,u8EdgeType;%d\n",
                  u8PenSize,u8FontName,u8TextTag,u8TextOffset,u8IsItalics,u8IsUnderline,u8EdgeType);

    CC708_OSD_SetPenAttributes (u8PenSize,u8FontName,u8TextTag,u8TextOffset,u8IsItalics,u8IsUnderline,u8EdgeType);
}

static void _DtvCC_SetPenColorCmd(HI_U8 *pu8Cmd)
{
    HI_U8 u8FGColor,u8FGOpacity,u8BGColor,u8BGOpacity,u8EdgeColor;
    ...
    u8FGColor = GET6(pu8Cmd,u8Offset,0);
    u32FGColor = _DtvCC_Translate2Color(u8FGColor);// get r,g,b value
    u8FGOpacity = GET2(pu8Cmd,u8Offset,6) + HI_UNF_CC_OPACITY_SOLID;//according with hi_unf_cc.h/HI_UNF_CC_OPACITY_E
    u8Offset++;

    u8BGColor = GET6(pu8Cmd,u8Offset,0);
    u32BGColor = _DtvCC_Translate2Color(u8BGColor);// get r,g,b value
    u8BGOpacity = GET2(pu8Cmd,u8Offset,6) + HI_UNF_CC_OPACITY_SOLID;
    u8Offset++;

    u8EdgeColor = GET6(pu8Cmd,u8Offset,0);
    u32EdgeColor = _DtvCC_Translate2Color(u8EdgeColor);// get r,g,b value

    DEC_TRACE("Set Pen Color command  %#x\n",*pu8Cmd);
    DEC_TRACE("u8FGColor:%d,u8BGColor:%d,u8EdgeColor:%d\n",u8FGColor,u8BGColor,u8EdgeColor);
    DEC_TRACE("u32FGColor:0x%x,u32BGColor:0x%x,u32EdgeColor:0x%x\n",u32FGColor,u32BGColor,u32EdgeColor);
    DEC_TRACE("u8FGOpacity:%d,u8BGOpacity:%d\n",u8FGOpacity,u8BGOpacity);

    CC708_OSD_SetPenColor (u32FGColor,u8FGOpacity,u32BGColor,u8BGOpacity,u32EdgeColor);
}

static void _DtvCC_SetPenLocationCmd(HI_U8 *pu8Cmd)
{
    CC708_OBJECT_S *pstCCObj = CC708_OBJ_GetHandle(0);
    HI_U8 u8Row,u8Column,u8Offset = 1;

    if(NULL == pu8Cmd || NULL == pstCCObj)
    {
        return ;
    }

    u8Row = GET4(pu8Cmd,u8Offset,0);
    CC708DECPARAM_UPPER_CHECK(u8Row,MAX_CC_ROWS,"Pen Location u8Row",MAX_CC_ROWS-1);
    u8Offset++;
    u8Column = GET6(pu8Cmd,u8Offset,0);
    CC708DECPARAM_UPPER_CHECK(u8Column,pstCCObj->stScreen.u16MaxColumnNum,"Pen Location u8Column",pstCCObj->stScreen.u16MaxColumnNum-1);

    DEC_TRACE("Set Pen Location command %#x\n",*pu8Cmd);
    DEC_TRACE("u8Row:%d,u8Column:%d\n\n",u8Row,u8Column);

    CC708_OSD_SetPenLocation (u8Row,u8Column);
}

static void _DtvCC_SetWindowAttributesCmd(HI_U8 *pu8Cmd)
{

    HI_U8 u8Justify,u8PrintDirection,u8ScrollDirection,u8Temp;
    HI_U8 u8WordWrap,u8DisplayEffect,u8EffectDirection,u8EffectSpeed;
    HI_U8 u8FillColor,u8FillOpacity,u8BorderType,u8BorderColor,u8Offset = 1;
    HI_U32 u32FillColor,u32BorderColor;
    ...
    u8FillColor = GET6(pu8Cmd,u8Offset,0);
    u32FillColor = _DtvCC_Translate2Color(u8FillColor);// get r,g,b value

    u8FillOpacity = GET2(pu8Cmd,u8Offset,6);
    u8FillOpacity += HI_UNF_CC_OPACITY_SOLID;/*here we map the opacity in ts stream to unf opacity*/
    u8Offset++;

    u8BorderColor = GET6(pu8Cmd,u8Offset,0);
    u32BorderColor = _DtvCC_Translate2Color(u8BorderColor);// get r,g,b value
    u8BorderType = GET2(pu8Cmd,u8Offset,6);
    u8Offset++;

    u8Justify = GET2(pu8Cmd,u8Offset,0);
    u8Justify += HI_UNF_CC_JUSTIFY_LEFT;

    u8ScrollDirection = GET2(pu8Cmd,u8Offset,2);
    u8ScrollDirection += CC_SD_LEFT_RIGHT;

    u8PrintDirection = GET2(pu8Cmd,u8Offset,4);
    u8PrintDirection += CC_PD_LEFT_RIGHT;

    u8WordWrap = GET1(pu8Cmd,u8Offset,6);
    u8WordWrap += HI_UNF_CC_WW_DISABLE;

    u8Temp = GET1(pu8Cmd,u8Offset,7);
    u8BorderType = (u8Temp << 2) | u8BorderType;
    u8BorderType += HI_UNF_CC_EDGETYPE_NONE;
    u8Offset++;

    u8DisplayEffect = GET2(pu8Cmd,u8Offset,0) + CC_EFFECT_SNAP;
    CC708DECPARAM_UPPER_CHECK(u8DisplayEffect,MAX_CC_EFFECT,"Display Effect",CC_EFFECT_SNAP);

    u8EffectDirection = GET2(pu8Cmd,u8Offset,2) + CC_DED_LEFT_RIGHT;
    u8EffectSpeed = GET4(pu8Cmd,u8Offset,4);

    DEC_TRACE("Set Window Attribute command  %#x\n",*pu8Cmd);
    DEC_TRACE("u8Justify:%d,u8PrintDirection:%d,u8ScrollDirection:%d,u8WordWrap:%d,u8DisplayEffect:%d\n",
                  u8Justify,u8PrintDirection,u8ScrollDirection,u8WordWrap,u8DisplayEffect);
    DEC_TRACE("u8EffectDirection:%d,u8EffectSpeed:%d,u8FillOpacity:%d,u8BorderType:%d\n",
                  u8EffectDirection,u8EffectSpeed,u8FillOpacity,u8BorderType);

    CC708_OSD_SetWindowAttributes (u8Justify,u8PrintDirection,u8ScrollDirection,u8WordWrap,
                         u8DisplayEffect,u8EffectDirection,u8EffectSpeed,u32FillColor,
                         u8FillOpacity,u8BorderType,u32BorderColor);
}

static void _DtvCC_DefineWindowCmd(HI_U8 *pu8Cmd)
{
    CC708_OBJECT_S *pstCCObj = CC708_OBJ_GetHandle(0);

    HI_U8 u8WindowID,u8Priority,u8AnchorPoint,u8RelativePositioning,u8AnchorVertical;
    HI_U8 u8AnchorHorizontal,u8RowCount,u8ColumnCount,u8RowLock,u8ColumnLock;
    HI_U8 u8IsVisible,u8WindowStyleID,u8PenStyleID;
    HI_U8 u8Offset = 0;
    ...
    u8WindowID = GET3(pu8Cmd,u8Offset,0);
    u8Offset++;

    u8Priority = GET3(pu8Cmd,u8Offset,0);
    u8ColumnLock = GET1(pu8Cmd,u8Offset,3);
    u8RowLock = GET1(pu8Cmd,u8Offset,4);
    u8IsVisible = GET1(pu8Cmd,u8Offset,5);
    u8Offset++;

    u8AnchorVertical = GET7(pu8Cmd,u8Offset,0);
    u8RelativePositioning = GET1(pu8Cmd,u8Offset,7);
    if( u8RelativePositioning == 0 )
    {
        CC708DECPARAM_UPPER_CHECK(u8AnchorVertical,MAX_CC_ABSOLUTE_ANCHOR_VERT,"Anchor Vertical",MAX_CC_ABSOLUTE_ANCHOR_VERT-1);
    }
    else
    {
        CC708DECPARAM_UPPER_CHECK(u8AnchorVertical,MAX_CC_RELATIVE_ANCHOR,"Anchor Vertical",MAX_CC_RELATIVE_ANCHOR-1);
    }
    u8Offset++;

    u8AnchorHorizontal = GET8(pu8Cmd,u8Offset);
    if( u8RelativePositioning == 0 )
    {
        CC708DECPARAM_UPPER_CHECK(u8AnchorHorizontal,pstCCObj->stScreen.u16MaxHorizonalCells,"Anchor Horizontal",pstCCObj->stScreen.u16MaxHorizonalCells-1);
    }
    else
    {
        CC708DECPARAM_UPPER_CHECK(u8AnchorHorizontal,MAX_CC_RELATIVE_ANCHOR,"Anchor Horizontal",MAX_CC_RELATIVE_ANCHOR-1);
    }

    u8Offset++;

    u8RowCount = GET4(pu8Cmd,u8Offset,0);
    CC708DECPARAM_UPPER_CHECK(u8RowCount,MAX_CC_ROWS,"row count",MAX_CC_ROWS-1);
    u8AnchorPoint = GET4(pu8Cmd,u8Offset,4);
    CC708DECPARAM_UPPER_CHECK(u8AnchorPoint,MAX_CC_AP,"anchor point",MAX_CC_AP-1);
    u8Offset++;

    u8ColumnCount = GET6(pu8Cmd,u8Offset,0);
    CC708DECPARAM_UPPER_CHECK(u8ColumnCount,MAX_CC_COLUMNS_16B9,"Pen Location column",MAX_CC_COLUMNS_16B9-1);
    u8Offset++;

    u8PenStyleID = GET3(pu8Cmd,u8Offset,0);
    CC708DECPARAM_UPPER_CHECK(u8PenStyleID,MAX_CC_PEN_STYLE,"pen Style ID",MAX_CC_PEN_STYLE-1);
    u8WindowStyleID = GET3(pu8Cmd,u8Offset,3);
    CC708DECPARAM_UPPER_CHECK(u8WindowStyleID,MAX_CC_WINDOW_STYLE,"window Style ID",MAX_CC_WINDOW_STYLE-1);

    DEC_TRACE("===============Get CC708DefineWindow command  %#x=======================\n",*pu8Cmd);
    DEC_TRACE("u8WindowID:%d;u8Priority:%d;u8AnchorPoint:%d;u8RelativePositioning:%d,u8AnchorVertical:%d\n",
                  u8WindowID,u8Priority,u8AnchorPoint,u8RelativePositioning,u8AnchorVertical);
    DEC_TRACE("u8AnchorHorizontal:%d;u8RowCount:%d;u8ColumnCount:%d;u8RowLock:%d;u8ColumnLock:%d\n",
                  u8AnchorHorizontal,u8RowCount,u8ColumnCount,u8RowLock,u8ColumnLock);
    DEC_TRACE("u8IsVisible:%d;u8WindowStyleID:%d;u8PenStyleID:%d\n",u8IsVisible,u8WindowStyleID,u8PenStyleID);
    DEC_TRACE("===============================================================================\n");

    CC708_OSD_DefineWindow (u8WindowID,u8Priority,u8AnchorPoint,u8RelativePositioning,u8AnchorVertical,
                  u8AnchorHorizontal,u8RowCount,u8ColumnCount,u8RowLock,u8ColumnLock,u8IsVisible,
                  u8WindowStyleID, u8PenStyleID);
}
...
static HI_BOOL _DtvCC_OddParityCheck(HI_U8 data)
{
    ...
    if ( (cnt % 2) == 0 )  //find even num of 1 in data bus
    {
        return HI_FALSE;   //faied the odd parity check
    }

    return HI_TRUE; //odd parity check ok.
}
