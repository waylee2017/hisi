...
// History       :  xxx 2014-07-09 Create file
//******************************************************************************
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    led_data_gpio_sel     : 1   ; /* [1]  */
        unsigned int    led_clk_gpio_sel      : 1   ; /* [2]  */
        unsigned int    reserved_0            : 1   ; /* [3]  */
        unsigned int    led_key0_gpio_sel     : 1   ; /* [4]  */
        unsigned int    gpio_sel              : 1   ; /* [5]  */
        unsigned int    ir_gpio_sel           : 1   ; /* [6]  */
        unsigned int    uart_rxd_gpio_sel     : 1   ; /* [7]  */
        unsigned int    uart_txd_gpio_sel     : 1   ; /* [8]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    h2h_srst_req          : 1   ; /* [30]  */
...
typedef struct
{
    ...
    volatile unsigned int           SC_SYSID0                ; /* 0xee0 */
    volatile unsigned int           SC_SYSID1                ; /* 0xee4 */
    volatile unsigned int           SC_SYSID2                ; /* 0xee8 */
    volatile unsigned int           SC_SYSID3                ; /* 0xeec */
    volatile unsigned int           reserved_6[4]                     ; /* 0xef0~0xefc */
