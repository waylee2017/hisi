...
HI_VOID __attribute__((weak)) HI_DRV_PROC_EchoHelper(const HI_CHAR *fmt, ...) { }
HI_VOID __attribute__((weak)) HI_DRV_PROC_EchoHelperVargs(HI_CHAR *buf, HI_U32 size,  const HI_CHAR * fmt, va_list args) { }
