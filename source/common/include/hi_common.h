...
/**Defines the exit mode of FastPlay.*//**CNcomment: 定义FastPlay 退出模式枚举 */
typedef enum
{
...
/**
\brief Gets ready for the audio/video graphic operations. CNcomment: 系统音视频图形操作前准备工作 CNend
\attention \n
...
建议 HI_SYS_Init 后立即调用，支持多次调用 CNend
\param[in]  pstPreParm CNcomment: 退出模式和参数结构体指针 CNend
\retval ::HI_SUCCESS Success CNcomment: 成功 CNend
\retval ::HI_FAILURE Calling this API fails. CNcomment: API系统调用失败 CNend
\see \n
N/A CNcomment: 无 CNend
...
/**
\brief Obtains current play time. CNcomment:  获取当前使用播放时间 CNend
\attention \n
Use second as time count. CNcomment: 时间单位:秒 CNend
\param[out] pu32Playtime Pointer type, output current used time. CNcomment: 指针类型，输出当前消费时间 CNend
\retval ::HI_SUCCESS Success CNcomment: 成功 CNend
\retval ::HI_FAILURE Calling this API fails. CNcomment: API系统调用失败 CNend
\see \n
N/A CNcomment: 无 CNend
...
/**
@brief Sets the log level of a module by Mod ID. CNcomment:通过模块ID 设置模块的调试信息级别 CNend
@attention \n
N/A CNcomment: 无 CNend
@param[in] enModId Module ID of a module CNcomment: 模块ID。 CNend
@param[in] enLogLevel Log level of a module CNcomment: 模块的调试信息级别。 CNend
@retval ::HI_SUCCESS Success CNcomment: 成功 CNend
@retval ::HI_FAILURE Calling this API fails. CNcomment: API系统调用失败 CNend
@see \n
*/
