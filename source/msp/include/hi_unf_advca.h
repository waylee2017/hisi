...
typedef enum hiUNF_ADVCA_OTP_FUSE_E
{
    ...
    HI_UNF_ADVCA_OTP_RSA_KEY_LOCK_FLAG,   /**< The lock flag of RSA_Root_key, HI_UNF_ADVCA_OTP_DEFAULT_ATTR_S*/ /**<CNcomment: RSA_Root_Key lock标记，HI_UNF_ADVCA_OTP_DEFAULT_ATTR_S*/     
