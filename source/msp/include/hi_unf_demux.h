...
/**CNcomment:DVB端口数量,通过tuner送入数据*/
#if defined(CHIP_TYPE_hi3716mv330)
#define DMX_DVBPORT_CNT                 4
#else
#define DMX_DVBPORT_CNT                 5
#endif

/**Number of RAM ports. These ports are used to receive data from the transport stream (TS) buffer.  */
/**CNcomment:RAM端口数量,使用TS BUFFER送入数据*/
#if defined(CHIP_TYPE_hi3716mv330)
...
/**CNcomment:DMX模块端口数量*/
#define DMX_TOTALPORT_CNT               (DMX_DVBPORT_CNT + DMX_RAMPORT_CNT)

/**Number of DEMUX TSO ports.*/
/**CNcomment:DMX模块TSO 端口数量*/
#define DMX_TSOPORT_CNT                   1

/**Number of audio/video channels of the DEMUX module. */
/**CNcomment:DMX模块音视频通道数量 */
...
{
    HI_U32 u32PortNum;          /**<Number of ports. */ /**< CNcomment:端口数量     */
    HI_U32 u32DmxNum;           /**<Number of DEMUX devices*/ /**< CNcomment:设备数量     *///AI7D04684
    HI_U32 u32CommonChannelNum; /**<Number of general-purpose channels*/ /**< CNcomment:通用通道数量 */
    HI_U32 u32AudioChannelNum;  /**<Number of audio channels*/ /**< CNcomment:音频通道数量 */
    HI_U32 u32VideoChannelNum;  /**<Number of video channels*/ /**< CNcomment:视频通道数量 */
...
{
    HI_UNF_DMX_PORT_0_TUNER = 0,     /**<Port0, tuner mode*/ /**< CNcomment:port0, Tuner模式 */
    HI_UNF_DMX_PORT_1_TUNER,     /**<Port1, tuner mode*/ /**< CNcomment:port1, Tuner模式 */
    HI_UNF_DMX_PORT_2_TUNER,     /**<Port2, tuner mode*/ /**< CNcomment:port2, Tuner模式 */
    HI_UNF_DMX_PORT_3_TUNER,     /**<Port3, tuner mode*/ /**< CNcomment:port3, Tuner模式 */
    HI_UNF_DMX_PORT_4_TUNER,     /**<Port4, tuner mode*/ /**< CNcomment:port4, Tuner模式 */
    HI_UNF_DMX_PORT_3_RAM = 5,       /**<Port3, RAM mode*/ /**< CNcomment:port3, RAM模式 */
    HI_UNF_DMX_PORT_4_RAM,       /**<Port4, RAM mode*/ /**< CNcomment:port4, RAM模式 */
    HI_UNF_DMX_PORT_5_RAM,       /**<Port5, RAM mode*/ /**< CNcomment:port5, RAM模式 */
    HI_UNF_DMX_PORT_6_RAM,       /**<Port6, RAM mode*/ /**< CNcomment:port6, RAM模式 */

    HI_UNF_DMX_PORT_BUTT
}HI_UNF_DMX_PORT_E;

#define HI_UNF_DMX_PORT_BASE_TUNER (HI_UNF_DMX_PORT_0_TUNER)
#define HI_UNF_DMX_PORT_BASE_RAM    (HI_UNF_DMX_PORT_3_RAM)
...
typedef enum hiUNF_DMX_TSO_CLK_E
{
    ...
    HI_UNF_DMX_TSO_CLK_1572M ,          /**< TS out mode clock frequency 1572M*/ /**< CNcomment:TS输出模块时钟频率选择为1572M*/
...
/**<DEMUX buffer status*/
/** CNcomment:DEMUX缓冲区状态结构*/
typedef struct hiUNF_DMX_BUF_STATUS_S
{
    HI_U32 u32BufSize;  /**<Used buffer*/ /**< CNcomment:缓冲区大小 */
    HI_U32 u32UsedSize; /**<Buffer size*/ /**< CNcomment:缓冲区已使用大小 */
...
\param[in] u32PortId    Port ID. CNcomment:端口号。CNend
