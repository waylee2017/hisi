...
typedef enum hiUNF_QAM_TYPE_E
{
    ...
    HI_UNF_MOD_TYPE_QAM_4,            /**<Enumeration corresponding to the 4QAM mode*/                                                  /**<CNcomment:4QAM对应的枚举值*/
    HI_UNF_MOD_TYPE_QAM_4_NR,         /**<Enumeration corresponding to the 4QAM_NR mode*/                                               /**<CNcomment:4QAM_NR对应的枚举值*/
...
typedef enum    hiUNF_TUNER_DEV_TYPE_E
{
    ...
    HI_UNF_TUNER_DEV_TYPE_MXL608,               /**<MXL608*/                    /**<CNcomment:支持MXL608高频头*/ 
    HI_UNF_TUNER_DEV_TYPE_SI2147,               /**<SI2147*/                     /**<CNcomment:支持SI2147高频头*/ 
    HI_UNF_TUNER_DEV_TYPE_R836,                 /**<R836*/                       /**<CNcomment:支持R836高频头*/ 
    HI_UNF_TUNER_DEV_TYPE_MXL214,               /**<MXL214*/                     /**<CNcomment:支持MXL214高频头*/ 
    HI_UNF_TUNER_DEV_TYPE_MXL254,               /**<MXL254*/                     /**<CNcomment:支持MXL254高频头*/ 
    HI_UNF_TUNER_DEV_TYPE_TDA18280,             /**<TDA18280*/                  /**<CNcomment:支持TDA18280高频头*/  
    HI_UNF_TUNER_DEV_TYPE_TDA18215,             /**<TDA18215*/                  /**<CNcomment:支持TDA18215高频头*/ 
    HI_UNF_TUNER_DEV_TYPE_M88TC3800,            /**<M88TC3800*/                 /**<CNcomment:支持M88TC3800高频头*/ 
    HI_UNF_TUNER_DEV_TYPE_SI2144,               /**<SI2144*/                     /**<CNcomment:支持SI2144高频头*/ 
    ...
    HI_UNF_TUNER_DEV_TYPE_SI2150,               /**< SI2150 */                   /**<CNcomment:支持SI2150高频头*/
    HI_UNF_TUNER_DEV_TYPE_R850,                 /**<R850*/                      /**<CNcomment:支持R850高频头*/ 
...
typedef enum    hiUNF_DEMOD_DEV_TYPE_E
{
    ...
    HI_UNF_DEMOD_DEV_TYPE_3138,				  /**< Hi3138 */            /**<CNcomment:支持Hi3138 */
    HI_UNF_DEMOD_DEV_TYPE_ATBM8869,			  /**< ATBM8869 */          /**<CNcomment:支持atbm8869 */
...
/** CNcomment:TS优先级，仅用于DVB-T*/
typedef enum hiUNF_TUNER_TS_PRIORITY_E
{
    HI_UNF_TUNER_TS_PRIORITY_NONE = 0 ,      
	/**<no priority mode,when there are two TS in signal,we can set this value as default.when single TS,config this value to lock the only TS;when double TS,config this value to lock high prioriy TS*/        
    /**<CNcomment:无优先级模式，当前端发送是单流或者双流时，均可以配置此默认值。单流时，配置此值默认锁定仅存在的一个流；双流时，配置此值默认锁定高优先级TS流*/
...
typedef struct  hiUNF_TER_CONNECT_PARA_S
{
	...
	HI_UNF_TUNER_TS_PRIORITY_E    enDVBTPrio;		/**< output high priority TS or low priority TS*/
...
/** the index of TS port*/
/** CNcomment:中频输出通路选择*/
typedef enum hiUNF_TUNER_IF_PATH_SEL_E
{
    HI_UNF_TUNER_IF_OUTPUT_SEL_SINGLE_I = 0,
    HI_UNF_TUNER_IF_OUTPUT_SEL_SINGLE_Q,
...
typedef struct hiUNF_TUNER_TER_TPINFO_S
{
	...
	HI_U8 u8DVBTHier;   						/**<delaminate or not*/                		/**<CNcomment:是否分层,0--不分层,1--分层*/
...
{   
    ...
    HI_UNF_TUNER_DTMB_CARRIER_BUTT          /**<Invalid value*/           /**<CNcomment:非法边界值*/
...
typedef enum hiUNF_TUNER_DTMB_CODE_RATE_E
{
    ...
    HI_UNF_TUNER_DTMB_CODE_RATE_BUTT         /**<Invalid value*/ /**<CNcomment:非法边界值*/
...
typedef enum hiUNF_TUNER_DTMB_TIME_INTERLEAVE_E
{
    ...
    HI_UNF_TUNER_DTMB_TIME_INTERLEAVER_BUTT         /**<Invalid value*/ /**<CNcomment:非法边界值*/
...
typedef enum hiUNF_TUNER_DTMB_GUARD_INTERVAL_E
{
    ...
    HI_UNF_TUNER_DTMB_GI_BUTT           /**<Invalid value*/     /**<CNcomment:非法边界值*/
...
typedef struct hiUNF_TUNER_DTMB_SIGNALINFO_S
{
    ...
    HI_UNF_MODULATION_TYPE_E            enQamIndex;       /**<QAM type*/              /**<CNcomment:调制类型*/
...
typedef struct hiUNF_TUNER_SIGNALINFO_S
{
    ...
    union
    {
        ...
        HI_UNF_TUNER_DTMB_SIGNALINFO_S stDtmb;      /**<Signal info of DTMB terrestrial*/   /*DTMB信号参数*/
    } unSignalInfo;
...
typedef struct  hiHI_UNF_TUNER_ATTR_S
{
    ...
    HI_U32                      u32ResetGpioNo;     /**<Demod reset GPIO NO.*/                      /**<CNcomment:复位使用的gpio管脚号,现在不再使用，移到HI_UNF_TUNER_CAB_ATTR_S等结构体中*/
...
/** Structure of the UB info */
/** CNcomment:获取UB信息的结构*/
typedef struct hiUNF_TUNER_SCR_UB_S
{
    HI_U32          u32SCRNo;           /**<UB no*/                                 /**<CNcomment:UB号*/
    HI_S32          s32CenterFreq;      /**<Frequency of the UB center， in MHz*/            /**<CNcomment:UB中心频点,单位是MHz*/
...
{
    HI_UNF_TUNER_DISEQC_LEVEL_E enLevel;        /**<DiSEqC device level*/      /**<CNcomment:器件版本*/
    HI_U8                       u8Para1;        /**<Satellite number */        /**<CNcomment:卫星序号*/
    HI_U8                       u8Para2;        /**<Local longitude */         /**<CNcomment:本地经度，可选参数*/
    HI_U8                       u8Para3;        /**<Local latitude */          /**<CNcomment:本地纬度，可选参数*/
...
/**
\brief While using satellite channel, gets the current attributes of the tuner.
CNcomment:\brief 获取卫星TUNER附加属性。CNend
\attention \n
N/A
\param[in] u32tunerId   tuner port ID. The port ID can be 0-2.      CNcomment:卫星TUNER端口号，取值为0-2 CNend
\param[in] pstSatTunerAttr tuner attributes                         CNcomment:卫星TUNER的附加属性。CNend
...
/**
\brief While using terrestrial channel, gets the current attributes of the tuner.
CNcomment:\brief 获取地面TUNER附加属性。CNend
\attention \n
N/A
\param[in] u32tunerId   tuner port ID. The port ID can be 0-2.      CNcomment:地面TUNER端口号，取值为0-2 CNend
\param[in] pstTerTunerAttr tuner attributes                         CNcomment:地面TUNER的附加属性。CNend
...
N/A
\param[in] u32tunerId   tuner port ID. The port ID can be 0-2.      CNcomment:地面TUNER端口号，取值为0-2 CNend
\param[in] pstCabTunerAttr tuner attributes                         CNcomment:地面TUNER的附加属性。CNend
\retval ::HI_SUCCESS Success                                        CNcomment:成功 CNend
\retval ::HI_FAILURE  Calling this API fails.                       CNcomment:API系统调用失败 CNend
\retval ::HI_ERR_TUNER_NOT_OPEN  The TUNER module is not opened. CNcomment: 模块没有打开CNend
\retval ::HI_ERR_TUNER_INVALID_PORT  The input parameter is invalid. CNcomment:输入 参数非法 CNend
...
/**
\brief While using cable channel, gets the current attributes of the tuner.
CNcomment:\brief 获取有线TUNER附加属性。CNend
\attention \n
N/A
\param[in] u32tunerId   tuner port ID. The port ID can be 0-2.      CNcomment:地面TUNER端口号，取值为0-2 CNend
\param[in] pstCabTunerAttr tuner attributes                         CNcomment:地面TUNER的附加属性。CNend
...
配置成除ts_clk之外的任意一个管脚，ts_clk是固定在HI3136芯片上的，不支持配置，其中pstTSOUT->enTSOutput[0..7]，对应芯片TS_OUT0..TS_OUT7管脚;\n
pstTSOUT->enTSOutput[8..10]，对应芯片TS_VALID,TS_SYNC,TS_ERR管脚。CNend
...
CNcomment:\brief 获取当前TUNER的信号质量，返回百分比。CNend
\attention \n
N/A
\param[in] u32TunerId  Tuner port ID. The port ID can be 0-2.         CNcomment:TUNER端口号，取值为0-2 CNend
...
/**
\brief stop unicable scan before the normal exit.
CNcomment: 在扫描过程中停止扫描。CNend
\attention \n
N/A
\param[in]  u32TunerId    Tuner port ID. The port ID can be 0-2.             CNcomment:TUNER端口号，取值为0-2 CNend
\retval ::HI_SUCCESS   Success                                               CNcomment:成功 CNend
...
/**
\brief get unicable ub info.
CNcomment: 获取unicable的UB 信息。CNend
\attention \n
N/A
\param[in]  u32TunerId    Tuner port ID. The port ID can be 0-2.             CNcomment:TUNER端口号，取值为0-2 CNend
\param[out] ppUBInfo    The UB info buffer.                                   CNcomment:需要返回的UB信息缓冲区
\param[out] pu32Num    UB numbers.                                           CNcomment:UB的总数目
\retval ::HI_SUCCESS   Success                                               CNcomment:成功 CNend
\retval ::HI_FAILURE   Calling this API fails.                               CNcomment:API系统调用失败 CNend
\see \n
N/A
