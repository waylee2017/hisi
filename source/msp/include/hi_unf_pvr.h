/******************************************************************************
  ...
  Copyright (C), 2001-2016, HiSilicon Technologies Co., Ltd.
...
typedef enum hiUNF_PVR_EVENT_E
{
    ...
    HI_UNF_PVR_EVENT_PLAY_BUFFER_START = 0x005,          /**<the play reaches record during time shift. and PVR will pause the play to buffer data until the difference between record and play more than the value set by HI_UNF_PVR_PLAY_SET_BUFFER_TIME_FOR_TIMESHIFT, default is 1500ms*/
    HI_UNF_PVR_EVENT_PLAY_BUFFER_END  = 0x006,          /**<end of buffering data*//**<CNcomment: 缓冲数据结束*/
...
typedef struct hiUNF_PVR_PLAY_ATTR_S
{
    ...
    HI_U32                      u32TimeshiftBufferMs;                 /**<buffer time for timeshift play, if the defference between current playback and record  more than buffer time, the play will go on. for fast forward, this value will be multified by the speed ratio inside  default is 1500ms if zero is inputed. unit: millisecond. */
