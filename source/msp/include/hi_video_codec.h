...
/**CNcomment: 定义宽高比枚举*/
typedef enum hiCODEC_ASPECT_RATIO_E
{
    HI_CODEC_ASPECT_RATIO_UNKNOWN,  /**<Unknown*/ /**<CNcomment: 未知宽高比*/
    HI_CODEC_ASPECT_RATIO_4TO3,     /**<4:3*/ /**<CNcomment: 4比3*/
    HI_CODEC_ASPECT_RATIO_16TO9,    /**<16:9*/ /**<CNcomment: 16比9*/
    HI_CODEC_ASPECT_RATIO_SQUARE,   /**<Square*/ /**<CNcomment: 正方形*/
    HI_CODEC_ASPECT_RATIO_14TO9,    /**<14:9*/ /**<CNcomment: 14比9*/
    HI_CODEC_ASPECT_RATIO_221TO1,   /**<221:100*/ /**<CNcomment: 221比100*/
    HI_CODEC_ASPECT_RATIO_ZOME,     /**<Unsupported default, display as rate of width and height of data source*/ /**<CNcomment: 默认不支持，根据数据源宽高比显示*/
    HI_CODEC_ASPECT_RATIO_FULL,     /**<Unsupported default, display as full screen*/ /**<CNcomment: 默认不支持，全屏显示*/
    HI_CODEC_ASPECT_RATIO_235TO1,   /**<235:100*/ /**<CNcomment: 235比100*/    
    HI_CODEC_ASPECT_RATIO_BUTT
}HI_CODEC_ASPECT_RATIO_E;
...
typedef struct hiCODEC_VIDEO_STREAMINFO_S
{
    ...
    HI_CODEC_ASPECT_RATIO_E       enAspectRatio;  /**<AspectRatio*/ /**<CNcomment: 最佳显示幅型比*/
...
typedef struct hiCODEC_STREAM_S
{
    ...
    HI_U32 u32PhyAddr;   /**<Stream buffer phy address*/ /**<CNcomment: 流数据物理地址*/
