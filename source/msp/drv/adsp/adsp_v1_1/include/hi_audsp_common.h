...
#define DSP0_SHARESRAM_BASEADDR 0x5000
#define DSP0_SHARESRAM_MAXSIZE 0x01000
#define DSP0_SHARESRAM_AOE_OFFSET 0x0000
#define DSP0_SHARESRAM_AFLT_OFFSET 0x0800    //TODO Aoe ues 2k, 0x800 = 2k
...
typedef struct
{
    ...
    volatile unsigned int         ADSP_RESERVED[11-DSP_DEBUG_REG_NUM];
