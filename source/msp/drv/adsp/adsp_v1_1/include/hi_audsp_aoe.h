...
#define AOE_CAST_REG_OFFSET     0x0500
...
#define AOE_CAST_REG_BANDSIZE   sizeof(S_CAST_REGS_TYPE)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    schedule_timeout_cnt      : 16  ; /* [31..24]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    ena_avc               : 1   ; /* [9]  */
        unsigned int    ena_pregain           : 1   ; /* [10]  */
        unsigned int    pregain_int           : 8   ; /* [18..11]  */
        unsigned int    pregain_dec           : 8   ; /* [26..19]  */
        unsigned int    pregain_dec_dir       : 1   ; /* [27]  */
        unsigned int    avc_change_attr       : 1   ; /* [28]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    aip_priority          : 1   ; /* [11]  */
        unsigned int    Reserved_12           : 20  ; /* [31..12]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    buf_latency           : 8   ; /* [27..20]  */
        unsigned int    buf_latency_real      : 4   ; /* [31..28]  */
    } bits;
...
typedef union
{
    struct
    {
        ...
        unsigned int    volume_r              : 8   ; /* [15..8]  */
        unsigned int    mute                  : 1   ; /* [16]  */
        unsigned int    Reserved_19           : 3   ; /* [19..17]  */
        unsigned int    Reserved_20           : 12  ; /* [31..20]  */
    } bits;
    unsigned int    u32;
} U_AOP_EXT_CTRL;
...
typedef struct
{
    volatile unsigned int         CAST_ATTR;
