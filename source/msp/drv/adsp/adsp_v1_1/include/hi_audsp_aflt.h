...
#define AFLT_REG_LENGTH  1536 //0x600 (1.5k) reg for aflt 

#define AFLT_MAX_CHAN_NUM 8
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    filter_id             : 8   ; /* [23..16]  */
        unsigned int    inbuf_cached          : 1   ; /* [24]  */
        unsigned int    outbuf_cached         : 1   ; /* [25]  */
        unsigned int    master_flag           : 1   ; /* [26]  */
        unsigned int    eos_flag              : 1   ; /* [27]  */
        unsigned int    endofframe            : 1   ; /* [28]  */
        unsigned int    use_flag              : 1   ; /* [29]  */
        unsigned int    status                : 1   ; /* [30]  */
        unsigned int    aef_cert              : 1   ; /* [31]  */
    } bits;
...
typedef struct
{
    ...
    volatile unsigned int         MSGPOOL_ADDR;
    ...
    volatile unsigned int         RESERVED1[(0x80/sizeof(HI_U32))-24-AFLT_CUSTOMER_AUTHKEY_SIZE];
...
typedef struct
{
    ...
    AFLT_ERRORTYPE_E (*Init)(HI_HANDLE *phComp);

    AFLT_ERRORTYPE_E (*DeInit)(HI_HANDLE hComp);

    AFLT_ERRORTYPE_E (*SetConfig)(HI_HANDLE hComp, HI_U32 u32ConfigIndex, HI_VOID *pConfigStructure);

    AFLT_ERRORTYPE_E (*GetConfig)(HI_HANDLE hComp, HI_U32 u32ConfigIndex, HI_VOID *pConfigStructure, HI_U32 *pu32ConfigStructureSize);

    AFLT_ERRORTYPE_E (*GetParameter)(HI_HANDLE hComp, HI_U32 u32ParamIndex, HI_VOID *pParameterStructure, HI_U32 *pu32ParameterStructureSize);

    AFLT_ERRORTYPE_E (*SetParameter)(HI_HANDLE hComp, HI_U32 u32ParamIndex, HI_VOID * pParameterStructure);

    AFLT_ERRORTYPE_E (*StoreSetting)(HI_HANDLE hComp, HI_VOID * pSettingStructure, HI_U32 *pu32SettingStructureSize);

    AFLT_ERRORTYPE_E (*RestoreSetting)(HI_HANDLE hComp, HI_VOID * pSettingStructure);

    AFLT_ERRORTYPE_E (*SetInputBuffer)(HI_HANDLE hComp, HI_VOID *pInBuf, HI_U32 u32InBufSize);

    AFLT_ERRORTYPE_E (*SetOutputBuffer)(HI_HANDLE hComp, HI_VOID *pOutBuf, HI_U32 u32OutBufSize);

    AFLT_ERRORTYPE_E (*GetInputBytesleft)(HI_HANDLE hComp, HI_U32 *pu32Bytesleft);
    
    AFLT_ERRORTYPE_E (*GetMinInputBufSize)(HI_HANDLE hComp, HI_U32 *pu32InBufsize);

    AFLT_ERRORTYPE_E (*ExcuteFrame)(HI_HANDLE hComp, AFLT_EXCUTE_FRAME_S *pstExcuteFrame);
    
    AFLT_ERRORTYPE_E (*GetCurnFramePrivInfo)(HI_HANDLE hComp, AFLT_FRAME_PRIVINFO_S *pstFramePrivInfo);

    AFLT_ERRORTYPE_E (*SetEosFlag)(HI_HANDLE hComp, HI_BOOL bEosFlag);
} AFLT_COMPONENT_S;
