...
static struct file_operations s_stAdspDevFileOpts =
{
    .owner = THIS_MODULE,
...
static PM_BASEOPS_S s_stAdspDrvOps = {
    .probe        = NULL,
    .remove       = NULL,
    .shutdown     = NULL,
    .prepare      = NULL,
...
static __inline__ int  ADSP_DRV_RegisterDev(void)
{
    ...
    s_stAdspUmapDev.fops   = &s_stAdspDevFileOpts;
    s_stAdspUmapDev.minor  = UMAP_MIN_MINOR_ADSP;
    s_stAdspUmapDev.owner  = THIS_MODULE;
    s_stAdspUmapDev.drvops = &s_stAdspDrvOps;
