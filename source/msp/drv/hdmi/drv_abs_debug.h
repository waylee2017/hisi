...
#define ABS_FATAL(module_id, fmt...)    HI_TRACE(HI_LOG_LEVEL_FATAL, module_id, fmt)
#define ABS_ERR(module_id, fmt...)      HI_TRACE(HI_LOG_LEVEL_ERROR, module_id, fmt)
#define ABS_WARN(module_id, fmt...)     HI_TRACE(HI_LOG_LEVEL_WARNING, module_id, fmt)
#define ABS_INFO(module_id, fmt...)     HI_TRACE(HI_LOG_LEVEL_INFO, module_id, fmt)
