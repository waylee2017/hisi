...
{
    //HI_U32 Ret;
    HDMI_PERI_CRG67 PeriCrg67;
    HDMI_PERI_CRG68 PeriCrg68;
    ...
    //SI_HW_ResetCtrl(1); //reset Control
    //SI_HW_ResetPhy(1);  //reset PHY
    ...
    PeriCrg67.u32 = g_pHDMIRegCrg->PERI_CRG67.u32;
    ...
    g_pHDMIRegCrg->PERI_CRG67.u32 = PeriCrg67.u32;
    ...
    */
    ...
    PeriCrg68.u32 = g_pHDMIRegCrg->PERI_CRG68.u32;

    PeriCrg68.bits.hdmitx_phy_bus_cken = 0;
    PeriCrg68.bits.hdmitx_phy_srst_req = 1;

    g_pHDMIRegCrg->PERI_CRG68.u32 = PeriCrg68.u32;
    ...
    */
    ...
    PeriCrg68.bits.phy_tmds_cken = 0;
    PeriCrg68.bits.phy_tmds_cken = 0;
   PeriCrg68.bits.ssc_bypass_cken = 0   ; /* [2]  */
    PeriCrg68.bits.hdmitx_ctrl_osc_24m_cken = 0  ; /* [3]  */
    PeriCrg68.bits.hdmitx_phy_srst_req = 1  ; /* [4]  */
    PeriCrg68.bits.vdp_hdmi_srst_req = 1  ; /* [5]  */
    PeriCrg68.bits.phy_tmds_srst_req = 1   ; /* [6]  */
    //PeriCrg68.bits.ssc_clk_div           : 4   ; /* [10..7]  */
    //PeriCrg68.bits.tmds_clk_div          : 3   ; /* [14..12]  */
    //PeriCrg68.bits.vou_clk_div           : 5   ; /* [20..16]  */
