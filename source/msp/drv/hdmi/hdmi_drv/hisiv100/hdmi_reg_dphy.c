...
int HDMI_HDMITX_INSSC_reg_Init(void)
{
	...
	#ifdef HDMI_BUILD_IN_BOOT
    gophdmi2tx_dphy_regAllReg = (volatile S_hdmi2tx_dphy_reg_REGS_TYPE*)(BASE_ADDR_phy_reg);
	#else
	gophdmi2tx_dphy_regAllReg = (S_hdmi2tx_dphy_reg_REGS_TYPE*)ioremap_nocache(BASE_ADDR_phy_reg, 0xbc);
	#endif
    ...
    {
        COM_ERR("gophdmi2tx_dphy_regAllReg = null,fail!\n");
        return HI_FAILURE;
    }
}
...
int HDMI_HDMITX_INSSC_reg_DeInit(void)
{
    if (HI_NULL != gophdmi2tx_dphy_regAllReg)
    {
        ...
        iounmap(gophdmi2tx_dphy_regAllReg);
	#endif
...
//  Input       : unsigned int ureg_sscin_bypass_en: 1 bits
...
#define HDMITXRegWrite(pu32RegAddr , u32Value) (*(volatile HI_U32*)pu32RegAddr = u32Value)


#define HDMITXRegRead(pu32RegAddr) (*(volatile HI_U32*)(pu32RegAddr))


HI_S32 HDMITXVerifyRegWrite(HI_U32 *pu32RegAddr, HI_U32 u32RegValue, HI_CHAR *pRegName)
{
    if ((pu32RegAddr != HI_NULL)&&(*pu32RegAddr != u32RegValue))
    {
        COM_ERR("VirAddr=%p, WValue=0x%08x, RValue=0x%08x, name= %s , error!\n", pu32RegAddr,u32RegValue, *pu32RegAddr,pRegName);
        return HI_FALSE;
    }
...
//  Input       : unsigned int ureg_pllfbmash111_en: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_ssc_mode: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_deep_color: 2 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_sscfifo_depth_clr: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_sscfifo_tune_en: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_set_load: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_set: 24 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_ssc_sync: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_tune_reverse: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_sscfifo_upper_thresh: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_sscfifo_lower_thresh: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_tune_step: 8 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_testd: 8 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_span: 14 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_step: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_tune_interval: 32 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_mash111_hk_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_hkmash_en: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_dnum: 5 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscin_div: 5 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscin_reverse_flag: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscin_stop_flag: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscin_segment: 2 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscin_span_cnt: 15 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscin_ssc_offset: 24 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscin_sscfifo_depth_min: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscin_sscfifo_depth_max: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscfb_div: 5 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscfb_reverse_flag: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscfb_stop_flag: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscfb_segment: 2 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscfb_span_cnt: 15 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscfb_ssc_offset: 24 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscfb_sscfifo_depth_min: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int usscfb_sscfifo_depth_max: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ufbmash_div: 5 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ufbmash_reverse_flag: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ufbmash_stop_flag: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ufbmash_segment: 2 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ufbmash_span_cnt: 15 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ufbmash_ssc_offset: 24 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ufbmash_sscfifo_depth_min: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ufbmash_sscfifo_depth_max: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_aphy_data_ch2_h: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_aphy_data_ch1_h: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_aphy_data_ch0_h: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_aphy_data_clk_h: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int utxafifo_empt_status: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int utxafifo_aempt_status: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int utxafifo_full_status: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int utxafifo_aful_status: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_aphy_data_ch2_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_aphy_data_ch1_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_aphy_data_ch0_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_txafifo_rst: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_txafifo_status_rst: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_aphy_data_clk_l: 30 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_aphy_data_ch2: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_aphy_data_ch1: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_aphy_data_ch0: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_d2_dataout_sel: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_d1_dataout_sel: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_d0_dataout_sel: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_ck_dataout_sel: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_prbs7_errinject: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_prbs7_clr: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_prbs7_en: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int uad_txpll_lock: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int uad_txpll_hvflag: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int uad_rxsense: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_divsel: 2 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_gc_txpll_pd: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_gc_pd_rxsense: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_gc_pd_rterm: 8 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_gc_pd_ldo: 2 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_gc_pd_de: 4 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_gc_pd_bist: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_gc_pd: 4 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_main_de_clk: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_main_d2: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_main_d1: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_main_d0: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_main_clk: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_pre_d0: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_pre_clk: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_main_de_d2: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_main_de_d1: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_main_de_d0: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_pre_de_d1: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_pre_de_d0: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_pre_de_clk: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_pre_d2: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_pre_d1: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_rsel_pre_de_d2: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_rsel_pre_de_d1: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_rsel_pre_de_d0: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_rsel_pre_de_clk: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_rsel_pre_d2: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_rsel_pre_d1: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_rsel_pre_d0: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_rsel_pre_clk: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_isel_pre_de_d2: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_rt_d2: 8 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_rt_d1: 8 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_rt_d0: 8 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_rt_clk: 8 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_sr_clk: 2 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_sel_rxsense: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_sel_ldo: 6 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_test_dc: 16 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_test: 16 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_gc_txpll_en_sscdiv: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_gc_txpll_en_ref_fb_div2: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_txpll_icp_ictrl: 4 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_txpll_divsel_post: 2 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_txpll_divsel_loop: 7 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_txpll_divsel_in: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_txpll_clkin_sel: 2 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_txpll_test: 20 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_pll_lock_times: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_pll_lockext_sel: 3 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_pll_unlock_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_pll_lock_sel: 2 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_ref_unlock_timer: 8 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_ref_lock_timer: 8 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_fb_prd_sel: 2 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_fb_div_sel: 2 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int uhdmi_clk_lock: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int upll_lock_oneshot: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int utest_pll_cnt: 17 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int upll_ena_edge: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int uclk_fb_exist: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_txdphy_dummy_ctrl: 32 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_ssc_mode_fb: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_sscfifo_depth_clr_fb: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_sscfifo_tune_en_fb: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_set_load_fb: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_set_fb: 24 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_ssc_sync_fb: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_tune_reverse_fb: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_sscfifo_upper_thresh_fb: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_sscfifo_lower_thresh_fb: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_tune_step_fb: 8 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_testd_fb: 8 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_span_fb: 14 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_step_fb: 10 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
...
//  Input       : unsigned int ureg_tune_interval_fb: 32 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
