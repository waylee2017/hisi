...
WICCBAaHIAm7RQ8Nd3+5VgwW/fe28nBjQNpEkWAqLjrvQatTDtc41tSbADyg18kescTqLcs/
CrzoHHXS/X1qjs3fPFp1KnI6whnMQ9r6yFB/JN5QQiGLhoRfjt126CmhAV6fQg==#*/
...
static int decode_user_data(MpegEncContext *s, GetBitContext *gb)
{
    ...
    if (e != 4)
    { e = sscanf(buf, "FFmpeg v%4d.%4d.%4d / libavcodec build: %4d", &ver, &ver2, &ver3, &build); }
