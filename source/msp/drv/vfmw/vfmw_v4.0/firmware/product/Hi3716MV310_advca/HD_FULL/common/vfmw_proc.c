...
int vfmw_read_proc(struct seq_file *p, void *v)
{
    ...
    {
        seq_printf(p, "%-35s %d:%d.%d%%\n", "VDM load", i, g_VfmwGlobalStat[i].u32VaVdmLoad / 10, g_VfmwGlobalStat[i].u32VaVdmLoad % 10);
    }
    ...
    seq_printf(p, "%-35s :%d\n", "u32VdmKiloCycle", g_VfmwGlobalStat[0].u32VaVdmKiloCycle);
    seq_printf(p, "%-35s :%d\n", "u32StatPeriod", g_VfmwGlobalStat[0].u32StatTime);
