...
typedef struct
{
    ...
    SINT32     DSD_OldWidth;//l00273086
    SINT32     DSD_OldHeight;//l00273086
    SINT32     DSD_NewWidth;
    SINT32     DSD_NewHeight;
    SINT32     DSD_NeedClearQue;//l00273086
} H264_CTX_S;


/*************************** func declare *************************/
VOID FindTrailZeros(H264_CTX_S *pH264Ctx);
...
UINT32 H264DEC_VDMPostProc( H264_CTX_S *pH264Ctx, SINT32 ErrRatio, SINT32 CalledByISR, LUMA_INFO_S *pLumaInfo, SINT32 s32LowdelayFlag);
