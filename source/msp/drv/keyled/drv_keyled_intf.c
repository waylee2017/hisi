...
HI_S32 KEYLED_DRV_ModInit(HI_VOID)
{
    ...
    snprintf(g_stKeyLedDev.devfs_name, sizeof(g_stKeyLedDev.devfs_name), UMAP_DEVNAME_KEYLED);
...
#if 1
    item = HI_DRV_PROC_AddModule(HI_MOD_KEYLED, NULL, NULL);
    if (!item)
    {
...
HI_VOID KEYLED_DRV_ModExit(HI_VOID)
{
    ...
    HI_DRV_PROC_RemoveModule(HI_MOD_KEYLED);
