...
{
    HI_U32 u32IEC61937DataType = IEC61937_DATATYPE_NULL;   /* Value of PC bit 0-6 */
    HI_U16 u16Data[8];
    HI_U16* pu16Data;
...
{
    const HI_CHAR *apcName[HI_UNF_AI_BUTT] =
    {
        "I2S0",
        "I2S1",
        "ADC0",
    ...
    if (enAiPort < HI_UNF_AI_BUTT)
    {
        return apcName[enAiPort];
    }
    return "UnknownPort";
}
#endif
