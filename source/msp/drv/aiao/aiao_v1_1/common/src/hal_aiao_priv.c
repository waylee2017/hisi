...
#elif defined (AIAO_PLL_811MHZ)
static HI_U32 g_u32MclkPLLTab[5][13] = {
/* crg = mclk0*pow(2, CRG_POW)/ ARM_BPLL_FREQ */ 
/* 128*FS mclk */ 
{0x000295fa,/* 8000 */ 0x0003904a,/* 11025 */ 0x0003e0f8,/* 12000 */ 0x00052bf5,/* 16000 */ 0x00072095,/* 22050 */ 0x0007c1f0,/* 24000 */ 0x000a57eb,/* 32000 */ 
0x000e412a,/* 44100 */ 0x000f83e1,/* 48000 */ 0x001c8254,/* 88200 */ 0x001f07c2,/* 96000 */ 0x003904a8,/* 176400 */ 0x003e0f84,/* 192000 */ },
/* 256*FS mclk */ 
{0x00052bf5,/* 8000 */ 0x00072095,/* 11025 */ 0x0007c1f0,/* 12000 */ 0x000a57eb,/* 16000 */ 0x000e412a,/* 22050 */ 0x000f83e1,/* 24000 */ 0x0014afd6,/* 32000 */ 
0x001c8254,/* 44100 */ 0x001f07c2,/* 48000 */ 0x003904a8,/* 88200 */ 0x003e0f84,/* 96000 */ 0x00720950,/* 176400 */ 0x007c1f09,/* 192000 */ },
/* 384*FS mclk */ 
{0x0007c1f0,/* 8000 */ 0x000ab0df,/* 11025 */ 0x000ba2e8,/* 12000 */ 0x000f83e1,/* 16000 */ 0x001561bf,/* 22050 */ 0x001745d1,/* 24000 */ 0x001f07c2,/* 32000 */ 
0x002ac37e,/* 44100 */ 0x002e8ba3,/* 48000 */ 0x005586fc,/* 88200 */ 0x005d1746,/* 96000 */ 0x00ab0df8,/* 176400 */ 0x00ba2e8d,/* 192000 */ },
/* 512*FS mclk */ 
{0x000a57eb,/* 8000 */ 0x000e412a,/* 11025 */ 0x000f83e1,/* 12000 */ 0x0014afd6,/* 16000 */ 0x001c8254,/* 22050 */ 0x001f07c2,/* 24000 */ 0x00295fad,/* 32000 */ 
0x003904a8,/* 44100 */ 0x003e0f84,/* 48000 */ 0x00720950,/* 88200 */ 0x007c1f09,/* 96000 */ 0x00e412a0,/* 176400 */ 0x00f83e12,/* 192000 */ },
/* 1024*FS mclk */ 
{0x0014afd6,/* 8000 */ 0x001c8254,/* 11025 */ 0x001f07c2,/* 12000 */ 0x00295fad,/* 16000 */ 0x003904a8,/* 22050 */ 0x003e0f84,/* 24000 */ 0x0052bf5b,/* 32000 */ 
0x00720950,/* 44100 */ 0x007c1f09,/* 48000 */ 0x00e412a0,/* 88200 */ 0x00f83e12,/* 96000 */ 0x01c82540,/* 176400 */ 0x01f07c24,/* 192000 */ },
};
#elif defined (AIAO_PLL_405MHZ)
static HI_U32 g_u32MclkPLLTab[5][13] = {
	/* crg = mclk0*pow(2, CRG_POW)/ ARM_BPLL_FREQ */ 
/* 128*FS mclk */ 
{0x00052bf5,/* 8000 */ 0x00072094,/* 11025 */ 0x0007c1f0,/* 12000 */ 0x000a57eb,/* 16000 */ 0x000e4129,/* 22050 */ 0x000f83e1,/* 24000 */ 0x0014afd6,/* 32000 */ 
0x001c8253,/* 44100 */ 0x001f07c2,/* 48000 */ 0x003904a7,/* 88200 */ 0x003e0f84,/* 96000 */ 0x0072094f,/* 176400 */ 0x007c1f08,/* 192000 */ },
/* 256*FS mclk */ 
{0x000a57eb,/* 8000 */ 0x000e4129,/* 11025 */ 0x000f83e1,/* 12000 */ 0x0014afd6,/* 16000 */ 0x001c8253,/* 22050 */ 0x001f07c2,/* 24000 */ 0x00295fad,/* 32000 */ 
0x003904a7,/* 44100 */ 0x003e0f84,/* 48000 */ 0x0072094f,/* 88200 */ 0x007c1f08,/* 96000 */ 0x00e4129e,/* 176400 */ 0x00f83e10,/* 192000 */ },
/* 384*FS mclk */ 
...
/* 512*FS mclk */ 
{0x0014afd6,/* 8000 */ 0x001c8253,/* 11025 */ 0x001f07c2,/* 12000 */ 0x00295fad,/* 16000 */ 0x003904a7,/* 22050 */ 0x003e0f84,/* 24000 */ 0x0052bf5a,/* 32000 */ 
0x0072094f,/* 44100 */ 0x007c1f08,/* 48000 */ 0x00e4129e,/* 88200 */ 0x00f83e10,/* 96000 */ 0x01c8253c,/* 176400 */ 0x01f07c20,/* 192000 */ },
/* 1024*FS mclk */ 
{0x00295fad,/* 8000 */ 0x003904a7,/* 11025 */ 0x003e0f84,/* 12000 */ 0x0052bf5a,/* 16000 */ 0x0072094f,/* 22050 */ 0x007c1f08,/* 24000 */ 0x00a57eb5,/* 32000 */ 
0x00e4129e,/* 44100 */ 0x00f83e10,/* 48000 */ 0x01c8253c,/* 88200 */ 0x01f07c20,/* 96000 */ 0x03904a78,/* 176400 */ 0x03e0f840,/* 192000 */ },
...
HI_VOID AIAO_HW_SetInt(AIAO_PORT_ID_E enPortID, HI_U32 u32Multibit)
{
    ...
    case AIAO_MODE_TXSPDIF:
        if(ChnId >= AIAO_MAX_TXSPDIF_PORT_NUMBER )
        {
            HI_ERR_AIAO("SPDIF ERR ChdId %d\n",ChnId);
            return;
        }
...
HI_S32 AIAO_HW_SetStart(AIAO_PORT_ID_E enPortID, HI_S32 bEn)
{
    ...
    case AIAO_MODE_RXI2S:
    case AIAO_MODE_TXI2S:
        AIAO_LOW_SetStart(ChnId, PORT2DIR(enPortID), bEn);
        break;
    case AIAO_MODE_TXSPDIF:
        if(ChnId >= AIAO_MAX_TXSPDIF_PORT_NUMBER )
        {
        ...
        AIAO_LOW_SPDIFSetStart(ChnId, bEn);
...
HI_S32   AIAO_HW_GetStopDoneStatus(AIAO_PORT_ID_E enPortID)
{
    ...
    case AIAO_MODE_RXI2S:
    case AIAO_MODE_TXI2S:
        return AIAO_LOW_GetStopDoneStatus(ChnId, PORT2DIR(enPortID));
    case AIAO_MODE_TXSPDIF:
        if(ChnId >= AIAO_MAX_TXSPDIF_PORT_NUMBER )
        {
            HI_ERR_AIAO("SPDIF ERR ChdId %d\n",ChnId);
        ...
        return AIAO_LOW_SPDIFGetStopDoneStatus(ChnId);
    default:
        return 1;
    }
}
...
HI_VOID AIAO_HW_SetBypass(AIAO_PORT_ID_E enPortID, HI_S32 bEn)
{
    ...
    case AIAO_MODE_RXI2S:
    case AIAO_MODE_TXI2S:
        AIAO_LOW_SetBypass(ChnId, PORT2DIR(enPortID), bEn);
        break;
    case AIAO_MODE_TXSPDIF:
        if(ChnId >= AIAO_MAX_TXSPDIF_PORT_NUMBER )
        {
        ...
        AIAO_LOW_SPDIFSetBypass(ChnId, bEn);
...
HI_VOID AIAO_HW_SetVolumedB(AIAO_PORT_ID_E enPortID, HI_S32 VoldB)
{
    ...
    case AIAO_MODE_RXI2S:
    case AIAO_MODE_TXI2S:
        AIAO_LOW_SetVolumedB(ChnId, PORT2DIR(enPortID), VoldB);
        break;
    case AIAO_MODE_TXSPDIF:
        if(ChnId >= AIAO_MAX_TXSPDIF_PORT_NUMBER )
        {
        ...
        AIAO_LOW_SPDIFSetVolumedB(ChnId, VoldB);
        break;
	default:
		break;
...
HI_VOID AIAO_HW_SetFadeOutRate(AIAO_PORT_ID_E enPortID, AIAO_FADE_RATE_E eFadeRate)
{
    ...
    case AIAO_MODE_RXI2S:
    case AIAO_MODE_TXI2S:
        AIAO_LOW_SetFadeOutRate(ChnId, PORT2DIR(enPortID), eFadeRate);
        break;
    case AIAO_MODE_TXSPDIF:
        if(ChnId >= AIAO_MAX_TXSPDIF_PORT_NUMBER )
        {
        ...
        AIAO_LOW_SPDIFSetFadeOutRate(ChnId, eFadeRate);
        break;
	default:
		break;
...
HI_VOID AIAO_HW_SetFadeInRate(AIAO_PORT_ID_E enPortID, AIAO_FADE_RATE_E eFadeRate)
{
    ...
    case AIAO_MODE_RXI2S:
    case AIAO_MODE_TXI2S:
        AIAO_LOW_SetFadeInRate(ChnId, PORT2DIR(enPortID), eFadeRate);
        break;
    case AIAO_MODE_TXSPDIF:
        if(ChnId >= AIAO_MAX_TXSPDIF_PORT_NUMBER )
        {
        ...
        AIAO_LOW_SPDIFSetFadeInRate(ChnId, eFadeRate);
        break;
	default:
		break;
...
HI_VOID AIAO_HW_SetMuteFade(AIAO_PORT_ID_E enPortID, HI_S32 bEn)
{
    ...
    case AIAO_MODE_RXI2S:
    case AIAO_MODE_TXI2S:
        AIAO_LOW_SetMuteFade(ChnId, PORT2DIR(enPortID), bEn);
        break;
    case AIAO_MODE_TXSPDIF:
        if(ChnId >= AIAO_MAX_TXSPDIF_PORT_NUMBER )
        {
        ...
        AIAO_LOW_SPDIFSetMuteFade(ChnId, bEn);
        break;
	default:
		break;
...
HI_VOID AIAO_HW_SetMute(AIAO_PORT_ID_E enPortID, HI_S32 bEn)
{
    ...
    case AIAO_MODE_RXI2S:
    case AIAO_MODE_TXI2S:
        AIAO_LOW_SetMute(ChnId, PORT2DIR(enPortID), bEn);
        break;
    case AIAO_MODE_TXSPDIF:
        if(ChnId >= AIAO_MAX_TXSPDIF_PORT_NUMBER )
        {
        ...
        AIAO_LOW_SPDIFSetMute(ChnId, bEn);
        break;
	default:
		break;
...
{
    HI_U32 ChnId = PORT2CHID(enPortID);
    HI_U32 offset = 0,u32WptrReg = 0,u32RptrReg = 0;
    switch (PORT2MODE(enPortID))
    {
    case AIAO_MODE_RXI2S:
...
static HI_VOID  AIAO_LOW_SetI2SSlaveClk(HI_U32 u32ChnId, HI_S32 Dir, AIAO_IfAttr_S *pstIfAttrSlave)
{
    ...
    {    
#ifdef HI_AIAO_TIMER_SUPPORT  
        if(u32ChnId >= AIAO_MAX_RX_RG_NUMBER)//codecc
        {
            HI_ERR_AIAO("Rx ERR ChdId %d\n",u32ChnId);
            return;
        }
#endif
...
static HI_VOID AIAO_TXBUF_SetBufAddrAndSize(HI_U32 u32ChnId, HI_S32 TxType, HI_U32 u32StartAddr, HI_U32 u32BufSize)
{
    ...
    {
        if(u32ChnId >= AIAO_MAX_TXSPDIF_PORT_NUMBER )
        {
            HI_ERR_AIAO("SPDIF ERR ChdId %d\n",u32ChnId);
            return;
        }
