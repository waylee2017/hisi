...
#define AIAO_IRQ_NUM (84 + 32)  /*s5 fpga 67*/
   ...
   || defined(CHIP_TYPE_hi3716mv320)\
   || defined(CHIP_TYPE_hi3110ev500)
#define AIAO_PLL_405MHZ 1
#elif defined(CHIP_TYPE_hi3716mv330)
#define AIAO_PLL_811MHZ 1
...
/* asic&fpga  */
    ...
    || defined(CHIP_TYPE_hi3796cv100_a) || defined(CHIP_TYPE_hi3796cv100) || defined(CHIP_TYPE_hi3798cv100_a) || defined(CHIP_TYPE_hi3798cv100)
#define AIAO_CBB_REGBASE    (0xff210000)
#elif defined(CHIP_TYPE_hi3716mv310)\
   || defined(CHIP_TYPE_hi3716mv320)\
   || defined(CHIP_TYPE_hi3110ev500)\
   || defined(CHIP_TYPE_hi3716mv330)
#define AIAO_CBB_REGBASE    (0x10160000)
#else
...
#define AIAO_MAX_TXSPDIF_PORT_NUMBER (3)
#else
#define AIAO_MAX_TXSPDIF_PORT_NUMBER (4)
#endif

#ifdef HI_AIAO_TIMER_SUPPORT
#define AIAO_MAX_RX_RG_NUMBER (6)
#else
#define AIAO_MAX_RX_RG_NUMBER (8)
#endif
...
typedef HI_VOID AIAO_TimerIsrFunc (AIAO_TIMER_ID_E enTimerID,void *);
#endif
