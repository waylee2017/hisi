    ...
    if (((HI_U8*)-1 != pClutSur->pu8ClutPhyAddr)&&(HI_NULL != pClutSur->pu8ClutPhyAddr))
    {
        ...
        *penClutUsage = TdeOsiGetClutUsage(pClutSur->enColorFmt, pOutSur->enColorFmt);/*AI7D02757*/
        if (TDE_CLUT_CLUT_BYPASS > *penClutUsage)
        {
			...
			memcpy(pMmzClut, pMmuClut, TDE_CLUT_SIZE);
...
#else
            stClutCmd.u32PhyClutAddr = (HI_U32)pClutSur->pu8ClutPhyAddr;
#endif
                                     ...
                                     TDE2_MBOPT_S* pMbOpt)
{
    ...
    switch (pMbOpt->enResize)
    {
        ...
        case TDE2_MBRESIZE_QUALITY_HIGH:
        {
            ...
            s32Ret = TdeHalNodeSetCsc(pstHWNodePass3, stCscOpt);
			if (s32Ret < 0)
			{
				TdeOsiListPutPhyBuff(u32WorkBufNum);
				return s32Ret;
        ...
        case TDE2_MBRESIZE_QUALITY_MIDDLE:
        {
            ...
            s32Ret = TdeHalNodeSetCsc(pstHWNodePass2, stCscOpt);
			if (s32Ret < 0)
			{
				TdeOsiListPutPhyBuff(u32WorkBufNum);
				return s32Ret;
                                       ...
                                       TDE_FILTER_OPT* pstFilterOpt)
{
    ...
    #ifndef HI_BUILD_IN_BOOT
    sliceInfo =(TDE_SLICE_INFO*)HI_GFX_KMALLOC(HIGFX_TDE_ID,u32MaxSliceNum * sizeof(TDE_SLICE_INFO),GFP_KERNEL);
    #else
    sliceInfo = (TDE_SLICE_INFO*)HI_GFX_Malloc(u32MaxSliceNum * sizeof(TDE_SLICE_INFO),"TDE_SLICE_INFO");
    #endif
