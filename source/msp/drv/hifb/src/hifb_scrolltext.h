...
typedef enum
{
    HIFB_SCROLLTEXT_SD0_HANDLE0 = 0x00,
    HIFB_SCROLLTEXT_SD0_HANDLE1 = 0x01,
    HIFB_SCROLLTEXT_HD0_HANDLE0 = 0x20,
    HIFB_SCROLLTEXT_HD0_HANDLE1 = 0x21,
    HIFB_SCROLLTEXT_AD0_HANDLE0 = 0x40,
    HIFB_SCROLLTEXT_AD0_HANDLE1 = 0x41,
    HIFB_SCROLLTEXT_AD1_HANDLE0 = 0x60,
    HIFB_SCROLLTEXT_AD1_HANDLE1 = 0x61,
