...
/* CIPHER register addr define */
    ...
    || defined (CHIP_TYPE_hi3110ev500) || defined (CHIP_TYPE_hi3716mv330) 
#define  CIPHER_REG_BASE_ADDR                   IO_ADDRESS(0x600E0000)
#else
...
#elif defined (CHIP_TYPE_hi3716mv310) || defined (CHIP_TYPE_hi3716mv320) \
    || defined (CHIP_TYPE_hi3110ev500)|| defined (CHIP_TYPE_hi3716mv330)
