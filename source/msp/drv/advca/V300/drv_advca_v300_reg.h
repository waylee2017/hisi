...
#define REG_SYS_GEN24     (0x101e00E0)
#define CA_V300_BASE_ADDR 0x10000000
#define OTP_V200_CRG_ADDR 0x101f5048
#elif defined(CHIP_TYPE_hi3716mv310) || defined (CHIP_TYPE_hi3110ev500) || defined(CHIP_TYPE_hi3716mv320) || defined(CHIP_TYPE_hi3716mv330)
#define REG_SYS_GEN24     (0x101e00E0)
#define CA_V300_BASE_ADDR 0x10000000
#define OTP_V200_CRG_ADDR 0x101f50c0  //PERI_CRG48 CA 相关的时钟及软复位控制寄存
#else
...
#else
#define CA_V300_BL_CTRL                (CA_V300_BASE_ADDR + 0x30)//Only for Hi3716mv330
#define CA_V300_BLK_ENC_RSLT           (CA_V300_BASE_ADDR + 0xA0)//BLK加密结果寄存器
#endif
#define CA_V300_CA_DIN0                (CA_V300_BASE_ADDR + 0x20)//Key Ladder输入待解密数据0寄存器
#define CA_V300_CA_DIN1                (CA_V300_BASE_ADDR + 0x24)//Key Ladder输入待解密数据1寄存器
#define CA_V300_CA_DIN2                (CA_V300_BASE_ADDR + 0x28)//Key Ladder输入待解密数据2寄存器
#define CA_V300_CA_DIN3                (CA_V300_BASE_ADDR + 0x2C)//Key Ladder输入待解密数据3寄存器
#define CA_V300_TEST_CRTL              (CA_V300_BASE_ADDR + 0x30)//测试控制寄存器
...
typedef union
{
    struct
    {
        ...
        HI_U32 otp_srst_req    : 1; //[10]   //otp 软复位请求。0：不复位；1：复位。
        HI_U32 reserved        : 1; //[11]
        HI_U32 ca_ci_clk_sel   : 1; //[12]        //ca cipher 时钟选择。
