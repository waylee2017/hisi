...
/* OTP Address */
#if defined(CHIP_TYPE_hi3716mv300) || defined(CHIP_TYPE_hi3716mv310) || defined(CHIP_TYPE_hi3110ev500) || defined(CHIP_TYPE_hi3716mv320) || defined(CHIP_TYPE_hi3716mv330)
...
typedef union
{
    struct
    {
        ...
        HI_U32 tskl_nv_disable      : 1;//0x02[3]  //as samle as tskl_sm4_disable for hi3716mv310
...
typedef union
{
    struct
    {
        HI_U32 reserved0            : 5;//  0x400[4~0]
        HI_U32 freq_ddr             : 2;//  0x400[6~5]
        HI_U32 reserved1            : 9;//  0x400[7],0x401[7~0]
        HI_U32 soc_id               : 5;//  0x402[4:0]
        HI_U32 reserved2            : 3;//  0x402[7~5]
        HI_U32 macrovision_disable  : 1;//  0x403[0]
        HI_U32 reserved3            : 7;//  0x403[7~1]
    } bits;
    HI_U32 u32;
...
typedef union
{
    struct
    {
        HI_U32 reserved0            : 3;//  0x404[2~0]
        HI_U32 ethernet_disable     : 1;//  0x404[3]
        HI_U32 reserved1            : 1;//  0x404[4]
        HI_U32 uart_disable         : 1;//  0x404[5]
        HI_U32 reserved2            : 3;//  0x404[7~6]~0x405[0]
        HI_U32 video_cfg            : 8;//  0x405[7~1]~0x406[0]
        HI_U32 reserved3            : 4;//  0x406[4~1]
        HI_U32 usb2_disable         : 1;//  0x406[5]
        HI_U32 reserved4            : 10;// 0x406[7~6]~0x407[7~0]
    } bits;
    HI_U32 u32;
...
typedef union
{
    struct
    {
        HI_U32 reserved1               : 5;// 0x410[4~0]
        HI_U32 freq_ddr_lock           : 2;//  0x410[6~5]
        HI_U32 reserved2               : 9;// 0x410[7]~ 0x411[7~0]
        HI_U32 soc_id_lock             : 5;//  0x412[4~0]
        HI_U32 reserved3               : 11;//  0x412[7~5]~0x412[7~0]
        HI_U32 macrovision_disable_lock: 1;//  0x413[0]
        HI_U32 reserved4               : 7;//  0x413[7~1]
    } bits;
    HI_U32 u32;
...
typedef union
{
    struct
    {
        HI_U32 reserved1               : 3;// 0x414[2~0]
        HI_U32 ethernet_disable_lock  : 1;// 0x414[3]
        HI_U32 reserved2               : 1;// 0x414[4]
        HI_U32 uart_disable_lock       : 1;// 0x414[5]
        HI_U32 reserved3               : 3;// 0x414[7~6]~0x415[0]
        HI_U32 video_cfg_lock          : 8;//0x415[7:1]~0x416[0]
        HI_U32 reserved4               : 4;// 0x416[4~1]
        HI_U32 usb2_disable_lock       : 1;// 0x416[5]
        HI_U32 reserved5               : 10;// 0x416[7~6]~0x414[7~0]
    } bits;
    HI_U32 u32;
