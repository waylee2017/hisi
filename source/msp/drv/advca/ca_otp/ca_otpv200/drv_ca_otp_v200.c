...
HI_S32 DRV_CA_OTP_V200_SetBootMode(CA_OTP_FLASH_TYPE_E type)
{
    ...
    switch (type)
    {
        ...
        case CA_OTP_FLASH_TYPE_SPI_NAND :
        {
        ...
        default:
        {
            HI_ERR_CA("Invalid bootmode flash type input:%d!\n", type);
            return HI_ERR_CA_INVALID_PARA;
        }
    }
    ...
    if ((1 == PVLOCK_0.bits.boot_mode_sel_1_lock) && (1 == PVLOCK_0.bits.boot_mode_sel_0_lock))
    {
        ...
        if ( (PV_0.bits.boot_mode_sel_1 != PV_0_otp.bits.boot_mode_sel_1) || (PV_0.bits.boot_mode_sel_0 != PV_0_otp.bits.boot_mode_sel_0))
        {
...
HI_S32 DRV_CA_OTP_V200_GetBootMode(CA_OTP_FLASH_TYPE_E* pType)
{
    HI_S32 ret = HI_SUCCESS;
    HI_U32 bootMode = 0;
    ...
    bootMode = (g_pOTPExportFunctionList->HAL_OTP_V200_Read)(CA_OTP_V200_INTERNAL_PV_0);

    switch (bootMode & 0x03)
    {
        case 0x00:
        {
            *pType = CA_OTP_FLASH_TYPE_SPI;
            break;
        }
        case 0x01:
        {
            *pType = CA_OTP_FLASH_TYPE_NAND;
            break;
        }
        case 0x02:
        {
            *pType = CA_OTP_FLASH_TYPE_SPI_NAND;
            break;
        }
        default:
        {
            *pType = CA_OTP_FLASH_TYPE_BUTT;
            break;
        }
    }
...
HI_S32 DRV_CA_OTP_V200_SetSPLadderLevel(CA_OTP_KEY_LEVEL_E level)
{
    ...
    if ( (1 == PVLOCK_0.bits.sp_lv_sel_lock) || (0x01 == PVLOCK_1.bits.sp_lv_sel_2_lock) )
    {
        ...
        if (HI_UNF_ADVCA_KEYLADDER_LEV2 == (HI_UNF_ADVCA_KEYLADDER_LEV_E)level)
        {
        ...
        else if (HI_UNF_ADVCA_KEYLADDER_LEV3 == (HI_UNF_ADVCA_KEYLADDER_LEV_E)level)
        {
        ...
        else if (HI_UNF_ADVCA_KEYLADDER_LEV4 == (HI_UNF_ADVCA_KEYLADDER_LEV_E)level)
        {
        ...
        else if (HI_UNF_ADVCA_KEYLADDER_LEV5 == (HI_UNF_ADVCA_KEYLADDER_LEV_E)level)
        {
...
HI_S32 DRV_CA_OTP_V200_SetTZEnable(HI_VOID)
{
    HI_S32 ret = HI_SUCCESS;
    CA_OTP_V200_INTERNAL_PV_1_U PV_1;
    ...
    {
        HI_ERR_CA("Soc and otp tz have already been enabled!\n");
        return HI_SUCCESS;
    }
...
HI_S32 DRV_CA_OTP_V200_SetUSBDisable(HI_VOID)
{
    HI_S32 ret = HI_SUCCESS;
...
HI_S32 DRV_CA_OTP_V200_SetUARTDisable(HI_VOID)
{
    ...
    /*lock value*/
    CFGLOCK_0.u32 = 0;
    CFGLOCK_0.bits.uart_disable_lock = 1;
...
HI_S32 DRV_CA_OTP_V200_GetUARTDisable(HI_U32* pu32Disable)
{
    ...
    *pu32Disable = CFG_1.bits.uart_disable;
...
HI_S32 DRV_CA_OTP_V200_SetEthernetDisable(HI_VOID)
{
    ...
    /*lock value*/
    CFGLOCK_0.u32 = 0;
    CFGLOCK_0.bits.ethernet_disable_lock = 1;
    ret = (g_pOTPExportFunctionList->HAL_OTP_V200_Write)(CA_OTP_V200_CHIPSET_CONFIGURE_LOCK_1, CFGLOCK_0.u32);
    if (HI_SUCCESS != ret)
    {
        HI_ERR_CA("Fail to set usb2_disable_lock bit!\n");
...
HI_S32 DRV_CA_OTP_V200_GetEthernetDisable(HI_U32* pu32Disable)
{
    ...
    *pu32Disable = CFG_1.bits.ethernet_disable;
...
HI_S32 DRV_CA_OTP_V200_SetOtpFuse(CA_OTP_ATTR_S* pstOtpAttr)
{
    ...
    switch (pstOtpAttr->enOtpFuseId)
    {
        case HI_UNF_ADVCA_OTP_SECURE_BOOT_ACTIVATION:
            ...
            enFlashType = (CA_OTP_FLASH_TYPE_E)pstOtpAttr->stOtpAttr.unOtpFuseAttr.stEnableSecureBoot.enFlashType;
            if (bEnable)
            {
        ...
        case HI_UNF_ADVCA_OTP_USB_DEACTIVATION:
            ret = DRV_CA_OTP_V200_SetUSBDisable();
            break;
        ...
        case HI_UNF_ADVCA_OTP_SM4_CRYPTO_ENGINE_DEACTIVATION:
            ret = DRV_CA_OTP_V200_SetSM4Disable();   // For Hi3716mv310 is tskl_sm4_disable
            break;
