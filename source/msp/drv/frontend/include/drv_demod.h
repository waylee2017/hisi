...
extern HI_U32 g_u32ConnectTimeOut;
...
extern HI_S32 tuner_chip_reset(HI_BOOL bEnable,HI_U32 u32ResetGpioNo);
...
/*for hi3716mv310*/
extern HI_S32 hi3716mv310_connect(HI_U32 u32TunerPort, TUNER_ACC_QAM_PARAMS_S *pstChannel);
extern HI_S32 hi3716mv310_get_status (HI_U32 u32TunerPort, HI_UNF_TUNER_LOCK_STATUS_E  *penTunerStatus);
extern HI_S32 hi3716mv310_get_signal_strength(HI_U32 u32TunerPort, HI_U32 *pu32SignalStrength);
extern HI_S32 hi3716mv310_get_ber(HI_U32 u32TunerPort, HI_U32* pu32ber);
extern HI_S32 hi3716mv310_get_snr(HI_U32 u32TunerPort, HI_U32* pu32SNR);
extern HI_S32 hi3716mv310_set_ts_type(HI_U32 u32TunerPort, HI_UNF_TUNER_OUPUT_MODE_E enTsType);
extern HI_S32 hi3716mv310_config_tuner(HI_U32 u32TunerPort, HI_U32 dbRFfreq, HI_S32 times);
extern HI_S32 hi3716mv310_get_freq_symb_offset(HI_U32 u32TunerPort, HI_U32 * pu32Freq, HI_U32 * pu32Symb );
extern HI_S32 hi3716mv310_get_signal_info(HI_U32 u32TunerPort, HI_UNF_TUNER_SIGNALINFO_S *pstInfo);
extern HI_S32 hi3716mv310_get_rs(HI_U32 u32TunerPort, HI_U32 *pu32Rs);
extern HI_VOID hi3716mv310_test_single_agc( HI_U32 u32TunerPort, AGC_TEST_S * pstAgcTest );
extern HI_VOID hi3716mv310_manage_after_chipreset(HI_U32 u32TunerPort);
#ifdef HI_TUNER_PROC_SUPPORT
extern HI_VOID hi3716mv310_get_registers(HI_U32 u32TunerPort, void *p);
#endif
extern HI_VOID hi3716mv310_connect_timeout(HI_U32 u32ConnectTimeout);

/*for hi3716mv310j83b*/
extern HI_S32 hi3716mv310_j83b_connect(HI_U32 u32TunerPort, TUNER_ACC_QAM_PARAMS_S *pstChannel);
extern HI_S32 hi3716mv310_j83b_get_status (HI_U32 u32TunerPort, HI_UNF_TUNER_LOCK_STATUS_E  *penTunerStatus);
extern HI_S32 hi3716mv310_j83b_get_signal_strength(HI_U32 u32TunerPort, HI_U32 *pu32SignalStrength);
extern HI_S32 hi3716mv310_j83b_get_ber(HI_U32 u32TunerPort, HI_U32* pu32ber);
extern HI_S32 hi3716mv310_j83b_get_snr(HI_U32 u32TunerPort, HI_U32* pu32SNR);
extern HI_S32 hi3716mv310_j83b_set_ts_type(HI_U32 u32TunerPort, HI_UNF_TUNER_OUPUT_MODE_E enTsType);
extern HI_S32 hi3716mv310_j83b_config_tuner(HI_U32 u32TunerPort, HI_U32 dbRFfreq, HI_S32 times);
extern HI_S32 hi3716mv310_j83b_get_freq_symb_offset(HI_U32 u32TunerPort, HI_U32 * pu32Freq, HI_U32 * pu32Symb );
extern HI_S32 hi3716mv310_j83b_get_signal_info(HI_U32 u32TunerPort, HI_UNF_TUNER_SIGNALINFO_S *pstInfo);
extern HI_S32 hi3716mv310_j83b_get_rs(HI_U32 u32TunerPort, HI_U32 *pu32Rs);
extern HI_VOID hi3716mv310_j83b_test_single_agc( HI_U32 u32TunerPort, AGC_TEST_S * pstAgcTest );
extern HI_VOID hi3716mv310_j83b_manage_after_chipreset(HI_U32 u32TunerPort);
#ifdef HI_TUNER_PROC_SUPPORT
extern HI_VOID hi3716mv310_j83b_get_registers(HI_U32 u32TunerPort, void *p);
#endif
extern HI_VOID hi3716mv310_j83b_connect_timeout(HI_U32 u32ConnectTimeout);

/* for av6211 */
extern HI_S32 avl6211_init(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_UNF_TUNER_DEV_TYPE_E enTunerDevType);
...
/*for mxl101*/
extern HI_S32 mxl101_init(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_UNF_TUNER_DEV_TYPE_E enTunerDevType);
...
/*for mn88472*/
extern HI_S32 MN88472_Init(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_UNF_TUNER_DEV_TYPE_E enTunerDevType);
...
/*for it9170*/
extern HI_S32 it9170_init(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_UNF_TUNER_DEV_TYPE_E enTunerDevType);
...
/*for it9133*/
extern HI_S32 it9133_init(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_UNF_TUNER_DEV_TYPE_E enTunerDevType);
...
extern HI_S32  tda18280_get_signal_info(HI_U32 u32TunerPort, HI_UNF_TUNER_SIGNALINFO_S *pstInfo);
