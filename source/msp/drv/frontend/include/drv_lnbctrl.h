...
extern LNBCTRL_DEV_PARAM_S* lnbctrl_queue_insert(HI_U32 u32TunerPort, HI_U32 u32I2CNum,
                                          HI_U8 u8DevAddr, HI_UNF_DEMOD_DEV_TYPE_E enDemodDevType);
extern LNBCTRL_DEV_PARAM_S* lnbctrl_queue_get(HI_U32 u32TunerPort);
extern HI_VOID              lnbctrl_queue_remove(HI_U32 u32TunerPort);
