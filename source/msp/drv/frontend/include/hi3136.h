...
/*for hi3136*/
extern HI_S32 hi3136_init(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_UNF_TUNER_DEV_TYPE_E enTunerDevType);
...
extern HI_VOID hi3136_read_tuner_registers(HI_U32 u32TunerPort, HI_VOID *p);
