    ...
    do { \
        ...
        { \
        	if((u32TunerPort == arraryName[allocationIndex].u32TunerPort) \
                && (HI_UNF_TUNER_SIG_TYPE_BUTT != arraryName[allocationIndex].enHi3138SigType)) \
        	{ \
        		break; \
        	} \
        } \
...
/** ADC port select*/
/** CNcomment:ADC端口选择*/
typedef enum hi3138_ADC_PORT_E
{
...
extern HI_S32 hi3138_init(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_UNF_TUNER_DEV_TYPE_E enTunerDevType);
...
extern HI_S32 hi3138_data_sample(HI_U32 u32TunerPort, TUNER_DATA_SRC_E enDataSrc, HI_U32 u32DataLen, HI_UNF_TUNER_SAMPLE_DATA_S *pstData);
...
extern HI_VOID hi3138_read_tuner_registers(HI_U32 u32TunerPort, HI_VOID *p);
