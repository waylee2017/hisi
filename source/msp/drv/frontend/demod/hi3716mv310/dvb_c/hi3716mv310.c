...
/* MXL661 HI3716MV310 CONFIG */
static REGVALUE_S s_stMXL661Qam16[]=
{
#include "qamdata/MXL661/MXL661_QAM16_V200.txt"
};

static REGVALUE_S s_stMXL661Qam32[]=
{
#include "qamdata/MXL661/MXL661_QAM32_V200.txt"
};

static REGVALUE_S s_stMXL661Qam64[]=
{
#include "qamdata/MXL661/MXL661_QAM64_V200.txt"
};

static REGVALUE_S s_stMXL661Qam128[]=
{
#include "qamdata/MXL661/MXL661_QAM128_V200.txt"
};

static REGVALUE_S s_stMXL661Qam256[]=
{
#include "qamdata/MXL661/MXL661_QAM256_V200.txt"
};

static REGVALUE_S *s_astMXL661QamRegs[HI_TUNER_QAM_TYPE_MAX] =
{	
    s_stMXL661Qam16, s_stMXL661Qam32, s_stMXL661Qam64, s_stMXL661Qam128, s_stMXL661Qam256
};
#endif

#if defined(TUNER_DEV_TYPE_SI2150)
/* SI2150 HI3716MV310 CONFIG */
static REGVALUE_S s_stSI2150Qam16[]=
{
#include "qamdata/SI2150/SI2150_QAM16_V200.txt"
};

static REGVALUE_S s_stSI2150Qam32[]=
{
#include "qamdata/SI2150/SI2150_QAM32_V200.txt"
};

static REGVALUE_S s_stSI2150Qam64[]=
{
#include "qamdata/SI2150/SI2150_QAM64_V200.txt"
};

static REGVALUE_S s_stSI2150Qam128[]=
{
#include "qamdata/SI2150/SI2150_QAM128_V200.txt"
};

static REGVALUE_S s_stSI2150Qam256[]=
{
#include "qamdata/SI2150/SI2150_QAM256_V200.txt"
};

static REGVALUE_S *s_astSI2150QamRegs[HI_TUNER_QAM_TYPE_MAX] =
{	
    s_stSI2150Qam16, s_stSI2150Qam32, s_stSI2150Qam64, s_stSI2150Qam128, s_stSI2150Qam256
};
#endif

#if defined(TUNER_DEV_TYPE_R850)

/* R850 hi3716mv310 CONFIG */
...
HI_VOID hi3716mv310_get_registers(HI_U32 u32TunerPort, void *p)
{
    HI_U8   u8Value = 0;
    HI_S32  i = 0;
    HI_S32  s32RegSum = 0;
...
static HI_VOID hi3716mv310_set_reg_value(HI_U32 u32TunerPort)
{
   ...
   switch( g_stTunerOps[u32TunerPort].enTunerDevType )
   {
	 ...
	 case HI_UNF_TUNER_DEV_TYPE_MXL661:
        {
            pstReg = s_astMXL661QamRegs[u32QamType];
            break;
        }
		#endif
	 ...
	 case HI_UNF_TUNER_DEV_TYPE_SI2150:
        {
            pstReg = s_astSI2150QamRegs[u32QamType];
            break;
        }
		#endif
...
HI_S32 hi3716mv310_get_signal_info(HI_U32 u32TunerPort, HI_UNF_TUNER_SIGNALINFO_S *pstInfo)
{
