...
static HI_VOID hi3716mv310_j83b_select_qam_block(HI_U32 u32TunerPort)
{
    HI_U8 u8Tmp = 0;
...
#if defined(TUNER_DEV_TYPE_TDA18215)
/* TDA18215 J83B CONFIG */
static REGVALUE_S s_stTda18215Qam16[]=
{
#include "qamdata/TDA18215/TDA18215_QAM16_J83B.txt"
};

static REGVALUE_S s_stTda18215Qam32[]=
{
#include "qamdata/TDA18215/TDA18215_QAM32_J83B.txt"
};

static REGVALUE_S s_stTda18215Qam64[]=
{
#include "qamdata/TDA18215/TDA18215_QAM64_J83B.txt"
};

static REGVALUE_S s_stTda18215Qam128[]=
{
#include "qamdata/TDA18215/TDA18215_QAM128_J83B.txt"
};

static REGVALUE_S s_stTda18215Qam256[]=
{
#include "qamdata/TDA18215/TDA18215_QAM256_J83B.txt"
};
...
/*MXL603 hi3716mv310_J83B CONFIG*/
...
/*MXL608 hi3716mv310_J83B CONFIG*/
...
/*M88TC3800 hi3716mv310_J83B CONFIG*/
...
static char *s_sthi3716mv310J83BQamRegName[]=
{
...
static HI_VOID set_symrate(HI_U32 u32TunerPort, HI_U32 u32SymRate)
{
    ...
    if((u8VersionReg >> 5) == 5)
    {
        hi3716mv310_j83b_select_qam_block(u32TunerPort);
    }
...
HI_VOID hi3716mv310_j83b_test_single_agc( HI_U32 u32TunerPort, AGC_TEST_S * pstAgcTest )
{
    HI_S32 s32Ret = 0;
    HI_U8  u8RegVal = 0;
    HI_U8  au8Tmp[2] = {0};
...
static HI_VOID hi3716mv310_j83b_chip_reset(HI_U32 u32TunerPort, qam_module_e enResetModule)
{
    HI_U8 u8VersionReg = 0;
...
HI_VOID hi3716mv310_j83b_get_registers(HI_U32 u32TunerPort, void *p)
{
    HI_U8   u8Value = 0;
    HI_S32  i = 0;
    HI_S32  s32RegSum = 0;
    ...
    for( i = 0; i < s32RegSum; i++ )
    {
        ...
        pstReg++;
        PROC_PRINT(p, "{%s  ,0x%02x },  ", s_sthi3716mv310J83BQamRegName[i], u8Value);
    }
    PROC_PRINT(p, "\n\n");
...
static HI_VOID hi3716mv310_j83b_set_customreg_value(HI_U32 u32TunerPort, HI_BOOL bInversion, HI_U32 u32SymbolRate)
{
    HI_U8 u8Val = 0;
    HI_U8 u8VersionReg = 0;
...
static HI_VOID hi3716mv310_j83b_set_reg_value(HI_U32 u32TunerPort)
{
    HI_S32  i = 0;
    HI_S32  s32RegSum;
    HI_U32  u32QamType;
...
HI_S32 hi3716mv310_j83b_get_status (HI_U32 u32TunerPort, HI_UNF_TUNER_LOCK_STATUS_E  *penTunerStatus)
{
    HI_U8  u8Status = 0;
...
HI_VOID hi3716mv310_j83b_manage_after_chipreset(HI_U32 u32TunerPort)
{
    //HI_S32  s32Cnt = 0;
...
static HI_U32 s_u32hi3716mv310J83bConnectTimeout = HI3130J83B_CONNCECT_TIMEOUT;
HI_VOID hi3716mv310_j83b_connect_timeout(HI_U32 u32ConnectTimeout)
{
    s_u32hi3716mv310J83bConnectTimeout = u32ConnectTimeout;
    return;
}
HI_S32 hi3716mv310_j83b_connect(HI_U32 u32TunerPort, TUNER_ACC_QAM_PARAMS_S *pstChannel)
{
    ...
    hi3716mv310_j83b_set_reg_value(u32TunerPort);    /*set for qam and tunner*/

    /*set for different usr request about symbolrate, ts type, demo in or out,  inversion or not*/
    hi3716mv310_j83b_set_customreg_value(u32TunerPort, pstChannel->bSI, u32SymbolRate);

    /*step 3:reset chip*/
    hi3716mv310_j83b_chip_reset(u32TunerPort, ALL_CHIP);
...
HI_S32 hi3716mv310_j83b_get_signal_strength(HI_U32 u32TunerPort, HI_U32 *pu32SignalStrength)
{
    HI_U8  au8RegVal[2] = {0};
...
HI_S32 hi3716mv310_j83b_get_ber(HI_U32 u32TunerPort, HI_U32 *pu32ber)
{
...
HI_S32 hi3716mv310_j83b_get_rs(HI_U32 u32TunerPort, HI_U32 *pu32Rs)
{
...
HI_S32 hi3716mv310_j83b_get_snr(HI_U32 u32TunerPort, HI_U32* pu32SNR)
{
    HI_U32 u32Snr = 0;
    HI_U8  u8RdVal = 0;
    HI_U32 i ;
...
HI_S32 hi3716mv310_j83b_set_ts_type(HI_U32 u32TunerPort, HI_UNF_TUNER_OUPUT_MODE_E enTsType)
{
...
HI_S32 hi3716mv310_j83b_get_freq_symb_offset(HI_U32 u32TunerPort, HI_U32 * pu32Freq, HI_U32 * pu32Symb )
{
    HI_U8  au8Freq[4] = { 0 };
...
HI_S32 hi3716mv310_j83b_get_signal_info(HI_U32 u32TunerPort, HI_UNF_TUNER_SIGNALINFO_S *pstInfo)
{
