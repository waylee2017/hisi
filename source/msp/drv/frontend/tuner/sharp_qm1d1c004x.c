...
static HI_S32 sharp_write(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel,
...
HI_S32 sharp7903_set_tuner(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_U32 u32PuRF/*kHz*/)  //freq :unit MHZ, symbol:unit  Khz
{
