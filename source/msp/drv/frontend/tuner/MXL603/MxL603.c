...
HI_S32	mxl603_init(HI_U32 u32TunerPort)
{
	MXL_BOOL singleSupply_3_3V;
    MXL603_XTAL_SET_CFG_T xtalCfg;
    MXL603_IF_OUT_CFG_T ifOutCfg;
    ...
    HI_INFO_TUNER("mxl603_init entered: %d.\n", u32TunerPort);
	
	devId = (HI_U8)u32TunerPort;
...
HI_S32 mxl603_set_tuner (HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_U32 u32PuRF)
{
...
HI_S32 mxl603_tuner_standby(HI_U32 u32TunerPort, HI_U32 u32Status)
{
    MXL_STATUS status;
	
    MXL603_PWR_MODE_E powerMode = MXL603_PWR_MODE_STANDBY;
    status = MxLWare603_API_CfgDevPowerMode(u32TunerPort, powerMode);
    if(MXL_SUCCESS != status)
    {
        return status;
    }
