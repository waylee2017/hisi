...
*/
  ...
  /* If OEM data is not required, customer should treat devId as I2C slave Address */
...

	{
		pArray[0] = RegAddr;
		pArray[1] = RegData;
		#if defined(DEMOD_DEV_TYPE_HI3130I) || defined(DEMOD_DEV_TYPE_HI3130E)
		    if(g_stTunerOps[devId].enDemodDevType == HI_UNF_DEMOD_DEV_TYPE_3130I ||
	   		g_stTunerOps[devId].enDemodDevType == HI_UNF_DEMOD_DEV_TYPE_3130E)
		    {
...
#if defined (DEMOD_DEV_TYPE_HI3137) || defined (DEMOD_DEV_TYPE_HI3138)
