...
HI_S32 r850_set_tuner(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_U32 puRF)
{
    R850_Set_Info R850_Info_Msg;
    R850_RF_KHz = puRF;
...
HI_VOID r850_get_signal_strength(HI_U32 u32TunerPort, HI_U32 *pu32SignalStrength)
{
    ...
    pu32SignalStrength[1] = (HI_U32)(RssiDbm + 118);	 
...
HI_VOID r850_tuner_standby(HI_U32 u32TunerPort, HI_U32 u32Status)
{
    R850_ErrCode err = RT_Success;
