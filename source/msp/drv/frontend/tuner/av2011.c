...
static HI_S32 av2011_write(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel,
...
HI_S32 av2011_set_tuner(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_U32 u32PuRF/*kHz*/)  //freq :unit MHZ, symbol:unit  Khz
{
    HI_U8 reg[50];
    HI_U8 reg_start;
    HI_U8 tuner_address;
