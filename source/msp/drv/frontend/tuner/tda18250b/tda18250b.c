...
HI_S32 tda18250b_set_tuner (HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_U32 u32PuRF);
...
HI_VOID tda18250b_tuner_standby(HI_U32 u32TunerPort, HI_U32 u32Status)
{
    tmErrorCode_t err = ( CUInt32 )TM_OK;
    	
    /* TDA18250A Master Hardware power state */
    err = tmbslTDA18250A_SetPowerState (u32TunerPort, tmPowerStandby);
    if (err != TM_OK)
    {
       HI_ERR_TUNER("tmbslTDA18250A_SetPowerState err 0x%x\n",err);
    }
