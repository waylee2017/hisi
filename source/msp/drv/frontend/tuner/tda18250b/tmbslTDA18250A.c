                             ...
                             )
{
    ...
    TDA18250APowerState_t LLPowerState = TDA18250A_PowerNormalMode;
    ...
    if(err == TM_OK)
    {
        ...
        {
            LLPowerState = pObj->mapLLPowerState[powerState];
			
	     if(powerState == tmPowerStandby)
			LLPowerState = TDA18250A_PowerStandbySmoothLTOffXtOutOff;

	     err = iTDA18250A_SetLLPowerState(pObj, LLPowerState);
