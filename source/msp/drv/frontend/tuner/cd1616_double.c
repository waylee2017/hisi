...
static HI_S32 cd1616_double_write(HI_U32 u32TunerPort,HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_U8* pu8Data, HI_U32 u32Num)
{
    HI_U8 i;
    HI_S32 s32Ret;
...
HI_S32 cd1616_double_set_tuner(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_U32 u32PuRF)
{
    HI_U32 u32FreqPll;
	HI_U32 u32RfProg;
