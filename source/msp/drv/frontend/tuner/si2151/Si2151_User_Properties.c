...
/***********************************************************************************************************************************************************
  ...
  Use      :  Modify Si2151 multifunction pins for the individual application.    The modification will be sent to the tuner
              upon initialization.

			  Brief introduction on AGC pin configuration as Si2151 external IF AGC source, please refer to Si2151 application note for details.
			  Configure AGC1 pin as external AGC source to follow the hardware connection
			  Si2151_CONFIG_PINS_CMD_AGC1_MODE_ATV_AGC          //Configure AGC1 pin as external ATV_AGC source
			  Si2151_CONFIG_PINS_CMD_AGC1_MODE_DTV_AGC          //Configure AGC1 pin as external DTV_AGC source
			  Si2151_CONFIG_PINS_CMD_AGC1_MODE_ATV_DTV_AGC      //Configure AGC1 pin as both external ATV_AGC and DTV_AGC source

			  Configure AGC2 pin as external AGC source to follow the hardware connection
			  Si2151_CONFIG_PINS_CMD_AGC2_MODE_ATV_AGC          //Configure AGC2 pin as external ATV_AGC source
			  Si2151_CONFIG_PINS_CMD_AGC2_MODE_DTV_AGC          //Configure AGC2 pin as external DTV_AGC source
			  Si2151_CONFIG_PINS_CMD_AGC2_MODE_ATV_DTV_AGC      //Configure AGC2 pin as both external ATV_AGC and DTV_AGC source

			  If only one of AGC1 and AGC2 pins is configured as external AGC source, please leave the other AGC pin as unchanged mode, that is,
			  Si2151_CONFIG_PINS_CMD_AGC1_MODE_NO_CHANGE or Si2151_CONFIG_PINS_CMD_AGC2_MODE_NO_CHANGE

			  By default,
			  Si2151_CONFIG_PINS_CMD_AGC1_MODE_NO_CHANGE and Si2151_CONFIG_PINS_CMD_AGC2_MODE_NO_CHANGE setting keeps Si2151 IF AGC as internal AGC source
***********************************************************************************************************************************************************/
