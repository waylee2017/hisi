...
typedef enum tagOPTM_AA_DEI_MODE_E
{
    OPTM_AA_DEI_NONE = 0,
    OPTM_AA_DEI_3FIELD,
    OPTM_AA_DEI_4FIELD,
...
HI_VOID OPTM_AA_UpdateZmeCoef_HD(OPTM_VZME_COEF_S *pstZmeModule);
HI_VOID OPTM_AA_UpdateZmeCoef_SD(OPTM_VZME_COEF_S *pstZmeModule);
...
HI_S32 OPTM_AA_AccUpdateLayer(HAL_DISP_LAYER_E enLayer, HI_S32 s32AccRatio);
...
HI_VOID OPTM_AA_VTIApi_SD(HAL_DISP_LAYER_E enLayer,  HI_U32 u32Md,  LTICTI_S *LTICTI);
...
OPTM_AA_DEI_MODE_E OPTM_AA_GetDEIMode(HI_U32 u32Width, HI_U32 u32Height);
