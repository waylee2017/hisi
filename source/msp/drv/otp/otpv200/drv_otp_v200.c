...
HI_S32 OTP_V200_SetHdcpRootKey(HI_U8 *pu8Key)
{
    ...
    {
        HI_ERR_OTP("Error! HDCP root key is set and can not be changed any more!\n");
        return HI_FAILURE;
    }
...
HI_S32 OTP_V200_GetHdcpRootKey(HI_U8 *pu8Key)
{
    ...
    HI_ERR_OTP("HDCP root key is not supported to read!\n");    
...
HI_S32 OTP_V200_SetHdcpRootKeyLock(HI_VOID)
{
    ...
    if (HI_SUCCESS != ret)
    {
        HI_ERR_OTP("Set hdcp rootkey lock failed!\n");    
        return ret;
    }
	return HI_SUCCESS;
}
...
HI_S32 OTP_V200_SetSTBRootKey(HI_U8 u8Key[16])
{
    ...
    {
        HI_ERR_OTP("Error! STB root key is set and can not be changed any more!\n");
        return HI_FAILURE;
    }
...
HI_S32 OTP_V200_GetSTBRootKey(HI_U8 u8Key[16])
{
    ...
    HI_ERR_OTP("STB root key is not supported to read!\n");
...
HI_S32 OTP_V200_LockSTBRootKey(HI_VOID)
{
    ...
    {
        HI_PRINT("Lock stb rootkey failed!\n");
        return s32Ret;
    }
	return HI_SUCCESS;
}
