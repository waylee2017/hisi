...
#elif defined(CHIP_TYPE_hi3716mv310) || defined(CHIP_TYPE_hi3716mv320) || defined(CHIP_TYPE_hi3110ev500) || defined(CHIP_TYPE_hi3716mv330)
...
typedef union
{
    struct 
    {
        ...
        HI_U32  pvr_tsi4_cken   : 1;    // [6]
        HI_U32  pvr_tsi5_cken   : 1;    // [7]
        HI_U32  reserved0          : 2;  //[8:9]
        HI_U32  pvr_ts0_cken    : 1;    // [10]
        HI_U32  reserved1         : 1;    // [11]
        HI_U32  pvr_tsout0_cken : 1;    // [12]
        HI_U32  pvr_tsi3_sel        : 1;    // [13]
        HI_U32  pvr_tsi4_sel          : 1;   //[14]
        HI_U32  pvr_tsi5_sel          : 1;   //[15]
        HI_U32  pvr_tsi2_pctrl          : 1;  //[16]
        HI_U32  pvr_tsi3_pctrl          : 1;  //[17]
        HI_U32  pvr_tsi4_pctrl          : 1;  //[18]
        HI_U32  pvr_tsi5_pctrl          : 1;  //[19]
        HI_U32  reserved2          : 2;  //[20:21]
        HI_U32  pvr_srst_req             : 1; //[22]
        HI_U32  reserved3          : 2;  //[23:31]
    }bits;
...
typedef union
{
    struct
    {
        ...
        HI_U32  reserved1           : 1;    // [11]
        HI_U32  pvr_ts0_clk_sel     : 2;    // [13:12]
        HI_U32  reserved2     : 2;    // [15:14]
        HI_U32  pvr_ts0_clk_div     : 4;    // [19:16]
        HI_U32  reserved3           : 12;    // [31:20]
    } bits;

    HI_U32 value;
} U_PERI_CRG64;

#define PERI_CRG22          (0x0058)

typedef union
{
    struct
    {
        HI_U32  core_bus_clk_sel    : 2;    // [1:0]
        HI_U32  mde0_clk_sel        : 2;    // [3:2]
        HI_U32  mde1_clk_sel        : 2;    // [5:4]
        HI_U32  bus_200m_sel        : 2;    // [7:6]
        HI_U32  clk_28p8m_sel       : 1;    // [8]
        HI_U32  clk_27m_sel         : 1;    // [9]   pvr 27m clk src 1:epll  0:vpll
        HI_U32  reserved0           : 2;    //[11:10]
        HI_U32  core_bus_clk_div    : 2;    // [13:12]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    tsout_source_sel    : 3  ; // [10..8]
        unsigned int    Reserved_1            : 1  ; // [11]
        unsigned int    tsout_dbg_auto      : 1  ; // [12]
...
typedef union
{
    struct
    {
        ...
        HI_U32  reserved0               : 4;   //[29:26]
        HI_U32  ip_judge_null_desc  : 1;    //[30]
        HI_U32  reserved1           : 1;    // [31]
    #else
