...
#else
static inline HI_S32  DMX_OsiGetTSOPortAttr(const HI_U32 PortId, HI_UNF_DMX_TSO_PORT_ATTR_S *PortAttr)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_OsiSetTSOPortAttr(const HI_U32 PortId, const HI_UNF_DMX_TSO_PORT_ATTR_S *PortAttr)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}
#endif
...
HI_S32  DMX_OsiPeekDataRequest(HI_U32 u32ChId, HI_U32 u32PeekLen, DMX_UserMsg_S* psMsgList);
...
#else
static inline HI_S32 DMX_DRV_REC_CreateChannel(HI_UNF_DMX_REC_ATTR_S *RecAttr, DMX_REC_TIMESTAMP_MODE_E enRecTimeStamp,HI_U32 *RecId, HI_U32 *BufPhyAddr, HI_U32 *BufSize)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_DestroyChannel(HI_U32 RecId)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_AddRecPid(HI_U32 RecId, HI_U32 Pid, HI_U32 *ChanId)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_DelRecPid(HI_U32 RecId, HI_U32 ChanId)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_DelAllRecPid(HI_U32 RecId)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_AddExcludeRecPid(HI_U32 RecId, HI_U32 Pid)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_DelExcludeRecPid(HI_U32 RecId, HI_U32 Pid)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_DelAllExcludeRecPid(HI_U32 RecId)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_GetTsCnt(HI_U32 RecId,HI_U32* TSCnt)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_StartRecChn(HI_U32 RecId)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_StopRecChn(HI_U32 RecId)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_AcquireRecData(HI_U32 RecId, HI_U32 *PhyAddr, HI_U32 *KerAddr, HI_U32 *Len, HI_U32 Timeout)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_ReleaseRecData(HI_U32 RecId, HI_U32 PhyAddr, HI_U32 Len)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_AcquireRecIndex(HI_U32 RecId, HI_UNF_DMX_REC_INDEX_S *RecIndex, HI_U32 Timeout)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_GetRecBufferStatus(HI_U32 RecId, HI_UNF_DMX_RECBUF_STATUS_S *BufStatus)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}    

static inline HI_S32  DMX_DRV_REC_AcquireScdData(HI_U32 RecId, HI_U32 *PhyAddr, HI_U32 *KerAddr, HI_U32 *Len, HI_U32 Timeout)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32  DMX_DRV_REC_ReleaseScdData(HI_U32 RecId, HI_U32 PhyAddr, HI_U32 Len)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32 DMX_DRV_REC_AcquireRecDataIndex(HI_U32 RecId, HI_UNF_DMX_REC_DATA_INDEX_S *pstRecDataIdx)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}

static inline HI_S32 DMX_DRV_REC_ReleaseRecDataIndex(HI_U32 RecId, HI_UNF_DMX_REC_DATA_INDEX_S *pstRecDataIdx)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}
