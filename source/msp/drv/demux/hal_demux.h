...
HI_VOID DmxHalIPPortEnableJudgeNullDesc(HI_U32 PortId);
#endif
...
static inline HI_S32  DmxHalSetScdFilter(HI_U32 u32FltId, HI_U8 u8Content)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}
static inline HI_S32  DmxHalSetScdRangeFilter(HI_U32 u32FltId, HI_U8 u8High, HI_U8 u8Low)
{
    return HI_ERR_DMX_NOT_SUPPORT;
}
static inline HI_VOID DmxHalSetScdNewRangeFilter(HI_U32 FilterId, HI_U8 High, HI_U8 Low, HI_U8 Mask, HI_BOOL Negate)
{
    return;
}

static inline HI_VOID DmxHalChooseScdFilter(HI_U32 ScdId, HI_U32 FilterId){return;}
static inline HI_VOID DmxHalScdFilterClear(HI_U32 ScdId){return;}
static inline HI_VOID DmxHalChooseScdRangeFilter(HI_U32 ScdId, HI_U32 FilterId){return;}
static inline HI_VOID DmxHalScdRangeFilterClear(HI_U32 ScdId){return;}
static inline HI_VOID DmxHalChooseScdNewRangeFilter(HI_U32 ScdId, HI_U32 FilterId){return;}
static inline HI_VOID DmxHalScdNewRangeFilterClear(HI_U32 ScdId){return;}

static inline HI_VOID DmxHalEnablePesSCD(HI_U32 ScdId){return;}
static inline HI_VOID DmxHalDisablePesSCD(HI_U32 ScdId){return;}
static inline HI_VOID DmxHalEnableEsSCD(HI_U32 ScdId){return;}
static inline HI_VOID DmxHalDisableEsSCD(HI_U32 ScdId){return;}
static inline HI_VOID DmxHalEnableMp4SCD(HI_U32 ScdId){return;}
static inline HI_VOID DmxHalDisableMp4SCD(HI_U32 ScdId){return;}
static inline HI_VOID DmxHalSetSCDAttachChannel(HI_U32 ScdId, HI_U32 ChanId){return;}
static inline HI_VOID DmxHalAllocSCDBufferId(HI_U32 ScdId, HI_U32 OqId){return;}

#endif /* #ifdef HI_DEMUX_SCD_SUPPORT */
...
HI_VOID DmxHalGetCurrentSCR(HI_U32 *ScrClk);
...
HI_VOID DmxHalIPPortRateSet(HI_U32 PortId, HI_U32 Rate);
HI_VOID DmxHalTSOPortSetAttr(HI_U32 PortId,HI_UNF_DMX_TSO_PORT_ATTR_S *PortAttr);

#else
static inline HI_VOID DmxHalGetTSOClkCfg(HI_U32 PortId,HI_BOOL *ClkReverse,HI_U32 *enClk,HI_U32 *ClkDiv){return;}
static inline HI_VOID DmxHalCfgTSOClk(HI_U32 PortId,HI_BOOL ClkReverse,HI_U32 enClk,HI_U32 ClkDiv){return;}
static inline HI_VOID DmxHalIPPortRateSet(HI_U32 PortId, HI_U32 Rate){return;}
static inline HI_VOID DmxHalTSOPortSetAttr(HI_U32 PortId,HI_UNF_DMX_TSO_PORT_ATTR_S *PortAttr){return;}
#endif
...
HI_U32  DmxHalFQGetOverflowIntType(HI_U32 offset);
...
HI_U32  DmxHalGetOqCounter(HI_U32 OQId);
