...
typedef struct hiDMX_KeyInfo_S
{
    HI_U32  CaType;
    HI_U32  CaEntropy;
    HI_U32  DescType;
...
typedef struct hiDRV_PES_EXT_DATA_S
{
    struct mutex          pes_lock;/* mutex_lock */
    HI_MPI_PES_EXT_DATA_S stPesExtData;
}HI_DRV_PES_EXT_DATA_S;
...
typedef struct
{
    ...
    HI_DRV_PES_EXT_DATA_S           stDrvPesExtData;
#endif
} DMX_ChanInfo_S;
...
typedef struct hiDMX_DEV_OSI_S
{
    ...
    struct mutex              lock_Channel;
    struct mutex              lock_AVChan;
    struct mutex              lock_Filter;
    struct mutex              lock_Key;
