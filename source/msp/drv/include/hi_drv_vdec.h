...
typedef struct hiVDEC_DNR_Capture_S
{
    HI_UNF_VO_FRAMEINFO_S *pstInFrame;
    HI_UNF_VO_FRAMEINFO_S *pstOutFrame;
    HI_U32 u32PhyAddr;
    HI_U32 u32Size;
    HI_U32 u32TimeOutMs;
}HI_DRV_VDEC_DNR_Capture_S;
...
HI_S32 HI_DRV_VDEC_RecvFrmBuf(HI_S32 s32Handle, HI_UNF_VO_FRAMEINFO_S * pstFrameInfo);
HI_S32 HI_DRV_VDEC_RlsFrmBuf(HI_S32 s32Handle, HI_UNF_VO_FRAMEINFO_S * pstFrameInfo);
HI_S32 HI_DRV_VDEC_RlsFrmBufWithoutHandle(HI_S32 s32Handle, HI_UNF_VO_FRAMEINFO_S * pstFrameInfo);
HI_S32 HI_DRV_VDEC_GetEsBuf(HI_S32 s32Handle,  VDEC_ES_BUF_S * pstBuf);
HI_S32 HI_DRV_VDEC_PutEsBuf(HI_S32 s32Handle,  VDEC_ES_BUF_S * pstBuf);
HI_S32 HI_DRV_VDEC_DNR_Capture(HI_S32 s32Handle, HI_DRV_VDEC_DNR_Capture_S * pstDNRCapInfo);
