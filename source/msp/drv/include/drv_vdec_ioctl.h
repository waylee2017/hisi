...
{
    HI_HANDLE               hHandle;
    HI_UNF_AVPLAY_FRAMERATE_PARAM_S stFrameRate;
...
#define UMAPC_VDEC_CHAN_PROGRSSIVE      _IOWR (HI_ID_VDEC, 0x93, VDEC_CMD_SET_PROGRESSIVE_S)
