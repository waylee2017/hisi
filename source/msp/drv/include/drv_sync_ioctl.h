...
typedef struct hiSYNC_PCR_INFO_S
{
    ...
    HI_BOOL                    PCRPreSyncAdjust;     /* adjust flag */
    SYNC_PCR_ADJUST_E          enPcrAdjust;          /*which way to adjust scr*/
    HI_S32                     PcrDelta;             /*adjust pcr value*/

    HI_U32                     CurPcrGradient;          /*Current Pcr Gradient,  multiply CurPcrGradient by 1000*/
    HI_U32                     LstPcrGradient;          /*Last Pcr Gradient,  multiply LstPcrGradient by 1000*/
    HI_U32                     CalPcrGradient;          /*Cal Pcr Gradient,  multiply CalPcrGradient by 1000*/
...
typedef struct hiSYNC_BUF_STATUS_S
{
    ...
    HI_BOOL   VidBlockFlag;
    HI_BOOL   AudBlockFlag;
    HI_U32    VfmwFrmNum;
    HI_U32    VfmwStrmSize;
    HI_U32    VidStrmInBps;
    HI_BOOL   VidEmptyFlag;
    HI_BOOL   VidLowFlag;
    HI_BOOL   AudEmptyFlag;
    HI_BOOL   AudLowFlag;
...
typedef struct hiSYNC_S
{
	...
	HI_BOOL                    AudAdjustFlag;        /* vid can't adjust, we must adjust aud*/
    ...
    HI_BOOL                    VidDiscard;           /* discard mode flag */
...
#define CMD_SYNC_AUD_JUDGE      _IOWR(HI_ID_SYNC, IOC_SYNC_START_JUDGE, SYNC_AUD_JUDGE_S)
