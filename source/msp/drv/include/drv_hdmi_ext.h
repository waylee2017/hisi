...
typedef HI_S32  (*FN_HDMI_PreFormat)(HI_UNF_HDMI_ID_E enHdmi, HI_UNF_ENC_FMT_E enEncodingFormat);
typedef HI_S32  (*FN_HDMI_SetFormat)(HI_UNF_HDMI_ID_E enHdmi, HI_UNF_ENC_FMT_E enFmt, HI_UNF_HDMI_3D_FORMAT_E enStereo);

typedef HI_S32  (*FN_HDMI_Detach)(HI_UNF_HDMI_ID_E enHdmi);
typedef HI_S32  (*FN_HDMI_Attach)(HI_UNF_HDMI_ID_E enHdmi, HI_UNF_ENC_FMT_E enFmt, HI_UNF_HDMI_3D_FORMAT_E enStereo);

typedef HI_S32  (*FN_HDMI_Suspend)(PM_BASEDEV_S *pdev, pm_message_t state);
typedef HI_S32  (*FN_HDMI_Resume)(PM_BASEDEV_S *pdev);

typedef HI_S32  (*FN_HDMI_SoftResume)(HI_UNF_ENC_FMT_E enFmt, HI_UNF_VIDEO_FRAME_PACKING_TYPE_E enStereo);
