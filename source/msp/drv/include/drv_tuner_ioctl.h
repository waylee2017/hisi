...
typedef struct _TUNER_OPS_S
{
    ...
    HI_S32 (*tuner_init)(HI_U32 u32TunerPort, HI_UNF_TUNER_I2cChannel_E enI2cChannel, HI_UNF_TUNER_DEV_TYPE_E enTunerDevType);
    ...
    HI_S32 (*tuner_monitor_ISDBT_layer)(HI_U32 u32TunerPort, HI_UNF_TUNER_MONITOR_LAYERS_CONFIG_S* enMonLayer);
...
#define TUNER_SET_MULTI_MODE_CHIP_ATTR_CMD _IOWR(HI_TUNER_IOC_MAGIC, 50, TUNER_ATTR_S)
#define TUNER_CLOSE_CMD _IOWR(HI_TUNER_IOC_MAGIC, 51, TUNER_DATA_S)
#define TUNER_MONITOR_ISDBT_LAYER_CMD _IOWR(HI_TUNER_IOC_MAGIC, 52, TUNER_ISDBTLAYER_S)
#define TUNER_TS_OUTPUT_SWAP_CMD _IOW(HI_TUNER_IOC_MAGIC, 53, TUNER_DATA_S)
#define TUNER_SETTERATTR_CMD _IOWR(HI_TUNER_IOC_MAGIC, 54, TUNER_DATA_S)
#define TUNER_SETCABATTR_CMD _IOWR(HI_TUNER_IOC_MAGIC, 55, TUNER_DATA_S)
#define TUNER_GET_ADC_DATA_CMD _IOW(HI_TUNER_IOC_MAGIC, 56, TUNER_DATABUF_S)
