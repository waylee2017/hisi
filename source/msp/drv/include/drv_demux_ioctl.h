...
typedef struct hiDMX_PesExtData_S
{
    HI_HANDLE hChannel;
...
#define DEMUX_CHAN_CMD_EXT          (0xa0)
...
#define CMD_DEMUX_PES_EXT_DATA_GET          _IOWR(HI_ID_DEMUX, 0x83, DMX_PesExtData_S)          /* Get PES EXT DATA */
...
#define CMD_DEMUX_REC_CHAN_ACQUIRE_DATA_INDEX    _IOWR(HI_ID_DEMUX, 0xA0, DMX_Rec_ProcessDataIndex_S)
#define CMD_DEMUX_REC_CHAN_RELEASE_DATA_INDEX    _IOWR(HI_ID_DEMUX, 0xA1, DMX_Rec_ProcessDataIndex_S)
