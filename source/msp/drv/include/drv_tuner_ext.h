...
typedef HI_S32 (*FN_TUNER_PROC_DISEQC)(struct seq_file * p, HI_VOID * v);
typedef HI_S32 (*FN_TUNER_PROC_CIR_PLOT)(struct seq_file * p, HI_VOID * v);
typedef HI_S32 (*FN_TUNER_PROC_CONSTELLATION)(struct seq_file * p, HI_VOID * v);
typedef HI_S32 (*FN_TUNER_PROC_SPECTRUM)(struct seq_file * p, HI_VOID * v);
...
typedef struct
{
	...
	FN_TUNER_PROC_DISEQC pfnTunerProcDiseqc;
    FN_TUNER_PROC_CIR_PLOT pfnTunerProcCirPlot;
    FN_TUNER_PROC_CONSTELLATION pfnTunerProcConstellation;
    FN_TUNER_PROC_SPECTRUM pfnTunerProcSpectrum;
