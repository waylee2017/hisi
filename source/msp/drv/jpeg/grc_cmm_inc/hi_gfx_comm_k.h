...
static inline HI_VOID *HI_GFX_Map(HI_U32 u32PhyAddr,HI_U32 size, HI_BOOL bMmu)
{
...
#endif
        {
            ...
            pu8VirDdr = (HI_U8*)(unsigned long)stMMZBuffer.u32StartVirAddr;
        }
...
static inline HI_VOID HI_GFX_Flush(GFX_MMZ_BUFFER_S *stFlushBuf, HI_BOOL bMmu)
{
...
#endif
    {
        ...
        stMMZBuffer.u32StartVirAddr = (unsigned long)stFlushBuf->pu8StartVirAddr;
...
#endif
        {
            stMMZBuffer.u32StartVirAddr = (unsigned long)pViraddr;
...
static inline HI_S32 HI_GFX_AllocAndMap(const HI_CHAR *pName, HI_CHAR* pZoneName, HI_U32 u32LayerSize, HI_S32 s32Align, GFX_MMZ_BUFFER_S *pstBuf)
{
...
#endif
        {
            ...
            pstBuf->pu8StartVirAddr   = (HI_U8*)(unsigned long)stMMZBuffer.u32StartVirAddr;
...
#endif
        {
            stMMZBuffer.u32StartVirAddr = (unsigned long)pstBuf->pu8StartVirAddr;
