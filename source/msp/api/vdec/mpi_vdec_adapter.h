...
typedef struct
{
    ...
    HI_UNF_VO_FRAMEINFO_S      *pstVoFrameInfo;
    HI_BOOL                         bCapture;
} VFMW_IFRAME_PARAM_S;
...
typedef enum
{
    ...
    VFMW_CMD_SETFRAMERATE,      /**< The param is HI_UNF_AVPLAY_FRAMERATE_PARAM_S* */
    VFMW_CMD_GETFRAMERATE,      /**< The param is HI_UNF_AVPLAY_FRAMERATE_PARAM_S* */
    ...
    VFMW_CMD_SET_PROGRESSIVE = 0x23,/* Set progressive info, the param is HI_UNF_AVPLAY_CONTROL_INFO_S* */
    VFMW_CMD_BUTT,
    VFMW_CMD_DROPSTREAM
} VFMW_CMD_E;
...
//HI_VOID VDEC_FrameInfo_UNF2Vo(HI_UNF_VIDEO_FRAME_INFO_S *pstSrc, HI_UNF_VO_FRAMEINFO_S *pstDst);
