...
#define PVR_CACHE_BUFFER_WRITE_INVALID (PVR_CACHE_BUFFER_STATE_BUTT|PVR_CACHE_BUFFER_STATE_WRITE|PVR_CACHE_BUFFER_STATE_FLUSH)
#define PVR_CACHE_BUFFER_READ_INVALID  (PVR_CACHE_BUFFER_STATE_BUTT|PVR_CACHE_BUFFER_STATE_FLUSH)
#define PVR_CACHE_BUFFER_FLUSH_INVALID (PVR_CACHE_BUFFER_STATE_BUTT|PVR_CACHE_BUFFER_STATE_READ|PVR_CACHE_BUFFER_STATE_WRITE|PVR_CACHE_BUFFER_STATE_FLUSH)
