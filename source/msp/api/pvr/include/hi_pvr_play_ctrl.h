...
#define PVR_PLAY_BUFFER_DEFAULT_TIME_TIMESHIFT  (1500)
#define PVR_PLAY_BUFFER_MAX_TIME_TIMESHIFT      (60*1000)
...
typedef struct hiPVR_PLAY_STREAM_INFO_S
{
    HI_U32 u32Width;
    HI_U32 u32Height;
#ifdef HI_PVR_SOFT_INDEX_SUPPORT    
    HI_U32 u32FpsInteger;
    HI_U32 u32FpsDemical;
#endif    
}PVR_PLAY_STREAM_INFO_S;
...
typedef struct hiPVR_PLAY_CHN_S
{
    ...
    HI_BOOL            bInterPauseForTimeshift;
    HI_U32           u32BufferTimeForTimeshift;
    HI_UNF_SYNC_REF_E       enLastSyncState;
    HI_UNF_PVR_PLAY_STATE_E enState;                 /* play state */
    HI_UNF_PVR_PLAY_SPEED_E enSpeed;
#ifdef HI_PVR_SOFT_INDEX_SUPPORT
    HI_PVR_TRICK_PROCESS_PARA_S stTrickAttr;
#else   
    HI_PVR_SMOOTH_PARA_S stFBAttr;
#endif
    PVR_PLAY_STREAM_INFO_S        stStreamInfo;
