...
HI_S32 HI_UNF_PVR_RegisterEventByChn(HI_U32 u32ChnId,eventCallBack callBack,HI_VOID * args)
{
    return HI_PVR_RegisterEventByChn(u32ChnId, callBack, args);
}

HI_S32 HI_UNF_PVR_UnRegisterEventByChn(HI_U32 u32ChnId)
{
    return HI_PVR_UnRegisterEventByChn(u32ChnId);
}
