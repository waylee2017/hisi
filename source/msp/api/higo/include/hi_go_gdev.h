...
\attention \n
The value takes effect at once, and you do not need to refresh it.from top to bottom,the value from little to big
CNcomment:立即生效，无需刷新，图层从上到下对应的值从小到大 CNend
\param[in] Layer Layer handle. CNcomment:图层句柄 CNend
\param[in] enZFlag Zorder flag.  
