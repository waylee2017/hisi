...
//HISILICON add begin
//ADP_HARD_DECODE: add ourself header files, will use inner function and other paras
#include "jmemmgr.h"
...
{
//HISILICON add begin
//ADP_HARD_DECODE: if the memory not enough, alloc failure
...
{
//HISILICON add begin
//ADP_HARD_DECODE: use mmz buffer and check whether should alloc buffer
#if 1
	JPEG_HDEC_HANDLE_S_PTR pJpegHandle = (JPEG_HDEC_HANDLE_S_PTR)(cinfo->client_data);
    /** 使用meminfo确认内存是否足够**/
...
#else
//HISILICON add begin
//ADP_HARD_DECODE: use mmz buffer
    size_t PhysAddr = 0;
    large_pool_ptr hdr_ptr;
...
{
//HISILICON add begin
//ADP_HARD_DECODE: release mem information
