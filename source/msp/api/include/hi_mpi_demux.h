...
#define PES_EXT1_DATA_MAXSIZE (16)
#define PES_EXT2_DATA_MAXSIZE (128)

/** Define pes extension type */
/**CNcomment:定义PES扩展数据的类型*/
typedef enum hiMPI_DMX_PES_EXT_DATA_TYPE_E
{
    HI_MPI_DMX_PES_EXT1_DATA_TYPE = (0x1<<0), /**<PES extension type 1*//**<CNcomment:PES 扩展数据类型1*/
    HI_MPI_DMX_PES_EXT2_DATA_TYPE = (0x1<<1), /**<PES extension type 2 *//**<CNcomment:PES 扩展数据类型2*/
    HI_MPI_DMX_PES_EXT_DATA_TYPE_BUTT = 0x0
}HI_MPI_DMX_PES_EXT_DATA_TYPE_E;


typedef struct hiMPI_PES_EXT_DATA_S
{
    HI_MPI_DMX_PES_EXT_DATA_TYPE_E ePesExtDataType;
    HI_U16 u16PesExt1DataLen;
    HI_U16 u16PesExt2DataLen;
    HI_U8 au8PesExt1Data[PES_EXT1_DATA_MAXSIZE];   /* pes extension data 1 */
    HI_U8 au8PesExt2Data[PES_EXT2_DATA_MAXSIZE];   /* pes extension data 2 */
}HI_MPI_PES_EXT_DATA_S;
