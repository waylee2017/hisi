...
HI_S32 HI_UNF_HDMI_Init(HI_UNF_HDMI_INIT_PARA_S *pstHdmiPara)
{
    ...
    s32Ret = HI_MPI_HDMI_Init(pstHdmiPara);
...
HI_S32 HI_UNF_HDMI_GetStatus(HI_UNF_HDMI_ID_E enHdmi, HI_DRV_HDMI_STATUS_S *pHdmiStatus)
{
    HI_S32 s32Ret;
...
HI_S32 HI_UNF_HDMI_RegCallbackFunc(HI_UNF_HDMI_ID_E enHdmi, HI_UNF_HDMI_INIT_PARA_S *pstCallbackFunc)
{
	HI_S32 s32Ret;
...
HI_S32 HI_UNF_HDMI_UnRegCallbackFunc(HI_UNF_HDMI_ID_E enHdmi, HI_UNF_HDMI_INIT_PARA_S *pstCallbackFunc)
{
	HI_S32 s32Ret;
...
HI_S32 HI_UNF_HDMI_SetDelay(HI_UNF_HDMI_ID_E enHdmi, HI_DRV_HDMI_DELAY_S *pstDelay)
{
 	HI_S32 s32Ret;
...
HI_S32 HI_UNF_HDMI_GetDelay(HI_UNF_HDMI_ID_E enHdmi, HI_DRV_HDMI_DELAY_S *pstDelay)
{
 	HI_S32 s32Ret;
