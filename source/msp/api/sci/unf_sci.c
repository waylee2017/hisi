...
Description		:config Reset pin work mode(od or cmos)
Calls			:NA
Data Accessed	:NA
Data Updated	:NA
Input			:NA
...
HI_S32 HI_UNF_SCI_ConfigResetMode(HI_UNF_SCI_PORT_E enSciPort, HI_UNF_SCI_MODE_E enResetMode)
{
    ...
    SciReset.enSciPort = enSciPort;
    SciReset.enResetMode = enResetMode;

    Ret = ioctl(g_SciDevFd, CMD_SCI_CONF_RESET_MODE, &SciReset);
#endif
    return Ret;
}
...
Description		:config VccEn pin work mode(od or cmos)
Calls			:NA
Data Accessed	:NA
Data Updated	:NA
Input			:NA
...
HI_S32 HI_UNF_SCI_ConfigVccEnMode(HI_UNF_SCI_PORT_E enSciPort, HI_UNF_SCI_MODE_E enVccEnMode)
{
    ...
    SciVccEn.enSciPort = enSciPort;
    SciVccEn.enVccEnMode = enVccEnMode;

    Ret = ioctl(g_SciDevFd, CMD_SCI_CONF_VCCEN_MODE, &SciVccEn);
#endif
    return Ret;
}
