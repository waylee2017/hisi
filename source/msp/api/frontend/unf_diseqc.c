...
HI_S32 HI_UNF_TUNER_DISEQC_Switch4Port(HI_U32 u32TunerId,  HI_UNF_TUNER_DISEQC_SWITCH4PORT_S* pstPara)
{
	...
	/* DTS2013072300587 when use diseqc2.0 to switch 4 port,modify here to support. */
	if(HI_UNF_TUNER_DISEQC_LEVEL_2_X == pstPara->enLevel)
	{
		pstPara->enLevel = HI_UNF_TUNER_DISEQC_LEVEL_1_X;
	}
...
HI_S32 HI_UNF_TUNER_DISEQC_Switch16Port(HI_U32 u32TunerId,  HI_UNF_TUNER_DISEQC_SWITCH16PORT_S* pstPara)
{
	...
	/* DTS2013072300587 when use diseqc2.0 to switch 16 port,modify here to support. */
	if(HI_UNF_TUNER_DISEQC_LEVEL_2_X == pstPara->enLevel)
	{
		pstPara->enLevel = HI_UNF_TUNER_DISEQC_LEVEL_1_X;
	}
...
HI_S32 HI_UNF_TUNER_DISEQC_Stop(HI_U32 u32TunerId, HI_UNF_TUNER_DISEQC_LEVEL_E enLevel)
{
    ...
    /* DTS2013072300587 when use diseqc2.0 to switch 16 port,modify here to support. */
    if(HI_UNF_TUNER_DISEQC_LEVEL_2_X == enLevel)
    {
