...
/*****************************************************************************/
#ifndef DDR_TRAINING_STAT_REG
#define DDR_TRAINING_STAT_REG        (0x101e009c) /* SC_GEN7 */
#endif
...
static void ddr_training_entry(void)
{
	...
	ddrt_write(REG_DDRT_BASE_CRG + 0x1c, 0);
	ddrt_write(REG_DDRT_BASE_CRG + 0x8, 0x4f);
	ddrt_write(REG_DDRT_BASE_CRG + 0x14, 0xffffffff);
