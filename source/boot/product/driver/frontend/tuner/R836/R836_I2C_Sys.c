...
R840_ErrCode R836_I2C_Write_Len(I2C_LEN_TYPE *I2C_Info)
{
    ...
    status = tuner_i2c_send_data( g_stTunerOps[g_r836_tuner_port].enI2cChannel, R840_ADDRESS, &I2cDataStr );
...
R840_ErrCode R836_I2C_Read_Len(I2C_LEN_TYPE *I2C_Info)
{
    ...
    s32status = tuner_i2c_receive_data(g_stTunerOps[g_r836_tuner_port].enI2cChannel, R840_ADDRESS, &stDataStruct);
