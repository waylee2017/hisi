...
#include "hi_type.h"
//----------------------------------------------------------//
#define VERSION   "R836_v2.5E3"    
#define VER_NUM   5

#define TRUE 1
#define FALSE 0

#define R840_USE_16M_XTAL     TRUE    //16 or 24M
#define R840_SHARE_XTAL_OUT     FALSE     //share Xtal, ext clk connect to XTAL_OUT

#if (R840_USE_16M_XTAL==TRUE)
