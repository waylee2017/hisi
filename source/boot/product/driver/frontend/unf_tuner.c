                         ...
                         HI_DemodAttr_S *pstDemodAttr, HI_U32 u32ResetGpioNo)
{
    ...
    switch (g_stTunerOps[u32TunerPort].enDemodDevType)
    {
        ...
        case HI_UNF_DEMOD_DEV_TYPE_3130I:
        {
            ...
            if((u8DataTmp >> 5) == 1 || (u8DataTmp >> 5) == 3 || (u8DataTmp >> 5) == 4 || (u8DataTmp >> 5)  == 6 || (u8DataTmp >> 5)  == 7)
            {
                ...
                TUNER_DEBUG("tuner port %d's demod type is hi3130 inside\n", u32TunerPort);
#endif				
            }
...
#if defined(HI_BOOT_DEMOD_DEV_TYPE_J83B)
        case HI_UNF_DEMOD_DEV_TYPE_J83B:
        {
		   ...
		   g_pstRegCrg->PERI_CRG58.u32 = unTmpPeriCrg58.u32;
			  ...
			  // g_stTunerOps[u32TunerPort].manage_after_chipreset = hi3716mv310_j83b_manage_after_chipreset;
			   ...
			   TUNER_DEBUG("tuner port %d's demod type is hi3716mv310_j83b inside\n", u32TunerPort);
 #endif          
            break;
        }
#endif
    ...
    switch (g_stTunerOps[u32TunerPort].enTunerDevType)
    {
        ...
        {  
            ...
            if(HI_FAILURE == s32Ret)
            {
                TUNER_DEBUG("tda18215 init error\n");
                return HI_FAILURE;
            }
            ...
            TUNER_DEBUG("tuner port %d's halftuner type is tda18215\n", u32TunerPort);
            break;
        }        
#endif
        ...
        case HI_UNF_TUNER_DEV_TYPE_R836:
        {
            ...
            if(HI_FAILURE == s32Ret)
            {
                TUNER_DEBUG("r836_init_tuner error\n");
                return HI_FAILURE;
            }
            ...
            TUNER_DEBUG("tuner port %d's halftuner type is r836\n", u32TunerPort);
            break;
        }
#endif
        ...
        case HI_UNF_TUNER_DEV_TYPE_MXL608:
        {
            ...
            if(HI_FAILURE == s32Ret)
            {
                TUNER_DEBUG("mxl608_init_tuner error\n");
                return HI_FAILURE;
            }
            g_stTunerOps[u32TunerPort].set_tuner = mxl608_set_tuner;
            //g_stTunerOps[u32TunerPort].tuner_resume = mxl608_tuner_resume;
            //g_stTunerOps[u32TunerPort].recalculate_signal_strength = mxl608_get_signal_strength;
            TUNER_DEBUG("tuner port %d's halftuner type is mxl608\n", u32TunerPort);
            break;
        }
#endif
        ...
        case HI_UNF_TUNER_DEV_TYPE_SI2144:
            {
                ...
                TUNER_DEBUG("tuner port %d's halftuner type is si2144\n", u32TunerPort);
                break;
            }
#endif
...
#if defined(HI_BOOT_LNB_CTRL_MPS8125) || defined(HI_BOOT_LNB_CTRL_ISL9492)
...
HI_S32 HI_UNF_TUNER_SetAttr(HI_U32	u32tunerId , const HI_UNF_TUNER_ATTR_S *pstTunerAttr)
{
    ...
    if(5 <= pstTunerAttr->enI2cChannel)
    {
