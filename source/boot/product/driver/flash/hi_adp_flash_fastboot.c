...
static int _HI_Flash_Init(void)
{
	...
	flash_part = (char *)strdup((const char *)bootargs);
	if (!flash_part) {
		ERR_FALSH_TRACE("Fail to dup bootargs!\n");
		goto fail;
	}
                         ...
                         HI_UCHAR *pucBuf)
{
    ...
    u32BlkSize = pstEmmcLog->blocksize;
    u32BlkOffset = u32Len & (u32BlkSize - 1);
...
HI_S32 HI_Flash_GetInfo_ByType(HI_FLASH_TYPE_E enFlashType, HI_Flash_InterInfo_S *pFlashInfo )
{
	...
	switch (enFlashType)
	{
        ...
        case HI_FLASH_TYPE_SPI_0:
    		...
    		pFlashInfo->BlockSize = pMtd_Info_Ex->erasesize;
        ...
        case HI_FLASH_TYPE_NAND_0:
    		...
    		pFlashInfo->BlockSize = pMtd_Info_Ex->erasesize;
    		pFlashInfo->PageSize = pMtd_Info_Ex->pagesize;
        ...
        case HI_FLASH_TYPE_EMMC_0:
	     ...
	     pFlashInfo->BlockSize = (mmc->write_bl_len * 16);
	     pFlashInfo->PageSize = 0;
	     pFlashInfo->OobSize = 0;
	     pFlashInfo->TotalSize = mmc->capacity;
...
HI_S32 HI_Flash_GetInfo(HI_HANDLE hFlash, HI_Flash_InterInfo_S *pFlashInfo )
{
	...
	switch (flash_handle->type)
	{
        ...
        case HI_FLASH_TYPE_SPI_0:
            ...
            pFlashInfo->OpenAddr = flash_handle->u.spiflash->address;
            pFlashInfo->OpenLeng = flash_handle->u.spiflash->length;
