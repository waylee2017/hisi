...
static HI_S32 BMP_Read_DecData(BMP_DECODER_S *pBmpDec,HI_HANDLE hSurface)
{
    ...
    if( (NULL == pstSurface) || (NULL == pBmpDec) || (NULL == pstStream)){
        HI_GFX_Log();
        return HI_FAILURE;
    }
...
* others:       : NA
***************************************************************************************/
HI_S32 BMP_ADP_CreateDecode(HI_U64 *pu64DecHandle,HI_CHAR* pSrcBuf,HI_U32 u32SrcLen)
{
    ...
    *pu64DecHandle = (HI_U64)(unsigned long)pBmpDecoder;
...
* others:       : NA
***************************************************************************************/
HI_S32 BMP_ADP_StartDecode(HI_U64 u64DecHandle, HI_HANDLE hSurface)
{
    HI_S32 s32Ret = HI_SUCCESS;

    BMP_DECODER_S *pBmpDec  = (BMP_DECODER_S*)(unsigned long)u64DecHandle;
    if(NULL == pBmpDec){
        HI_GFX_Log();
        return HI_FAILURE;
    }
...
* others:       : NA
***************************************************************************************/
HI_S32 BMP_ADP_GetImgInfo(HI_U64 u64DecHandle, HI_HANDLE hSurface)
{
...
* others:       : NA
***************************************************************************************/
HI_S32 BMP_ADP_DestroyDecode(HI_U64 u64DecHandle)
{
    BMP_DECODER_S *pBmpDecoder = (BMP_DECODER_S*)(unsigned long)u64DecHandle;
