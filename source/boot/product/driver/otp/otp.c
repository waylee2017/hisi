...
HI_S32 OTP_V200_setCustomerKey(OTP_CUSTOMER_KEY_S *pCustomerKey)
{
...
static HI_BOOL ca_CheckReset(HI_VOID)
{
    HI_BOOL ret = HI_TRUE;
    OTP_V200_CRG_CTRL_U unCRG;
...
static HI_VOID ca_SetReset(HI_VOID)
{
    OTP_V200_CRG_CTRL_U unCRG;
