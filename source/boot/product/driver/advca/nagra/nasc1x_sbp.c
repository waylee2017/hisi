...
extern HI_S32 Logo_Main(HI_BOOL bNeedFastplay);
...
HI_S32 SBP_Authenticate_LogoData(HI_VOID)
{
    ...
    if(HI_SUCCESS == ret)
    {
        ...
        ret = HI_PDM_SetSource(HI_PDM_SRCTYPE_DDR, &FastPlayMemInfo);
        if (HI_SUCCESS != ret)
        {
