...
void HAL_VccEnable(HI_U8 qON);

void HAL_SetHotPlug(HI_U8 portMask);
void HAL_SetAudioMux(HI_U8 muxInput);

HI_U8 HAL_GetInterruptPinState(void);
HI_U8 HAL_GetPortSelection(void);
HI_U8 HAL_GetPortSelectionDebounced(void);

void HAL_PowerDownAudioDAC(void);
void HAL_WakeUpAudioDAC(void);
void HAL_SetAudioDACMode(HI_U8 dacModeDSD);

void GPIO_ClearCecD(void);
HI_U8 GPIO_GetComMode(void);
