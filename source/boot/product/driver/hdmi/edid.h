...
HI_U8 ParseEDID(EDIDParsedDataType *);
...
HI_U8 EDID_Force_Setting(void);
HI_U8 Force_HDMI_Set_Output_Mode(HI_BOOL bForce, HI_BOOL bHDMIMode);
HI_U8 Force_HDMI_Get_Output_Mode(HI_BOOL *bForce, HI_BOOL *bHDMIMode);
HI_U32 hdmi_Set_DEBUG_Flag(HI_BOOL DebugFlag);
