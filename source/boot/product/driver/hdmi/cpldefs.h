...
#ifdef _9032_
    #define _9032_AN_STOP_FIX_          // If defined, no need to toggle Repeat bit to write AN_STOP to 0

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    #define _9032_M0_                   // 9132 - If defined, then M0 must be made "external" before reading
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #define _9032_AUTO_RI_              // If defined, turn on Auto Ri Checking
    #define _9032_BCAP_                 // If defined, use the Auto BCAP interrupt
///    #define _9032_SHA_                  // If defined, use the HW SHA calculator
#define _9032_SHA_ 

    #define _9032_WRITEBLOCKP0_         // Must be turned on for either _9032_AUTO_RI_ OR _9032_BCAP_
#endif
...
///    #define _9132_DIAG_PD_DEFAULT_      // Default for this register is different from other TX's - #define for Fred and for Fred/Dino FPGAs. Undefine for Dino 
    ...
    #define _9132_SPDIF_DECODER_        // SPDIF decoder is on this board
    #define _9132_SACD_                 // Support for SACD
    #define _9132_USE_SOURCE_TERMINATION_ // source termination enabled
#endif
