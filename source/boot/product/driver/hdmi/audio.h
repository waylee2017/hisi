...
Bool IsSPDIFSelected( void );
void TXAudio( HI_U8 );
void siiSetAudioPath ( HI_U8 * );
void siiGetAudioPath ( HI_U8 * );
void siiSetAudioInfoFramePacket ( HI_U8 * abAudioPath, HI_U8 bChSpkAlloc, HI_U8 bDM_LSV );
