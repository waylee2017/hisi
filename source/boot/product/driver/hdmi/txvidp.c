...
HI_U8 ConfigTXVideoMode(HI_U8 In, HI_U8 Out)
{
    ...
    COM_INFO("ConfigTXVideoMode in:0x%02x: out:0x%02x, RegVal:0x%02x\n", In, Out, RegVal);
...
//    COM_INFO("siiSetVideoPath to do SW_ResetHDMITX\n");
