...
//------------------------------------------------------------------------------
HI_U8 RegisterRead(HI_U16 regAddr);
void RegisterWrite(HI_U16 regAddr, HI_U8 value);
void RegisterModify(HI_U16 regAddr, HI_U8 mask, HI_U8 value);
void RegisterBitToggle(HI_U16 regAddr, HI_U8 mask);

void RegisterReadBlock(HI_U16 regAddr, HI_U8* buffer, HI_U8 length);
void RegisterWriteBlock(HI_U16 regAddr, HI_U8* buffer, HI_U8 length);
