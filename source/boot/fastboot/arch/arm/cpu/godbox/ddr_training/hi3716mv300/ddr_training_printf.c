...
#include "hi3716mv300_ddr_training.h"
...
#endif
/****************************************************************************/
int hi3716mv300_ddr_training_result(unsigned int TRAINING_ADDR)
{
...
#ifdef WRITE_DESKEW
	printf("Write: ");
	print_risk(training->prebit_wr_best);
#endif

#ifdef READ_DESKEW
	printf("Read: ");
	print_risk(training->prebit_rd_best);
#endif
