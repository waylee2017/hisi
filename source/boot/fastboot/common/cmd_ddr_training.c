...
extern int  hi3716mv310_ddr_training_result(unsigned int result_addr);
extern char hi3716mv310_ddr_training_data_start[];
extern char hi3716mv310_ddr_training_data_end[];
...
#ifdef CONFIG_DDR_TRAINING_HI3716MV310
	if ((get_chipid() == _HI3716M_V310)
	    || (get_chipid() == _HI3716M_V320)
	    || (get_chipid() == _HI3716M_V330)
	    || (get_chipid() == _HI3110E_V500))
		return hi3716mv310_ddr_training_result(result_addr);
#endif
...
static void * get_ddrtr_entry(void)
{
	...
	if ((get_chipid() == _HI3716M_V310)
	    ...
	    || (get_chipid() == _HI3716M_V330)
	    || (get_chipid() == _HI3110E_V500)) {
		src_ptr = hi3716mv310_ddr_training_data_start;
		dst_ptr = (char *)(0x0001000);
		length  = hi3716mv310_ddr_training_data_end - src_ptr;
	}
#endif
