...
#ifndef __CONFIG_HI3716MV310_H__
#define __CONFIG_HI3716MV310_H__
#define CONFIG_ARCH_HI3716MV310
/* Arm configuration*/
...
#define CONFIG_HI3716MV310_SUPPORT_DDRPHY_TRAIN
...
#  define CONFIG_HINFC610_MAX_NAND_DEVICE       1
#  define CONFIG_HINFC610_HARDWARE_PAGESIZE_ECC
#  ifndef CONFIG_GENERIC_NAND
#    define CONFIG_GENERIC_NAND
...
/* limit the reserve mem to the low-mem zone of kernel*/
...
#else
#define HISFV_DEFAULT_PHY_U                     2
#endif
#define HISFV_DEFAULT_PHY_D                     1
...
#  define CONFIG_PL011_IBRD                     29
#  define CONFIG_PL011_FBRD                     19
#else
#  define CONFIG_PL011_CLOCK                    85714286

#if (CONFIG_CHIP_TYPE == hi3716mv330)
#  define CONFIG_PL011_IBRD                     46
#  define CONFIG_PL011_FBRD                     32
#else
#  define CONFIG_PL011_IBRD                     47
#  define CONFIG_PL011_FBRD                     32
#endif
#endif
...
#define CONFIG_PRODUCTNAME                    "hi3716mv310"
...
#  undef CONFIG_DDR_TRAINING_HI3716MV300
#  define CONFIG_DDR_TRAINING_HI3716MV310
#  undef CONFIG_DDR_TRAINING_HI3716CV100
#  undef CONFIG_DDR_TRAINING_HI3712V100
