...
static int spinor_quad_enable_gd(struct flash_regop *regop)
{
	u8 sr[2];
	...
	spinor_write_buf_reg(regop, 0x31, (char *)&sr[1], 1);
...
static int spinor_quad_disable_gd(struct flash_regop *regop)
{
	u8 sr[2];
...
static struct spinor_driver spinor_drv_gd = {
	.quad_enable = spinor_quad_enable_gd,
	.quad_disable = spinor_quad_disable_gd,
};
/******************************************************************************/
