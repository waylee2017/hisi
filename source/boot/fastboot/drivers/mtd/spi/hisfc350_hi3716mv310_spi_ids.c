...
SET_READ_QUAD_ADDR(5, INFINITE, 80);
...
{
	{
		"GD25Q128C",   {0xc8, 0x40, 0x18}, 3,  (_64K * 256),  _64K, 3,
		{
	...
	{
		"S25FL164K", {0x01, 0x40, 0x17}, 3, (_64K * 128), _64K, 3,
		{
...
//			&WRITE_STD(0 , 256, 104),
	...
	*/
	...
	{
		"W25Q128B/FV", {0xEF, 0x40, 0x18}, 3, _16M, _64K, 3,
		{
			&READ_STD(0, INFINITE, 33),
			&READ_FAST(1, INFINITE, 80),
	...
	{
		"GD25Q16B",   {0xc8, 0x40, 0x15}, 3,  _2M,  _64K, 3,
		{
			&READ_STD(0, INFINITE, 80),
			&READ_FAST(1, INFINITE, 120),
			&READ_DUAL(1, INFINITE, 120),
	...
	{
		"GD25Q64B/C",   {0xc8, 0x40, 0x17}, 3,  _8M,  _64K, 3,
		{
			&READ_STD(0, INFINITE, 80),
			&READ_FAST(1, INFINITE, 120),
			&READ_DUAL(1, INFINITE, 120),
	...
	{
		"S25FL127/8S", {0x01, 0x20, 0x18, 0x4D, 0x01, 0x80 }, 6, (_64K * 256), _64K, 3,
		{
			&READ_STD(0, INFINITE, 50),
			&READ_FAST(1, INFINITE, 108),
			&READ_DUAL(1, INFINITE, 108),
	...
	*/
	...
	{
		"MX25L25655E", {0xc2, 0x26, 0x19}, 3, _32M, _64K, 4,
		{
	...
	{
		"MX25L3255D/E",  {0xc2, 0x9e, 0x16}, 3, _4M, _64K, 3,
		{
			&READ_STD(0, INFINITE, 33),
			&READ_FAST(1, INFINITE, 104),
			&READ_DUAL(1, INFINITE, 75),
	...
	{
		"MX25L6455E/6F", {0xc2, 0x26, 0x17}, 3, _8M,   _64K, 3,
		{
			&READ_STD(0, INFINITE, 50),
			&READ_FAST(1, INFINITE, 104),
	...
	{
		"IC25LP128-JBLE",  {0x9d, 0x60, 0x18}, 3, (_64K * 256),  _64K, 3,
		{
			&READ_STD(0, INFINITE, 66),
			0
		},
