...
#define BUSCLK_TO_TIMER_RELOAD(busclk)	((busclk)/HZ)
#define BUSCLK_TO_TIMER0_CLK_HZ(busclk)  (busclk)
#define BUSCLK_TO_TIMER1_CLK_HZ(busclk)  (busclk)
#define BUSCLK_TO_TIMER0_CLK_KHZ(busclk) ((busclk)/1000)
#define BUSCLK_TO_TIMER1_CLK_KHZ(busclk) ((busclk)/1000)
