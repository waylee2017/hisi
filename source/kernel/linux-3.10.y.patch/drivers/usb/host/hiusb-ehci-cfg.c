...
extern void hiusb_start_hcd_godbox(void);
extern void hiusb_stop_hcd_godbox(void);
#endif

#ifdef CONFIG_ARCH_HI3716MV310
extern void hiusb_start_hcd_hi3716mv310(void);
extern void hiusb_stop_hcd_hi3716mv310(void);
#endif
...
{
#ifdef CONFIG_ARCH_GODBOX
	hiusb_start_hcd_godbox();
	return;
#endif

#ifdef CONFIG_ARCH_HI3716MV310
	hiusb_start_hcd_hi3716mv310();
	return;
#endif
