...
SET_ERASE_SECTOR_256K(0, SZ_256, 133);
SET_ERASE_SECTOR_256K(0, SZ_256, 104);
...
struct spi_info hisfc350_spi_info_table[] =
{
	...
	*/
	...
	{
		"S25FL512S", {0x01, 0x02, 0x20, 0x4d, 0x00, 0x80}, 6, (SZ_256 * 256), SZ_256, 4,
		{
			&READ_STD(0, INFINITE, 50),
			&READ_FAST(1, INFINITE, 104),
			&READ_DUAL(1, INFINITE, 104),
		...
		{
			&ERASE_SECTOR_256K(0, SZ_256, 133),
			0
		},
	...
	{
		"S25FL128P-0", {0x01, 0x20, 0x18, 0x03, 0x00}, 5, SZ_16M/*(SZ_256 * 64)*/,  SZ_256, 3,
		{
			&READ_STD(0, INFINITE, 40),
			 &READ_FAST(1, INFINITE, 104),
			0
		...
		{
			&ERASE_SECTOR_256K(0, SZ_256, 104),
			0
		},
	...
	{
		"S25FL129P0", {0x01, 0x20, 0x18, 0x4d, 0x00}, 5, (SZ_256 * 64),  SZ_256, 3,
		{
			&READ_STD(0, INFINITE, 40),
			&READ_FAST(1, INFINITE, 104),
			&READ_DUAL(1, INFINITE, 80),
