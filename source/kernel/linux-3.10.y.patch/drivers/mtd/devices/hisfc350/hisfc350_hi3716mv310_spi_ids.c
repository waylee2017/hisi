...
{
	{
		"GD25Q128C",   {0xc8, 0x40, 0x18}, 3,  (SZ_64K * 256),  SZ_64K, 3,
		{
	...
	{
		"EN25QH128", {0x1C, 0x70, 0x18}, 3, (SZ_64K * 256), SZ_64K, 3,
		{
			&READ_STD(0, INFINITE, 50),
//			&READ_FAST(1, INFINITE, 50),
//			&READ_DUAL(1, INFINITE, 54),
...
//			&WRITE_STD(0 , 256, 104),
	...
	{
		"EN25QH64", {0x1C, 0x70, 0x17}, 3, (SZ_64K * 128), SZ_64K, 3,
		{
			&READ_STD(0, INFINITE, 50),
//			&READ_FAST(1, INFINITE, 50),
//			&READ_DUAL(1, INFINITE, 54),
...
//			&WRITE_STD(0 , 256, 104),
	...
	*/
	...
	{
		"GD25Q16B",   {0xc8, 0x40, 0x15}, 3,  SZ_2M,  SZ_64K, 3,
		{
			&READ_STD(0, INFINITE, 80),
			&READ_FAST(1, INFINITE, 120),
			&READ_DUAL(1, INFINITE, 120),
	...
	{
		"GD25Q64B/C",   {0xc8, 0x40, 0x17}, 3,  SZ_8M,  SZ_64K, 3,
		{
			&READ_STD(0, INFINITE, 80),
			&READ_FAST(1, INFINITE, 120),
			&READ_DUAL(1, INFINITE, 120),
	...
	*/
	...
	{
		"MX25L25655E", {0xc2, 0x26, 0x19}, 3, SZ_32M, SZ_64K, 4,
		{
	...
	{
		"IC25LP128-JBLE",  {0x9d, 0x60, 0x18}, 3, (SZ_64K * 256),  SZ_64K, 3,
		{
			&READ_STD(0, INFINITE, 66),
			0
		},
