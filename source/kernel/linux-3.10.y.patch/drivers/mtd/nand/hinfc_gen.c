...
int (*hinfc_nand_param_adjust)(struct mtd_info *, struct nand_chip *, struct nand_dev_t *) = NULL;
int (*hisfc_nand_param_adjust)(struct mtd_info *, struct nand_chip *, struct nand_dev_t *) = NULL;
