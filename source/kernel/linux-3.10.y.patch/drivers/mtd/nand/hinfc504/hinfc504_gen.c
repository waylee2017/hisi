...
{
	u32 regval = host->NFC_CON >> HINFC504_CON_PAGEISZE_SHIFT;
...
{
	u32 mask = ~(HINFC504_CON_PAGESIZE_MASK << HINFC504_CON_PAGEISZE_SHIFT);
	u32 regval = match_type_to_reg(hinfc504_pagesize,
...
{
	u32 regval = host->NFC_CON >> HINFC504_CON_ECCTYPE_SHIFT;
...
{
	u32 regval = match_type_to_reg(hinfc504_ecc, ARRAY_SIZE(hinfc504_ecc),
