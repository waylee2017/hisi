...
extern int (*hinfc_nand_param_adjust)(struct mtd_info *, struct nand_chip *, struct nand_dev_t *);
extern int (*hisfc_nand_param_adjust)(struct mtd_info *, struct nand_chip *, struct nand_dev_t *);
...
struct nand_flash_dev *hifmc_spinand_probe(struct mtd_info *mtd,
					struct nand_chip *chip,
					struct nand_dev_t *nand_dev);

void hinfc_param_adjust(struct mtd_info *mtd, struct nand_chip *chip);
void hisfc_param_adjust(struct mtd_info *mtd, struct nand_chip *chip);
