...
{
	u32 regval = host->NFC_CON >> HINFC610_CON_PAGEISZE_SHIFT;
...
{
	u32 mask = ~(HINFC610_CON_PAGESIZE_MASK << HINFC610_CON_PAGEISZE_SHIFT);
	u32 regval = match_type_to_reg(hinfc620_pagesize,
...
{
	u32 regval = host->NFC_CON >> HINFC610_CON_ECCTYPE_SHIFT;
...
{
	u32 regval = match_type_to_reg(hinfc620_ecc, ARRAY_SIZE(hinfc620_ecc),
