...
#define HINFC610_INTS_EN                              0x24
#define HINFC610_ALL_INTS_MASK           (0x3FF)
#define HINFC610_INTS_EN_DMA_DONE        (1U << 9)
#define HINFC610_STATUS_RANDOMIZER_EN    (1U << 20)

#define HINFC610_INTS                                 0x28
#define HINFC610_INTS_UE                 (1U << 6)
#define HINFC610_INTS_DMA_DONE           (1U << 9)

#define HINFC610_INTCLR                               0x2C
#define HINFC610_INTCLR_MASK             (0x3FF)
#define HINFC610_INTCLR_UE               (1U << 6)
#define HINFC610_INTCLR_CE               (1U << 5)
#define HINFC610_INTCLR_DMA_DONE         (1U << 9)
