...
/*****************************************************************************/
static void hisfc400_spi_search_rw(struct nand_flash_special_dev *spiinfo,
...
/*****************************************************************************/
static void hisfc400_spi_get_erase(struct nand_flash_special_dev *spiinfo,
...
/*****************************************************************************/
void hisfc400_flash_init(struct hisfc_host *host)
{
	unsigned int regval;
