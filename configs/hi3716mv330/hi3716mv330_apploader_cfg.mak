...
CFG_HI_ETH_UP_PHYADDR=1
CFG_HI_ETH_DOWN_PHYADDR=2
...
CFG_HI_KEYLED_GPIOKEY_POWER_GPIO=0xd
CFG_HI_KEYLED_GPIOKEY_OK_GPIO=0x13
CFG_HI_KEYLED_GPIOKEY_MENU_GPIO=0x12
CFG_HI_KEYLED_GPIOKEY_LEFT_GPIO=0xf
CFG_HI_KEYLED_GPIOKEY_RIGHT_GPIO=0xe
CFG_HI_KEYLED_GPIOKEY_UP_GPIO=0x10
...
CFG_HI_BOOT_REG_NAME=hi3716m33dmb_hi3716mv330_DDR3_128_256MB_16bit_2layers.reg
...
CFG_HI_BOOT_ENV_STARTADDR=0xa0000
CFG_HI_BOOT_ENV_SIZE=0x20000
...
CFG_HI_BOOT_KEYLED_GPIOKEY=y
# CFG_HI_BOOT_KEYLED_74HC164 is not set
# CFG_HI_BOOT_KEYLED_CT1642 is not set
...
CFG_HI_KERNEL_CFG=hi3716mv330_loader_defconfig
CFG_HI_FS_BUILDIN=y
...
# HACODEC Config
#
# CFG_HI_HACODEC_MP3DECODE_SUPPORT is not set
# CFG_HI_HACODEC_AACDECODE_SUPPORT is not set
...
# CFG_HI_HACODEC_PCMDECODE_SUPPORT is not set
...
# CFG_HI_APPLOADER_LOGOUT_DISABLE is not set
...
# CFG_HI_SND_ADAC_SUPPORT is not set
# CFG_HI_SND_SPDIF_SUPPORT is not set
# CFG_HI_SND_HDMI_SUPPORT is not set
...
CFG_HI_VFMW_DECODE_CAPABILITY=HD_SIMPLE
CFG_FHD=y
# CFG_D1 is not set
CFG_HI_VFMW_DECODE_PREALLOC_MMZ=FHD
CFG_HI_VDEC_MAX_INSTANCE=2
CFG_HI_VDEC_MAX_REF_FRAME=6
CFG_HI_VDEC_MAX_DISP_FRAME=7
CFG_HI_VDEC_SCD_BUFFER_SIZE=0x200000
# CFG_HI_VDEC_DEINTERLACE_SUPPORT is not set
...
# CFG_HI_VDEC_DSD_SUPPORT is not set
...
CFG_HI_DISP_YPBPR_VIDEO_BUFF=y
# CFG_HI_DISP_YPBPR_LC is not set
